...
public class ThirdPartyApi extends BaseApi {
   ...
   */
  public ObjectWrapper getThirdPartyCode(@javax.annotation.Nonnull LoginProvider provider) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ObjectWrapper getThirdPartyCode(@javax.annotation.Nonnull LoginProvider provider, Map<String, String> additionalHeaders) throws ApiException {
