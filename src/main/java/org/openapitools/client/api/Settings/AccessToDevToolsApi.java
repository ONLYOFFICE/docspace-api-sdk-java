...
public class AccessToDevToolsApi extends BaseApi {
   ...
   */
  public TenantDevToolsAccessSettingsWrapper getTenantAccessDevToolsSettings() throws ApiException {
    return this.getTenantAccessDevToolsSettings(Collections.emptyMap());
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public TenantDevToolsAccessSettingsWrapper getTenantAccessDevToolsSettings(Map<String, String> additionalHeaders) throws ApiException {
