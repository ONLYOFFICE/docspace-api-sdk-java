...
public class BannersVisibilityApi extends BaseApi {
   ...
   */
  public TenantBannerSettingsWrapper getTenantBannerSettings() throws ApiException {
    return this.getTenantBannerSettings(Collections.emptyMap());
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public TenantBannerSettingsWrapper getTenantBannerSettings(Map<String, String> additionalHeaders) throws ApiException {
