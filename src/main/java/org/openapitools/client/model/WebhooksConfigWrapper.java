 ...
 */
@JsonPropertyOrder({
  WebhooksConfigWrapper.JSON_PROPERTY_RESPONSE,
  WebhooksConfigWrapper.JSON_PROPERTY_COUNT,
  WebhooksConfigWrapper.JSON_PROPERTY_LINKS,
  WebhooksConfigWrapper.JSON_PROPERTY_STATUS,
  WebhooksConfigWrapper.JSON_PROPERTY_STATUS_CODE
})

public class WebhooksConfigWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private WebhooksConfigDto response;
  ...
  public WebhooksConfigDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable WebhooksConfigDto response) {
    this.response = response;
  }

  public WebhooksConfigWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public WebhooksConfigWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public WebhooksConfigWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public WebhooksConfigWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public WebhooksConfigWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    WebhooksConfigWrapper webhooksConfigWrapper = (WebhooksConfigWrapper) o;
    return Objects.equals(this.response, webhooksConfigWrapper.response) &&
        Objects.equals(this.count, webhooksConfigWrapper.count) &&
        Objects.equals(this.links, webhooksConfigWrapper.links) &&
        Objects.equals(this.status, webhooksConfigWrapper.status) &&
        Objects.equals(this.statusCode, webhooksConfigWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhooksConfigWrapper {\n");
