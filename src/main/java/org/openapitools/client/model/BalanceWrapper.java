...
@JsonPropertyOrder({
  ...
  BalanceWrapper.JSON_PROPERTY_COUNT,
  BalanceWrapper.JSON_PROPERTY_LINKS,
  BalanceWrapper.JSON_PROPERTY_STATUS,
  BalanceWrapper.JSON_PROPERTY_STATUS_CODE
})

public class BalanceWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private Balance response;
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable Balance response) {
    this.response = response;
  }

  public BalanceWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public BalanceWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public BalanceWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public BalanceWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public BalanceWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    BalanceWrapper balanceWrapper = (BalanceWrapper) o;
    return Objects.equals(this.response, balanceWrapper.response) &&
        Objects.equals(this.count, balanceWrapper.count) &&
        Objects.equals(this.links, balanceWrapper.links) &&
        Objects.equals(this.status, balanceWrapper.status) &&
        Objects.equals(this.statusCode, balanceWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class BalanceWrapper {\n");
