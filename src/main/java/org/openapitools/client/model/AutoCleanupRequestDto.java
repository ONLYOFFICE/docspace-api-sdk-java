...
public class AutoCleanupRequestDto {
  ...
  public AutoCleanupRequestDto gap(@javax.annotation.Nullable DateToAutoCleanUp gap) {
  ...
  public boolean equals(Object o) {
    ...
    AutoCleanupRequestDto autoCleanupRequestDto = (AutoCleanupRequestDto) o;
    return Objects.equals(this.set, autoCleanupRequestDto.set) &&
        Objects.equals(this.gap, autoCleanupRequestDto.gap);
  }

  @Override
  public int hashCode() {
    return Objects.hash(set, gap);
  }
