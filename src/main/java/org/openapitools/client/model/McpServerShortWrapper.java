 ...
 */
@JsonPropertyOrder({
  McpServerShortWrapper.JSON_PROPERTY_RESPONSE,
  McpServerShortWrapper.JSON_PROPERTY_COUNT,
  McpServerShortWrapper.JSON_PROPERTY_LINKS,
  McpServerShortWrapper.JSON_PROPERTY_STATUS,
  McpServerShortWrapper.JSON_PROPERTY_STATUS_CODE
})

public class McpServerShortWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private McpServerShortDto response;
  ...
  public McpServerShortWrapper() {
  }


  public McpServerShortWrapper response(@javax.annotation.Nullable McpServerShortDto response) {
  ...
  public McpServerShortDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable McpServerShortDto response) {
    this.response = response;
  }

  public McpServerShortWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public McpServerShortWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public McpServerShortWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public McpServerShortWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public McpServerShortWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    McpServerShortWrapper mcpServerShortWrapper = (McpServerShortWrapper) o;
    return Objects.equals(this.response, mcpServerShortWrapper.response) &&
        Objects.equals(this.count, mcpServerShortWrapper.count) &&
        Objects.equals(this.links, mcpServerShortWrapper.links) &&
        Objects.equals(this.status, mcpServerShortWrapper.status) &&
        Objects.equals(this.statusCode, mcpServerShortWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class McpServerShortWrapper {\n");
