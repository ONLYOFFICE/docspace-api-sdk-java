...
public class AiEmbeddingPrice {
  public static final String JSON_PROPERTY_PROMPT = "prompt";
  @javax.annotation.Nullable  private Double prompt;

  public AiEmbeddingPrice() {
  }


  public AiEmbeddingPrice prompt(@javax.annotation.Nullable Double prompt) {
  ...
  public boolean equals(Object o) {
    ...
    AiEmbeddingPrice aiEmbeddingPrice = (AiEmbeddingPrice) o;
    return Objects.equals(this.prompt, aiEmbeddingPrice.prompt);
  }
  ...
  public String toString() {
    ...
    sb.append("class AiEmbeddingPrice {\n");
