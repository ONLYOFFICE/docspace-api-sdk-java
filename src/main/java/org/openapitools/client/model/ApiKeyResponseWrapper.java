...
@JsonPropertyOrder({
  ...
  ApiKeyResponseWrapper.JSON_PROPERTY_COUNT,
  ApiKeyResponseWrapper.JSON_PROPERTY_LINKS,
  ApiKeyResponseWrapper.JSON_PROPERTY_STATUS,
  ApiKeyResponseWrapper.JSON_PROPERTY_STATUS_CODE
})

public class ApiKeyResponseWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private ApiKeyResponseDto response;
  ...
  public ApiKeyResponseDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable ApiKeyResponseDto response) {
    this.response = response;
  }

  public ApiKeyResponseWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public ApiKeyResponseWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public ApiKeyResponseWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public ApiKeyResponseWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public ApiKeyResponseWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    ApiKeyResponseWrapper apiKeyResponseWrapper = (ApiKeyResponseWrapper) o;
    return Objects.equals(this.response, apiKeyResponseWrapper.response) &&
        Objects.equals(this.count, apiKeyResponseWrapper.count) &&
        Objects.equals(this.links, apiKeyResponseWrapper.links) &&
        Objects.equals(this.status, apiKeyResponseWrapper.status) &&
        Objects.equals(this.statusCode, apiKeyResponseWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiKeyResponseWrapper {\n");
