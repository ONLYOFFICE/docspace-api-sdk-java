 ...
 */
@JsonPropertyOrder({
  ProviderSettingsDto.JSON_PROPERTY_TYPE,
  ProviderSettingsDto.JSON_PROPERTY_URL
})
...
public class ProviderSettingsDto {
  ...
  public ProviderSettingsDto type(@javax.annotation.Nullable ProviderType type) {
  ...
  public ProviderSettingsDto url(@javax.annotation.Nullable String url) {
  ...
  public boolean equals(Object o) {
    ...
    ProviderSettingsDto providerSettingsDto = (ProviderSettingsDto) o;
    return Objects.equals(this.type, providerSettingsDto.type) &&
        equalsNullable(this.url, providerSettingsDto.url);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, hashCodeNullable(url));
  }
