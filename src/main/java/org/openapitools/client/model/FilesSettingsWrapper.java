...
import org.openapitools.client.model.FilesSettingsDto;
 ...
 */
@JsonPropertyOrder({
  FilesSettingsWrapper.JSON_PROPERTY_RESPONSE,
  FilesSettingsWrapper.JSON_PROPERTY_COUNT,
  FilesSettingsWrapper.JSON_PROPERTY_LINKS,
  FilesSettingsWrapper.JSON_PROPERTY_STATUS,
  FilesSettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class FilesSettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private FilesSettingsDto response;
  ...
  public FilesSettingsDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable FilesSettingsDto response) {
    this.response = response;
  }

  public FilesSettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public FilesSettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public FilesSettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public FilesSettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public FilesSettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    FilesSettingsWrapper filesSettingsWrapper = (FilesSettingsWrapper) o;
    return Objects.equals(this.response, filesSettingsWrapper.response) &&
        Objects.equals(this.count, filesSettingsWrapper.count) &&
        Objects.equals(this.links, filesSettingsWrapper.links) &&
        Objects.equals(this.status, filesSettingsWrapper.status) &&
        Objects.equals(this.statusCode, filesSettingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class FilesSettingsWrapper {\n");
