...
@JsonPropertyOrder({
  ...
  AccountInfoArrayWrapper.JSON_PROPERTY_COUNT,
  AccountInfoArrayWrapper.JSON_PROPERTY_LINKS,
  AccountInfoArrayWrapper.JSON_PROPERTY_STATUS,
  AccountInfoArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class AccountInfoArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<AccountInfoDto> response = new ArrayList<>();
  ...
  public AccountInfoArrayWrapper addResponseItem(AccountInfoDto responseItem) {
  ...
  public List<AccountInfoDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<AccountInfoDto> response) {
    this.response = response;
  }

  public AccountInfoArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public AccountInfoArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public AccountInfoArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public AccountInfoArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public AccountInfoArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    AccountInfoArrayWrapper accountInfoArrayWrapper = (AccountInfoArrayWrapper) o;
    return Objects.equals(this.response, accountInfoArrayWrapper.response) &&
        Objects.equals(this.count, accountInfoArrayWrapper.count) &&
        Objects.equals(this.links, accountInfoArrayWrapper.links) &&
        Objects.equals(this.status, accountInfoArrayWrapper.status) &&
        Objects.equals(this.statusCode, accountInfoArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccountInfoArrayWrapper {\n");
