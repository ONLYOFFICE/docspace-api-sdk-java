...
import org.openapitools.client.model.BackupProgress;
 ...
 */
@JsonPropertyOrder({
  BackupProgressWrapper.JSON_PROPERTY_RESPONSE,
  BackupProgressWrapper.JSON_PROPERTY_COUNT,
  BackupProgressWrapper.JSON_PROPERTY_LINKS,
  BackupProgressWrapper.JSON_PROPERTY_STATUS,
  BackupProgressWrapper.JSON_PROPERTY_STATUS_CODE
})

public class BackupProgressWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private BackupProgress response;
  ...
  public BackupProgress getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable BackupProgress response) {
    this.response = response;
  }

  public BackupProgressWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public BackupProgressWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public BackupProgressWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public BackupProgressWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public BackupProgressWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    BackupProgressWrapper backupProgressWrapper = (BackupProgressWrapper) o;
    return Objects.equals(this.response, backupProgressWrapper.response) &&
        Objects.equals(this.count, backupProgressWrapper.count) &&
        Objects.equals(this.links, backupProgressWrapper.links) &&
        Objects.equals(this.status, backupProgressWrapper.status) &&
        Objects.equals(this.statusCode, backupProgressWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class BackupProgressWrapper {\n");
