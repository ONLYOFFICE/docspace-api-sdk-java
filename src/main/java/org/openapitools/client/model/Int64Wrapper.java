...
@JsonPropertyOrder({
  ...
  Int64Wrapper.JSON_PROPERTY_COUNT,
  Int64Wrapper.JSON_PROPERTY_LINKS,
  Int64Wrapper.JSON_PROPERTY_STATUS,
  Int64Wrapper.JSON_PROPERTY_STATUS_CODE
})

public class Int64Wrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private Integer response;
  ...
  public Int64Wrapper response(@javax.annotation.Nullable Integer response) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable Integer response) {
    this.response = response;
  }

  public Int64Wrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public Int64Wrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public Int64Wrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public Int64Wrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public Int64Wrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    Int64Wrapper int64Wrapper = (Int64Wrapper) o;
    return Objects.equals(this.response, int64Wrapper.response) &&
        Objects.equals(this.count, int64Wrapper.count) &&
        Objects.equals(this.links, int64Wrapper.links) &&
        Objects.equals(this.status, int64Wrapper.status) &&
        Objects.equals(this.statusCode, int64Wrapper.statusCode);
  }
