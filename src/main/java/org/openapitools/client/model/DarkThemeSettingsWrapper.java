...
import org.openapitools.client.model.DarkThemeSettings;
...
@JsonPropertyOrder({
  ...
  DarkThemeSettingsWrapper.JSON_PROPERTY_COUNT,
  DarkThemeSettingsWrapper.JSON_PROPERTY_LINKS,
  DarkThemeSettingsWrapper.JSON_PROPERTY_STATUS,
  DarkThemeSettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class DarkThemeSettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private DarkThemeSettings response;
  ...
  public DarkThemeSettings getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable DarkThemeSettings response) {
    this.response = response;
  }

  public DarkThemeSettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public DarkThemeSettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public DarkThemeSettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public DarkThemeSettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public DarkThemeSettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    DarkThemeSettingsWrapper darkThemeSettingsWrapper = (DarkThemeSettingsWrapper) o;
    return Objects.equals(this.response, darkThemeSettingsWrapper.response) &&
        Objects.equals(this.count, darkThemeSettingsWrapper.count) &&
        Objects.equals(this.links, darkThemeSettingsWrapper.links) &&
        Objects.equals(this.status, darkThemeSettingsWrapper.status) &&
        Objects.equals(this.statusCode, darkThemeSettingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class DarkThemeSettingsWrapper {\n");
