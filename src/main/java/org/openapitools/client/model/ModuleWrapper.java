...
@JsonPropertyOrder({
  ...
  ModuleWrapper.JSON_PROPERTY_COUNT,
  ModuleWrapper.JSON_PROPERTY_LINKS,
  ModuleWrapper.JSON_PROPERTY_STATUS,
  ModuleWrapper.JSON_PROPERTY_STATUS_CODE
})

public class ModuleWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private Module response;
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable Module response) {
    this.response = response;
  }

  public ModuleWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public ModuleWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public ModuleWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public ModuleWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public ModuleWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.response, moduleWrapper.response) &&
        Objects.equals(this.count, moduleWrapper.count) &&
        Objects.equals(this.links, moduleWrapper.links) &&
        Objects.equals(this.status, moduleWrapper.status) &&
        Objects.equals(this.statusCode, moduleWrapper.statusCode);
  }
