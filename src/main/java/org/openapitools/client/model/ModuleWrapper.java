...
public class ModuleWrapper {
  ...
  public ModuleWrapper links(@javax.annotation.Nullable List<ActiveConnectionsWrapperLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public ModuleWrapper addLinksItem(ActiveConnectionsWrapperLinksInner linksItem) {
    if (this.links == null) {
