...
import org.openapitools.client.model.CspDto;
 ...
 */
@JsonPropertyOrder({
  CspWrapper.JSON_PROPERTY_RESPONSE,
  CspWrapper.JSON_PROPERTY_COUNT,
  CspWrapper.JSON_PROPERTY_LINKS,
  CspWrapper.JSON_PROPERTY_STATUS,
  CspWrapper.JSON_PROPERTY_STATUS_CODE
})

public class CspWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private CspDto response;
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable CspDto response) {
    this.response = response;
  }

  public CspWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public CspWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public CspWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public CspWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public CspWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    CspWrapper cspWrapper = (CspWrapper) o;
    return Objects.equals(this.response, cspWrapper.response) &&
        Objects.equals(this.count, cspWrapper.count) &&
        Objects.equals(this.links, cspWrapper.links) &&
        Objects.equals(this.status, cspWrapper.status) &&
        Objects.equals(this.statusCode, cspWrapper.statusCode);
  }
