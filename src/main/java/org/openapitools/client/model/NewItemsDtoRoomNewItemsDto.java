...
@JsonPropertyOrder({
  ...
  NewItemsDtoRoomNewItemsDto.JSON_PROPERTY_ITEMS
})
...
public class NewItemsDtoRoomNewItemsDto {
  ...
  public NewItemsDtoRoomNewItemsDto items(@javax.annotation.Nullable List<RoomNewItemsDto> items) {
    
    this.items = items;
    return this;
  }

  public NewItemsDtoRoomNewItemsDto addItemsItem(RoomNewItemsDto itemsItem) {
    if (this.items == null) {
  ...
  public boolean equals(Object o) {
    ...
    NewItemsDtoRoomNewItemsDto newItemsDtoRoomNewItemsDto = (NewItemsDtoRoomNewItemsDto) o;
    return Objects.equals(this.date, newItemsDtoRoomNewItemsDto.date) &&
        Objects.equals(this.items, newItemsDtoRoomNewItemsDto.items);
  }
