 ...
 */
@JsonPropertyOrder({
  GroupSummaryArrayWrapper.JSON_PROPERTY_RESPONSE,
  GroupSummaryArrayWrapper.JSON_PROPERTY_COUNT,
  GroupSummaryArrayWrapper.JSON_PROPERTY_LINKS,
  GroupSummaryArrayWrapper.JSON_PROPERTY_STATUS,
  GroupSummaryArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class GroupSummaryArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<GroupSummaryDto> response = new ArrayList<>();
  ...
  public GroupSummaryArrayWrapper() {
  }


  public GroupSummaryArrayWrapper response(@javax.annotation.Nullable List<GroupSummaryDto> response) {
    
    this.response = response;
    return this;
  }

  public GroupSummaryArrayWrapper addResponseItem(GroupSummaryDto responseItem) {
  ...
  public List<GroupSummaryDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<GroupSummaryDto> response) {
    this.response = response;
  }

  public GroupSummaryArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public GroupSummaryArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public GroupSummaryArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public GroupSummaryArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public GroupSummaryArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    GroupSummaryArrayWrapper groupSummaryArrayWrapper = (GroupSummaryArrayWrapper) o;
    return Objects.equals(this.response, groupSummaryArrayWrapper.response) &&
        Objects.equals(this.count, groupSummaryArrayWrapper.count) &&
        Objects.equals(this.links, groupSummaryArrayWrapper.links) &&
        Objects.equals(this.status, groupSummaryArrayWrapper.status) &&
        Objects.equals(this.statusCode, groupSummaryArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class GroupSummaryArrayWrapper {\n");
