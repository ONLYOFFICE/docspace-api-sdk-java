...
import org.openapitools.client.model.MentionWrapper;
 ...
 */
@JsonPropertyOrder({
  MentionWrapperArrayWrapper.JSON_PROPERTY_RESPONSE,
  MentionWrapperArrayWrapper.JSON_PROPERTY_COUNT,
  MentionWrapperArrayWrapper.JSON_PROPERTY_LINKS,
  MentionWrapperArrayWrapper.JSON_PROPERTY_STATUS,
  MentionWrapperArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class MentionWrapperArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<MentionWrapper> response = new ArrayList<>();
  ...
  public MentionWrapperArrayWrapper addResponseItem(MentionWrapper responseItem) {
  ...
  public List<MentionWrapper> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<MentionWrapper> response) {
    this.response = response;
  }

  public MentionWrapperArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public MentionWrapperArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public MentionWrapperArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public MentionWrapperArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public MentionWrapperArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    MentionWrapperArrayWrapper mentionWrapperArrayWrapper = (MentionWrapperArrayWrapper) o;
    return Objects.equals(this.response, mentionWrapperArrayWrapper.response) &&
        Objects.equals(this.count, mentionWrapperArrayWrapper.count) &&
        Objects.equals(this.links, mentionWrapperArrayWrapper.links) &&
        Objects.equals(this.status, mentionWrapperArrayWrapper.status) &&
        Objects.equals(this.statusCode, mentionWrapperArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class MentionWrapperArrayWrapper {\n");
