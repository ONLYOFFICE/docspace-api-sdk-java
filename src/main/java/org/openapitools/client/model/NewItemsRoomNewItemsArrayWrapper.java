...
import org.openapitools.client.model.NewItemsDtoRoomNewItemsDto;
 ...
 */
@JsonPropertyOrder({
  NewItemsRoomNewItemsArrayWrapper.JSON_PROPERTY_RESPONSE,
  NewItemsRoomNewItemsArrayWrapper.JSON_PROPERTY_COUNT,
  NewItemsRoomNewItemsArrayWrapper.JSON_PROPERTY_LINKS,
  NewItemsRoomNewItemsArrayWrapper.JSON_PROPERTY_STATUS,
  NewItemsRoomNewItemsArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class NewItemsRoomNewItemsArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<NewItemsDtoRoomNewItemsDto> response = new ArrayList<>();
  ...
  public NewItemsRoomNewItemsArrayWrapper addResponseItem(NewItemsDtoRoomNewItemsDto responseItem) {
  ...
  public List<NewItemsDtoRoomNewItemsDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<NewItemsDtoRoomNewItemsDto> response) {
    this.response = response;
  }

  public NewItemsRoomNewItemsArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public NewItemsRoomNewItemsArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public NewItemsRoomNewItemsArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public NewItemsRoomNewItemsArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public NewItemsRoomNewItemsArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    NewItemsRoomNewItemsArrayWrapper newItemsRoomNewItemsArrayWrapper = (NewItemsRoomNewItemsArrayWrapper) o;
    return Objects.equals(this.response, newItemsRoomNewItemsArrayWrapper.response) &&
        Objects.equals(this.count, newItemsRoomNewItemsArrayWrapper.count) &&
        Objects.equals(this.links, newItemsRoomNewItemsArrayWrapper.links) &&
        Objects.equals(this.status, newItemsRoomNewItemsArrayWrapper.status) &&
        Objects.equals(this.statusCode, newItemsRoomNewItemsArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class NewItemsRoomNewItemsArrayWrapper {\n");
