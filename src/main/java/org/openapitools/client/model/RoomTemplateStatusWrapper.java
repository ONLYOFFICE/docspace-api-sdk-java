...
import org.openapitools.client.model.RoomTemplateStatusDto;
...
@JsonPropertyOrder({
  ...
  RoomTemplateStatusWrapper.JSON_PROPERTY_COUNT,
  RoomTemplateStatusWrapper.JSON_PROPERTY_LINKS,
  RoomTemplateStatusWrapper.JSON_PROPERTY_STATUS,
  RoomTemplateStatusWrapper.JSON_PROPERTY_STATUS_CODE
})

public class RoomTemplateStatusWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private RoomTemplateStatusDto response;
  ...
  public RoomTemplateStatusWrapper() {
  }


  public RoomTemplateStatusWrapper response(@javax.annotation.Nullable RoomTemplateStatusDto response) {
  ...
  public RoomTemplateStatusDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable RoomTemplateStatusDto response) {
    this.response = response;
  }

  public RoomTemplateStatusWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public RoomTemplateStatusWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public RoomTemplateStatusWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public RoomTemplateStatusWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public RoomTemplateStatusWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    RoomTemplateStatusWrapper roomTemplateStatusWrapper = (RoomTemplateStatusWrapper) o;
    return Objects.equals(this.response, roomTemplateStatusWrapper.response) &&
        Objects.equals(this.count, roomTemplateStatusWrapper.count) &&
        Objects.equals(this.links, roomTemplateStatusWrapper.links) &&
        Objects.equals(this.status, roomTemplateStatusWrapper.status) &&
        Objects.equals(this.statusCode, roomTemplateStatusWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class RoomTemplateStatusWrapper {\n");
