...
@JsonPropertyOrder({
  ...
  InvitationLinkCreateRequestDto.JSON_PROPERTY_EXPIRATION,
  InvitationLinkCreateRequestDto.JSON_PROPERTY_MAX_USE_COUNT
})
...
public class InvitationLinkCreateRequestDto {
  ...
  public InvitationLinkCreateRequestDto() {
  }


  public InvitationLinkCreateRequestDto employeeType(@javax.annotation.Nonnull EmployeeType employeeType) {
  ...
  public InvitationLinkCreateRequestDto expiration(@javax.annotation.Nullable OffsetDateTime expiration) {
  ...
  public InvitationLinkCreateRequestDto maxUseCount(@javax.annotation.Nullable Integer maxUseCount) {
  ...
  public boolean equals(Object o) {
    ...
    InvitationLinkCreateRequestDto invitationLinkCreateRequestDto = (InvitationLinkCreateRequestDto) o;
    return Objects.equals(this.employeeType, invitationLinkCreateRequestDto.employeeType) &&
        equalsNullable(this.expiration, invitationLinkCreateRequestDto.expiration) &&
        equalsNullable(this.maxUseCount, invitationLinkCreateRequestDto.maxUseCount);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(employeeType, hashCodeNullable(expiration), hashCodeNullable(maxUseCount));
  }
