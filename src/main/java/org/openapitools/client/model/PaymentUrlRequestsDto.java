 ...
 */
@JsonPropertyOrder({
  PaymentUrlRequestsDto.JSON_PROPERTY_BACK_URL,
  PaymentUrlRequestsDto.JSON_PROPERTY_QUANTITY
})

public class PaymentUrlRequestsDto {
  public static final String JSON_PROPERTY_BACK_URL = "backUrl";
  @javax.annotation.Nullable
  private JsonNullable<String> backUrl = JsonNullable.<String>undefined();
  ...
  public PaymentUrlRequestsDto quantity(@javax.annotation.Nullable Map<String, Integer> quantity) {
    this.quantity = JsonNullable.<Map<String, Integer>>of(quantity);
    
    return this;
  }

  public PaymentUrlRequestsDto putQuantityItem(String key, Integer quantityItem) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentUrlRequestsDto paymentUrlRequestsDto = (PaymentUrlRequestsDto) o;
    return equalsNullable(this.backUrl, paymentUrlRequestsDto.backUrl) &&
        equalsNullable(this.quantity, paymentUrlRequestsDto.quantity);
  }
