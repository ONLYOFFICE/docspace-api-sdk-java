...
@JsonPropertyOrder({
  ...
  FileShareArrayWrapper.JSON_PROPERTY_COUNT,
  FileShareArrayWrapper.JSON_PROPERTY_LINKS,
  FileShareArrayWrapper.JSON_PROPERTY_STATUS,
  FileShareArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class FileShareArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<FileShareDto> response = new ArrayList<>();
  ...
  public FileShareArrayWrapper() {
  }


  public FileShareArrayWrapper response(@javax.annotation.Nullable List<FileShareDto> response) {
    
    this.response = response;
    return this;
  }

  public FileShareArrayWrapper addResponseItem(FileShareDto responseItem) {
  ...
  public List<FileShareDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<FileShareDto> response) {
    this.response = response;
  }

  public FileShareArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public FileShareArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public FileShareArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public FileShareArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public FileShareArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    FileShareArrayWrapper fileShareArrayWrapper = (FileShareArrayWrapper) o;
    return Objects.equals(this.response, fileShareArrayWrapper.response) &&
        Objects.equals(this.count, fileShareArrayWrapper.count) &&
        Objects.equals(this.links, fileShareArrayWrapper.links) &&
        Objects.equals(this.status, fileShareArrayWrapper.status) &&
        Objects.equals(this.statusCode, fileShareArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class FileShareArrayWrapper {\n");
