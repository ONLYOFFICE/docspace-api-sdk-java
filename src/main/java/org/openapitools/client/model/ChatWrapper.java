 ...
 */
@JsonPropertyOrder({
  ChatWrapper.JSON_PROPERTY_RESPONSE,
  ChatWrapper.JSON_PROPERTY_COUNT,
  ChatWrapper.JSON_PROPERTY_LINKS,
  ChatWrapper.JSON_PROPERTY_STATUS,
  ChatWrapper.JSON_PROPERTY_STATUS_CODE
})

public class ChatWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private ChatDto response;
  ...
  public ChatWrapper response(@javax.annotation.Nullable ChatDto response) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable ChatDto response) {
    this.response = response;
  }

  public ChatWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public ChatWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public ChatWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public ChatWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public ChatWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    ChatWrapper chatWrapper = (ChatWrapper) o;
    return Objects.equals(this.response, chatWrapper.response) &&
        Objects.equals(this.count, chatWrapper.count) &&
        Objects.equals(this.links, chatWrapper.links) &&
        Objects.equals(this.status, chatWrapper.status) &&
        Objects.equals(this.statusCode, chatWrapper.statusCode);
  }
