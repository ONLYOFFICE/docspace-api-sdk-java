...
public class FinishDto {
  ...
  public boolean equals(Object o) {
    ...
    FinishDto finishDto = (FinishDto) o;
    return Objects.equals(this.isSendWelcomeEmail, finishDto.isSendWelcomeEmail);
  }

  @Override
  public int hashCode() {
    return Objects.hash(isSendWelcomeEmail);
  }
  ...
  public String toString() {
    ...
    sb.append("    isSendWelcomeEmail: ").append(toIndentedString(isSendWelcomeEmail)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `isSendWelcomeEmail` to the URL query string
    if (getIsSendWelcomeEmail() != null) {
      try {
        joiner.add(String.format("%sisSendWelcomeEmail%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getIsSendWelcomeEmail()), "UTF-8").replaceAll("\\+", "%20")));
