 ...
 */
@JsonPropertyOrder({
  DocumentBuilderTaskWrapper.JSON_PROPERTY_RESPONSE,
  DocumentBuilderTaskWrapper.JSON_PROPERTY_COUNT,
  DocumentBuilderTaskWrapper.JSON_PROPERTY_LINKS,
  DocumentBuilderTaskWrapper.JSON_PROPERTY_STATUS,
  DocumentBuilderTaskWrapper.JSON_PROPERTY_STATUS_CODE
})

public class DocumentBuilderTaskWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private DocumentBuilderTaskDto response;
  ...
  public DocumentBuilderTaskDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable DocumentBuilderTaskDto response) {
    this.response = response;
  }

  public DocumentBuilderTaskWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public DocumentBuilderTaskWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public DocumentBuilderTaskWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public DocumentBuilderTaskWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public DocumentBuilderTaskWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    DocumentBuilderTaskWrapper documentBuilderTaskWrapper = (DocumentBuilderTaskWrapper) o;
    return Objects.equals(this.response, documentBuilderTaskWrapper.response) &&
        Objects.equals(this.count, documentBuilderTaskWrapper.count) &&
        Objects.equals(this.links, documentBuilderTaskWrapper.links) &&
        Objects.equals(this.status, documentBuilderTaskWrapper.status) &&
        Objects.equals(this.statusCode, documentBuilderTaskWrapper.statusCode);
  }
