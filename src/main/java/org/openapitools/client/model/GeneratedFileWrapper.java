...
import org.openapitools.client.model.GeneratedFileDto;
 ...
 */
@JsonPropertyOrder({
  GeneratedFileWrapper.JSON_PROPERTY_RESPONSE,
  GeneratedFileWrapper.JSON_PROPERTY_COUNT,
  GeneratedFileWrapper.JSON_PROPERTY_LINKS,
  GeneratedFileWrapper.JSON_PROPERTY_STATUS,
  GeneratedFileWrapper.JSON_PROPERTY_STATUS_CODE
})

public class GeneratedFileWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private GeneratedFileDto response;
  ...
  public GeneratedFileWrapper() {
  }


  public GeneratedFileWrapper response(@javax.annotation.Nullable GeneratedFileDto response) {
  ...
  public GeneratedFileDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable GeneratedFileDto response) {
    this.response = response;
  }

  public GeneratedFileWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public GeneratedFileWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public GeneratedFileWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public GeneratedFileWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public GeneratedFileWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    GeneratedFileWrapper generatedFileWrapper = (GeneratedFileWrapper) o;
    return Objects.equals(this.response, generatedFileWrapper.response) &&
        Objects.equals(this.count, generatedFileWrapper.count) &&
        Objects.equals(this.links, generatedFileWrapper.links) &&
        Objects.equals(this.status, generatedFileWrapper.status) &&
        Objects.equals(this.statusCode, generatedFileWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class GeneratedFileWrapper {\n");
