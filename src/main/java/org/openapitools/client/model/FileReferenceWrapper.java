 ...
 */
@JsonPropertyOrder({
  FileReferenceWrapper.JSON_PROPERTY_RESPONSE,
  FileReferenceWrapper.JSON_PROPERTY_COUNT,
  FileReferenceWrapper.JSON_PROPERTY_LINKS,
  FileReferenceWrapper.JSON_PROPERTY_STATUS,
  FileReferenceWrapper.JSON_PROPERTY_STATUS_CODE
})
...
public class FileReferenceWrapper {
  ...
  public FileReferenceWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public FileReferenceWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public FileReferenceWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    FileReferenceWrapper fileReferenceWrapper = (FileReferenceWrapper) o;
    return Objects.equals(this.response, fileReferenceWrapper.response) &&
        Objects.equals(this.count, fileReferenceWrapper.count) &&
        Objects.equals(this.links, fileReferenceWrapper.links) &&
        Objects.equals(this.status, fileReferenceWrapper.status) &&
        Objects.equals(this.statusCode, fileReferenceWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class FileReferenceWrapper {\n");
