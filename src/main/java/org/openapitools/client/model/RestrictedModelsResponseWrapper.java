...
import org.openapitools.client.model.RestrictedModelsResponse;
...
@JsonPropertyOrder({
  ...
  RestrictedModelsResponseWrapper.JSON_PROPERTY_COUNT,
  RestrictedModelsResponseWrapper.JSON_PROPERTY_LINKS,
  RestrictedModelsResponseWrapper.JSON_PROPERTY_STATUS,
  RestrictedModelsResponseWrapper.JSON_PROPERTY_STATUS_CODE
})

public class RestrictedModelsResponseWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private RestrictedModelsResponse response;
  ...
  public RestrictedModelsResponseWrapper() {
  }


  public RestrictedModelsResponseWrapper response(@javax.annotation.Nullable RestrictedModelsResponse response) {
  ...
  public RestrictedModelsResponse getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable RestrictedModelsResponse response) {
    this.response = response;
  }

  public RestrictedModelsResponseWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public RestrictedModelsResponseWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public RestrictedModelsResponseWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public RestrictedModelsResponseWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public RestrictedModelsResponseWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    RestrictedModelsResponseWrapper restrictedModelsResponseWrapper = (RestrictedModelsResponseWrapper) o;
    return Objects.equals(this.response, restrictedModelsResponseWrapper.response) &&
        Objects.equals(this.count, restrictedModelsResponseWrapper.count) &&
        Objects.equals(this.links, restrictedModelsResponseWrapper.links) &&
        Objects.equals(this.status, restrictedModelsResponseWrapper.status) &&
        Objects.equals(this.statusCode, restrictedModelsResponseWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class RestrictedModelsResponseWrapper {\n");
