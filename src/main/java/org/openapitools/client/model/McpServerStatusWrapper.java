 ...
 */
@JsonPropertyOrder({
  McpServerStatusWrapper.JSON_PROPERTY_RESPONSE,
  McpServerStatusWrapper.JSON_PROPERTY_COUNT,
  McpServerStatusWrapper.JSON_PROPERTY_LINKS,
  McpServerStatusWrapper.JSON_PROPERTY_STATUS,
  McpServerStatusWrapper.JSON_PROPERTY_STATUS_CODE
})

public class McpServerStatusWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private McpServerStatusDto response;
  ...
  public McpServerStatusWrapper() {
  }


  public McpServerStatusWrapper response(@javax.annotation.Nullable McpServerStatusDto response) {
  ...
  public McpServerStatusDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable McpServerStatusDto response) {
    this.response = response;
  }

  public McpServerStatusWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public McpServerStatusWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public McpServerStatusWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public McpServerStatusWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public McpServerStatusWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    McpServerStatusWrapper mcpServerStatusWrapper = (McpServerStatusWrapper) o;
    return Objects.equals(this.response, mcpServerStatusWrapper.response) &&
        Objects.equals(this.count, mcpServerStatusWrapper.count) &&
        Objects.equals(this.links, mcpServerStatusWrapper.links) &&
        Objects.equals(this.status, mcpServerStatusWrapper.status) &&
        Objects.equals(this.statusCode, mcpServerStatusWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class McpServerStatusWrapper {\n");
