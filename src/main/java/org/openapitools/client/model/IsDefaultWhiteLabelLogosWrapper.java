...
@JsonPropertyOrder({
  ...
  IsDefaultWhiteLabelLogosWrapper.JSON_PROPERTY_COUNT,
  IsDefaultWhiteLabelLogosWrapper.JSON_PROPERTY_LINKS,
  IsDefaultWhiteLabelLogosWrapper.JSON_PROPERTY_STATUS,
  IsDefaultWhiteLabelLogosWrapper.JSON_PROPERTY_STATUS_CODE
})

public class IsDefaultWhiteLabelLogosWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private IsDefaultWhiteLabelLogosDto response;
  ...
  public IsDefaultWhiteLabelLogosDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable IsDefaultWhiteLabelLogosDto response) {
    this.response = response;
  }

  public IsDefaultWhiteLabelLogosWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public IsDefaultWhiteLabelLogosWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public IsDefaultWhiteLabelLogosWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public IsDefaultWhiteLabelLogosWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public IsDefaultWhiteLabelLogosWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    IsDefaultWhiteLabelLogosWrapper isDefaultWhiteLabelLogosWrapper = (IsDefaultWhiteLabelLogosWrapper) o;
    return Objects.equals(this.response, isDefaultWhiteLabelLogosWrapper.response) &&
        Objects.equals(this.count, isDefaultWhiteLabelLogosWrapper.count) &&
        Objects.equals(this.links, isDefaultWhiteLabelLogosWrapper.links) &&
        Objects.equals(this.status, isDefaultWhiteLabelLogosWrapper.status) &&
        Objects.equals(this.statusCode, isDefaultWhiteLabelLogosWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class IsDefaultWhiteLabelLogosWrapper {\n");
