...
import org.openapitools.client.model.TaskProgressResponseDto;
 ...
 */
@JsonPropertyOrder({
  TaskProgressResponseWrapper.JSON_PROPERTY_RESPONSE,
  TaskProgressResponseWrapper.JSON_PROPERTY_COUNT,
  TaskProgressResponseWrapper.JSON_PROPERTY_LINKS,
  TaskProgressResponseWrapper.JSON_PROPERTY_STATUS,
  TaskProgressResponseWrapper.JSON_PROPERTY_STATUS_CODE
})

public class TaskProgressResponseWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private TaskProgressResponseDto response;
  ...
  public TaskProgressResponseDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable TaskProgressResponseDto response) {
    this.response = response;
  }

  public TaskProgressResponseWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public TaskProgressResponseWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public TaskProgressResponseWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public TaskProgressResponseWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public TaskProgressResponseWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    TaskProgressResponseWrapper taskProgressResponseWrapper = (TaskProgressResponseWrapper) o;
    return Objects.equals(this.response, taskProgressResponseWrapper.response) &&
        Objects.equals(this.count, taskProgressResponseWrapper.count) &&
        Objects.equals(this.links, taskProgressResponseWrapper.links) &&
        Objects.equals(this.status, taskProgressResponseWrapper.status) &&
        Objects.equals(this.statusCode, taskProgressResponseWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class TaskProgressResponseWrapper {\n");
