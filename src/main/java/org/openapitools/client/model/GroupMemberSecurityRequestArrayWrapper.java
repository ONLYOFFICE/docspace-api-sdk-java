...
import org.openapitools.client.model.GroupMemberSecurityRequestDto;
...
@JsonPropertyOrder({
  ...
  GroupMemberSecurityRequestArrayWrapper.JSON_PROPERTY_COUNT,
  GroupMemberSecurityRequestArrayWrapper.JSON_PROPERTY_LINKS,
  GroupMemberSecurityRequestArrayWrapper.JSON_PROPERTY_STATUS,
  GroupMemberSecurityRequestArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class GroupMemberSecurityRequestArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<GroupMemberSecurityRequestDto> response = new ArrayList<>();
  ...
  public GroupMemberSecurityRequestArrayWrapper addResponseItem(GroupMemberSecurityRequestDto responseItem) {
  ...
  public List<GroupMemberSecurityRequestDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<GroupMemberSecurityRequestDto> response) {
    this.response = response;
  }

  public GroupMemberSecurityRequestArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public GroupMemberSecurityRequestArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public GroupMemberSecurityRequestArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public GroupMemberSecurityRequestArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public GroupMemberSecurityRequestArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    GroupMemberSecurityRequestArrayWrapper groupMemberSecurityRequestArrayWrapper = (GroupMemberSecurityRequestArrayWrapper) o;
    return Objects.equals(this.response, groupMemberSecurityRequestArrayWrapper.response) &&
        Objects.equals(this.count, groupMemberSecurityRequestArrayWrapper.count) &&
        Objects.equals(this.links, groupMemberSecurityRequestArrayWrapper.links) &&
        Objects.equals(this.status, groupMemberSecurityRequestArrayWrapper.status) &&
        Objects.equals(this.statusCode, groupMemberSecurityRequestArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class GroupMemberSecurityRequestArrayWrapper {\n");
