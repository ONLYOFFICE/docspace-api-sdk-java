...
@JsonPropertyOrder({
  ...
  StringWrapper.JSON_PROPERTY_COUNT,
  StringWrapper.JSON_PROPERTY_LINKS,
  StringWrapper.JSON_PROPERTY_STATUS,
  StringWrapper.JSON_PROPERTY_STATUS_CODE
})

public class StringWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private String response;
  ...
  public StringWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public StringWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public StringWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public StringWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public StringWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.response, stringWrapper.response) &&
        Objects.equals(this.count, stringWrapper.count) &&
        Objects.equals(this.links, stringWrapper.links) &&
        Objects.equals(this.status, stringWrapper.status) &&
        Objects.equals(this.statusCode, stringWrapper.statusCode);
  }
