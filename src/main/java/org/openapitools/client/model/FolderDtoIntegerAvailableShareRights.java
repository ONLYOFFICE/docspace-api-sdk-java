 ...
 */
@JsonPropertyOrder({
  FolderDtoIntegerAvailableShareRights.JSON_PROPERTY_USER,
  FolderDtoIntegerAvailableShareRights.JSON_PROPERTY_EXTERNAL_LINK,
  FolderDtoIntegerAvailableShareRights.JSON_PROPERTY_GROUP,
  FolderDtoIntegerAvailableShareRights.JSON_PROPERTY_INVITATION_LINK,
  FolderDtoIntegerAvailableShareRights.JSON_PROPERTY_PRIMARY_EXTERNAL_LINK
})
@JsonTypeName("FolderDtoInteger_availableShareRights")

public class FolderDtoIntegerAvailableShareRights {
  ...
  public FolderDtoIntegerAvailableShareRights() {
  }


  public FolderDtoIntegerAvailableShareRights user(@javax.annotation.Nullable List<String> user) {
    
    this.user = user;
    return this;
  }

  public FolderDtoIntegerAvailableShareRights addUserItem(String userItem) {
    if (this.user == null) {
  ...
  public FolderDtoIntegerAvailableShareRights externalLink(@javax.annotation.Nullable List<String> externalLink) {
    
    this.externalLink = externalLink;
    return this;
  }

  public FolderDtoIntegerAvailableShareRights addExternalLinkItem(String externalLinkItem) {
  ...
  public FolderDtoIntegerAvailableShareRights group(@javax.annotation.Nullable List<String> group) {
    
    this.group = group;
    return this;
  }

  public FolderDtoIntegerAvailableShareRights addGroupItem(String groupItem) {
    if (this.group == null) {
  ...
  public FolderDtoIntegerAvailableShareRights invitationLink(@javax.annotation.Nullable List<String> invitationLink) {
    
    this.invitationLink = invitationLink;
    return this;
  }

  public FolderDtoIntegerAvailableShareRights addInvitationLinkItem(String invitationLinkItem) {
  ...
  public FolderDtoIntegerAvailableShareRights primaryExternalLink(@javax.annotation.Nullable List<String> primaryExternalLink) {
    
    this.primaryExternalLink = primaryExternalLink;
    return this;
  }

  public FolderDtoIntegerAvailableShareRights addPrimaryExternalLinkItem(String primaryExternalLinkItem) {
  ...
  public boolean equals(Object o) {
    ...
    FolderDtoIntegerAvailableShareRights folderDtoIntegerAvailableShareRights = (FolderDtoIntegerAvailableShareRights) o;
    return Objects.equals(this.user, folderDtoIntegerAvailableShareRights.user) &&
        Objects.equals(this.externalLink, folderDtoIntegerAvailableShareRights.externalLink) &&
        Objects.equals(this.group, folderDtoIntegerAvailableShareRights.group) &&
        Objects.equals(this.invitationLink, folderDtoIntegerAvailableShareRights.invitationLink) &&
        Objects.equals(this.primaryExternalLink, folderDtoIntegerAvailableShareRights.primaryExternalLink);
  }
  ...
  public String toString() {
    ...
    sb.append("class FolderDtoIntegerAvailableShareRights {\n");
