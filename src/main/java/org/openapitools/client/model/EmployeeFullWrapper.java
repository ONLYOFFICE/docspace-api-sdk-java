...
@JsonPropertyOrder({
  ...
  EmployeeFullWrapper.JSON_PROPERTY_COUNT,
  EmployeeFullWrapper.JSON_PROPERTY_LINKS,
  EmployeeFullWrapper.JSON_PROPERTY_STATUS,
  EmployeeFullWrapper.JSON_PROPERTY_STATUS_CODE
})

public class EmployeeFullWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private EmployeeFullDto response;
  ...
  public EmployeeFullWrapper() {
  }


  public EmployeeFullWrapper response(@javax.annotation.Nullable EmployeeFullDto response) {
  ...
  public EmployeeFullDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable EmployeeFullDto response) {
    this.response = response;
  }

  public EmployeeFullWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public EmployeeFullWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public EmployeeFullWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public EmployeeFullWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public EmployeeFullWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeeFullWrapper employeeFullWrapper = (EmployeeFullWrapper) o;
    return Objects.equals(this.response, employeeFullWrapper.response) &&
        Objects.equals(this.count, employeeFullWrapper.count) &&
        Objects.equals(this.links, employeeFullWrapper.links) &&
        Objects.equals(this.status, employeeFullWrapper.status) &&
        Objects.equals(this.statusCode, employeeFullWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeFullWrapper {\n");
