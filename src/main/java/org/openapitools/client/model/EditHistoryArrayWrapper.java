...
import org.openapitools.client.model.EditHistoryDto;
...
@JsonPropertyOrder({
  ...
  EditHistoryArrayWrapper.JSON_PROPERTY_COUNT,
  EditHistoryArrayWrapper.JSON_PROPERTY_LINKS,
  EditHistoryArrayWrapper.JSON_PROPERTY_STATUS,
  EditHistoryArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class EditHistoryArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<EditHistoryDto> response = new ArrayList<>();
  ...
  public EditHistoryArrayWrapper addResponseItem(EditHistoryDto responseItem) {
  ...
  public List<EditHistoryDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<EditHistoryDto> response) {
    this.response = response;
  }

  public EditHistoryArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public EditHistoryArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public EditHistoryArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public EditHistoryArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public EditHistoryArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    EditHistoryArrayWrapper editHistoryArrayWrapper = (EditHistoryArrayWrapper) o;
    return Objects.equals(this.response, editHistoryArrayWrapper.response) &&
        Objects.equals(this.count, editHistoryArrayWrapper.count) &&
        Objects.equals(this.links, editHistoryArrayWrapper.links) &&
        Objects.equals(this.status, editHistoryArrayWrapper.status) &&
        Objects.equals(this.statusCode, editHistoryArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class EditHistoryArrayWrapper {\n");
