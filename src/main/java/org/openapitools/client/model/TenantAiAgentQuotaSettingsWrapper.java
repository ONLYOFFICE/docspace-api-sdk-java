...
import org.openapitools.client.model.TenantAiAgentQuotaSettings;
 ...
 */
@JsonPropertyOrder({
  TenantAiAgentQuotaSettingsWrapper.JSON_PROPERTY_RESPONSE,
  TenantAiAgentQuotaSettingsWrapper.JSON_PROPERTY_COUNT,
  TenantAiAgentQuotaSettingsWrapper.JSON_PROPERTY_LINKS,
  TenantAiAgentQuotaSettingsWrapper.JSON_PROPERTY_STATUS,
  TenantAiAgentQuotaSettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class TenantAiAgentQuotaSettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private TenantAiAgentQuotaSettings response;
  ...
  public TenantAiAgentQuotaSettings getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable TenantAiAgentQuotaSettings response) {
    this.response = response;
  }

  public TenantAiAgentQuotaSettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public TenantAiAgentQuotaSettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public TenantAiAgentQuotaSettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public TenantAiAgentQuotaSettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public TenantAiAgentQuotaSettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    TenantAiAgentQuotaSettingsWrapper tenantAiAgentQuotaSettingsWrapper = (TenantAiAgentQuotaSettingsWrapper) o;
    return Objects.equals(this.response, tenantAiAgentQuotaSettingsWrapper.response) &&
        Objects.equals(this.count, tenantAiAgentQuotaSettingsWrapper.count) &&
        Objects.equals(this.links, tenantAiAgentQuotaSettingsWrapper.links) &&
        Objects.equals(this.status, tenantAiAgentQuotaSettingsWrapper.status) &&
        Objects.equals(this.statusCode, tenantAiAgentQuotaSettingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class TenantAiAgentQuotaSettingsWrapper {\n");
