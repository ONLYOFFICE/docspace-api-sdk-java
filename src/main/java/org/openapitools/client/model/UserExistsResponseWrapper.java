...
import org.openapitools.client.model.UserExistsResponseDto;
...
@JsonPropertyOrder({
  ...
  UserExistsResponseWrapper.JSON_PROPERTY_COUNT,
  UserExistsResponseWrapper.JSON_PROPERTY_LINKS,
  UserExistsResponseWrapper.JSON_PROPERTY_STATUS,
  UserExistsResponseWrapper.JSON_PROPERTY_STATUS_CODE
})

public class UserExistsResponseWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private UserExistsResponseDto response;
  ...
  public UserExistsResponseWrapper() {
  }


  public UserExistsResponseWrapper response(@javax.annotation.Nullable UserExistsResponseDto response) {
  ...
  public UserExistsResponseDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable UserExistsResponseDto response) {
    this.response = response;
  }

  public UserExistsResponseWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public UserExistsResponseWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public UserExistsResponseWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public UserExistsResponseWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public UserExistsResponseWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    UserExistsResponseWrapper userExistsResponseWrapper = (UserExistsResponseWrapper) o;
    return Objects.equals(this.response, userExistsResponseWrapper.response) &&
        Objects.equals(this.count, userExistsResponseWrapper.count) &&
        Objects.equals(this.links, userExistsResponseWrapper.links) &&
        Objects.equals(this.status, userExistsResponseWrapper.status) &&
        Objects.equals(this.statusCode, userExistsResponseWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserExistsResponseWrapper {\n");
