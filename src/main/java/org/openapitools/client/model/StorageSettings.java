...
public class StorageSettings {
  ...
  public StorageSettings module(@javax.annotation.Nullable String module) {
  ...
  public StorageSettings props(@javax.annotation.Nullable Map<String, String> props) {
    this.props = JsonNullable.<Map<String, String>>of(props);
    
    return this;
  }

  public StorageSettings putPropsItem(String key, String propsItem) {
