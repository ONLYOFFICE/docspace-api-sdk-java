 ...
 */
@JsonPropertyOrder({
  McpToolDto.JSON_PROPERTY_NAME,
  McpToolDto.JSON_PROPERTY_ENABLED
})
...
public class McpToolDto {
  ...
  public McpToolDto name(@javax.annotation.Nullable String name) {
  ...
  public McpToolDto enabled(@javax.annotation.Nullable Boolean enabled) {
  ...
  public boolean equals(Object o) {
    ...
    McpToolDto mcpToolDto = (McpToolDto) o;
    return Objects.equals(this.name, mcpToolDto.name) &&
        Objects.equals(this.enabled, mcpToolDto.enabled);
  }
