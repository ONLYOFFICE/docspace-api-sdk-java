...
@JsonPropertyOrder({
  ...
  EditHistoryAuthor.JSON_PROPERTY_NAME
})
...
public class EditHistoryAuthor {
  ...
  public EditHistoryAuthor name(@javax.annotation.Nullable String name) {
  ...
  public boolean equals(Object o) {
    ...
    EditHistoryAuthor editHistoryAuthor = (EditHistoryAuthor) o;
    return Objects.equals(this.id, editHistoryAuthor.id) &&
        equalsNullable(this.name, editHistoryAuthor.name);
  }
