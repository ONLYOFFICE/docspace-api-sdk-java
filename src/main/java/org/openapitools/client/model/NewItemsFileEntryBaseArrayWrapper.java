...
import org.openapitools.client.model.NewItemsDtoFileEntryBaseDto;
...
@JsonPropertyOrder({
  ...
  NewItemsFileEntryBaseArrayWrapper.JSON_PROPERTY_COUNT,
  NewItemsFileEntryBaseArrayWrapper.JSON_PROPERTY_LINKS,
  NewItemsFileEntryBaseArrayWrapper.JSON_PROPERTY_STATUS,
  NewItemsFileEntryBaseArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class NewItemsFileEntryBaseArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<NewItemsDtoFileEntryBaseDto> response = new ArrayList<>();
  ...
  public NewItemsFileEntryBaseArrayWrapper addResponseItem(NewItemsDtoFileEntryBaseDto responseItem) {
  ...
  public List<NewItemsDtoFileEntryBaseDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<NewItemsDtoFileEntryBaseDto> response) {
    this.response = response;
  }

  public NewItemsFileEntryBaseArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public NewItemsFileEntryBaseArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public NewItemsFileEntryBaseArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public NewItemsFileEntryBaseArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public NewItemsFileEntryBaseArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    NewItemsFileEntryBaseArrayWrapper newItemsFileEntryBaseArrayWrapper = (NewItemsFileEntryBaseArrayWrapper) o;
    return Objects.equals(this.response, newItemsFileEntryBaseArrayWrapper.response) &&
        Objects.equals(this.count, newItemsFileEntryBaseArrayWrapper.count) &&
        Objects.equals(this.links, newItemsFileEntryBaseArrayWrapper.links) &&
        Objects.equals(this.status, newItemsFileEntryBaseArrayWrapper.status) &&
        Objects.equals(this.statusCode, newItemsFileEntryBaseArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class NewItemsFileEntryBaseArrayWrapper {\n");
