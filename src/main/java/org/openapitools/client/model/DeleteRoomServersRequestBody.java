 ...
 */
@JsonPropertyOrder({
  DeleteRoomServersRequestBody.JSON_PROPERTY_SERVERS
})
...
public class DeleteRoomServersRequestBody {
  ...
  public DeleteRoomServersRequestBody() {
  }


  public DeleteRoomServersRequestBody servers(@javax.annotation.Nullable Set<UUID> servers) {
    
    this.servers = servers;
    return this;
  }

  public DeleteRoomServersRequestBody addServersItem(UUID serversItem) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteRoomServersRequestBody deleteRoomServersRequestBody = (DeleteRoomServersRequestBody) o;
    return Objects.equals(this.servers, deleteRoomServersRequestBody.servers);
  }
