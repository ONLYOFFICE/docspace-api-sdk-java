 ...
 */
@JsonPropertyOrder({
  FileShareWrapper.JSON_PROPERTY_RESPONSE,
  FileShareWrapper.JSON_PROPERTY_COUNT,
  FileShareWrapper.JSON_PROPERTY_LINKS,
  FileShareWrapper.JSON_PROPERTY_STATUS,
  FileShareWrapper.JSON_PROPERTY_STATUS_CODE
})

public class FileShareWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private FileShareDto response;
  ...
  public FileShareDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable FileShareDto response) {
    this.response = response;
  }

  public FileShareWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public FileShareWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public FileShareWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public FileShareWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public FileShareWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    FileShareWrapper fileShareWrapper = (FileShareWrapper) o;
    return Objects.equals(this.response, fileShareWrapper.response) &&
        Objects.equals(this.count, fileShareWrapper.count) &&
        Objects.equals(this.links, fileShareWrapper.links) &&
        Objects.equals(this.status, fileShareWrapper.status) &&
        Objects.equals(this.statusCode, fileShareWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class FileShareWrapper {\n");
