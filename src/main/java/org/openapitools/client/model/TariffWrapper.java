...
@JsonPropertyOrder({
  ...
  TariffWrapper.JSON_PROPERTY_COUNT,
  TariffWrapper.JSON_PROPERTY_LINKS,
  TariffWrapper.JSON_PROPERTY_STATUS,
  TariffWrapper.JSON_PROPERTY_STATUS_CODE
})
@javax.annotation.Generated(value = "com.example.codegen.MyJavaClientCodegen", date = "2025-11-10T06:17:22.719994700+03:00[Europe/Moscow]", comments = "Generator version: 7.14.0")
public class TariffWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable
  private Tariff response;
  ...
  public TariffWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public TariffWrapper links(@javax.annotation.Nullable List<ActiveConnectionsWrapperLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public TariffWrapper addLinksItem(ActiveConnectionsWrapperLinksInner linksItem) {
    if (this.links == null) {
  ...
  public TariffWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public TariffWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    TariffWrapper tariffWrapper = (TariffWrapper) o;
    return Objects.equals(this.response, tariffWrapper.response) &&
        Objects.equals(this.count, tariffWrapper.count) &&
        Objects.equals(this.links, tariffWrapper.links) &&
        Objects.equals(this.status, tariffWrapper.status) &&
        Objects.equals(this.statusCode, tariffWrapper.statusCode);
  }
