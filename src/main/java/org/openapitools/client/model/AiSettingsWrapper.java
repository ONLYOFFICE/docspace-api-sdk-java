...
import org.openapitools.client.model.AiSettingsDto;
 ...
 */
@JsonPropertyOrder({
  AiSettingsWrapper.JSON_PROPERTY_RESPONSE,
  AiSettingsWrapper.JSON_PROPERTY_COUNT,
  AiSettingsWrapper.JSON_PROPERTY_LINKS,
  AiSettingsWrapper.JSON_PROPERTY_STATUS,
  AiSettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class AiSettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private AiSettingsDto response;
  ...
  public AiSettingsWrapper() {
  }


  public AiSettingsWrapper response(@javax.annotation.Nullable AiSettingsDto response) {
  ...
  public AiSettingsDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable AiSettingsDto response) {
    this.response = response;
  }

  public AiSettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public AiSettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public AiSettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public AiSettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public AiSettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    AiSettingsWrapper aiSettingsWrapper = (AiSettingsWrapper) o;
    return Objects.equals(this.response, aiSettingsWrapper.response) &&
        Objects.equals(this.count, aiSettingsWrapper.count) &&
        Objects.equals(this.links, aiSettingsWrapper.links) &&
        Objects.equals(this.status, aiSettingsWrapper.status) &&
        Objects.equals(this.statusCode, aiSettingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class AiSettingsWrapper {\n");
