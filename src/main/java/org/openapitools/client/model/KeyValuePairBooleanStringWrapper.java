...
public class KeyValuePairBooleanStringWrapper {
  ...
  private KeyValuePairBooleanString response;
  ...
  public KeyValuePairBooleanStringWrapper links(@javax.annotation.Nullable List<ActiveConnectionsWrapperLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public KeyValuePairBooleanStringWrapper addLinksItem(ActiveConnectionsWrapperLinksInner linksItem) {
    if (this.links == null) {
