...
@JsonPropertyOrder({
  ...
  ProviderArrayWrapper.JSON_PROPERTY_COUNT,
  ProviderArrayWrapper.JSON_PROPERTY_LINKS,
  ProviderArrayWrapper.JSON_PROPERTY_STATUS,
  ProviderArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class ProviderArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<ProviderDto> response = new ArrayList<>();
  ...
  public ProviderArrayWrapper addResponseItem(ProviderDto responseItem) {
  ...
  public List<ProviderDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<ProviderDto> response) {
    this.response = response;
  }

  public ProviderArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public ProviderArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public ProviderArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public ProviderArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public ProviderArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    ProviderArrayWrapper providerArrayWrapper = (ProviderArrayWrapper) o;
    return Objects.equals(this.response, providerArrayWrapper.response) &&
        Objects.equals(this.count, providerArrayWrapper.count) &&
        Objects.equals(this.links, providerArrayWrapper.links) &&
        Objects.equals(this.status, providerArrayWrapper.status) &&
        Objects.equals(this.statusCode, providerArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProviderArrayWrapper {\n");
