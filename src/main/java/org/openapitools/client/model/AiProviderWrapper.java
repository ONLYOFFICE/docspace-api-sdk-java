 ...
 */
@JsonPropertyOrder({
  AiProviderWrapper.JSON_PROPERTY_RESPONSE,
  AiProviderWrapper.JSON_PROPERTY_COUNT,
  AiProviderWrapper.JSON_PROPERTY_LINKS,
  AiProviderWrapper.JSON_PROPERTY_STATUS,
  AiProviderWrapper.JSON_PROPERTY_STATUS_CODE
})

public class AiProviderWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private AiProviderDto response;
  ...
  public AiProviderWrapper() {
  }


  public AiProviderWrapper response(@javax.annotation.Nullable AiProviderDto response) {
  ...
  public AiProviderDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable AiProviderDto response) {
    this.response = response;
  }

  public AiProviderWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public AiProviderWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public AiProviderWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public AiProviderWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public AiProviderWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    AiProviderWrapper aiProviderWrapper = (AiProviderWrapper) o;
    return Objects.equals(this.response, aiProviderWrapper.response) &&
        Objects.equals(this.count, aiProviderWrapper.count) &&
        Objects.equals(this.links, aiProviderWrapper.links) &&
        Objects.equals(this.status, aiProviderWrapper.status) &&
        Objects.equals(this.statusCode, aiProviderWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class AiProviderWrapper {\n");
