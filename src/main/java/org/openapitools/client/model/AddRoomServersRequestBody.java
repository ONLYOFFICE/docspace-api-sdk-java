 ...
 */
@JsonPropertyOrder({
  AddRoomServersRequestBody.JSON_PROPERTY_SERVERS
})
...
public class AddRoomServersRequestBody {
  ...
  public AddRoomServersRequestBody() {
  }


  public AddRoomServersRequestBody servers(@javax.annotation.Nullable Set<UUID> servers) {
    
    this.servers = servers;
    return this;
  }

  public AddRoomServersRequestBody addServersItem(UUID serversItem) {
  ...
  public boolean equals(Object o) {
    ...
    AddRoomServersRequestBody addRoomServersRequestBody = (AddRoomServersRequestBody) o;
    return Objects.equals(this.servers, addRoomServersRequestBody.servers);
  }
