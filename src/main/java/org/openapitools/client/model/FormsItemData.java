 ...
 */
@JsonPropertyOrder({
  FormsItemData.JSON_PROPERTY_KEY,
  FormsItemData.JSON_PROPERTY_TAG,
  FormsItemData.JSON_PROPERTY_VALUE,
  FormsItemData.JSON_PROPERTY_TYPE
})
...
public class FormsItemData {
  ...
  @javax.annotation.Nullable  private JsonNullable<String> tag = JsonNullable.<String>undefined();
  ...
  public FormsItemData() {
  }


  public FormsItemData key(@javax.annotation.Nullable String key) {
  ...
  public FormsItemData tag(@javax.annotation.Nullable String tag) {
  ...
  public FormsItemData value(@javax.annotation.Nullable String value) {
  ...
  public FormsItemData type(@javax.annotation.Nullable String type) {
  ...
  public boolean equals(Object o) {
    ...
    FormsItemData formsItemData = (FormsItemData) o;
    return equalsNullable(this.key, formsItemData.key) &&
        equalsNullable(this.tag, formsItemData.tag) &&
        equalsNullable(this.value, formsItemData.value) &&
        equalsNullable(this.type, formsItemData.type);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(key), hashCodeNullable(tag), hashCodeNullable(value), hashCodeNullable(type));
  }
