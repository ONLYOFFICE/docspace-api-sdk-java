...
import org.openapitools.client.model.CustomColorThemesSettingsDto;
 ...
 */
@JsonPropertyOrder({
  CustomColorThemesSettingsWrapper.JSON_PROPERTY_RESPONSE,
  CustomColorThemesSettingsWrapper.JSON_PROPERTY_COUNT,
  CustomColorThemesSettingsWrapper.JSON_PROPERTY_LINKS,
  CustomColorThemesSettingsWrapper.JSON_PROPERTY_STATUS,
  CustomColorThemesSettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class CustomColorThemesSettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private CustomColorThemesSettingsDto response;
  ...
  public CustomColorThemesSettingsDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable CustomColorThemesSettingsDto response) {
    this.response = response;
  }

  public CustomColorThemesSettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public CustomColorThemesSettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public CustomColorThemesSettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public CustomColorThemesSettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public CustomColorThemesSettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    CustomColorThemesSettingsWrapper customColorThemesSettingsWrapper = (CustomColorThemesSettingsWrapper) o;
    return Objects.equals(this.response, customColorThemesSettingsWrapper.response) &&
        Objects.equals(this.count, customColorThemesSettingsWrapper.count) &&
        Objects.equals(this.links, customColorThemesSettingsWrapper.links) &&
        Objects.equals(this.status, customColorThemesSettingsWrapper.status) &&
        Objects.equals(this.statusCode, customColorThemesSettingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomColorThemesSettingsWrapper {\n");
