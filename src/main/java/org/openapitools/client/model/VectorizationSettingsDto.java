...
import org.openapitools.client.model.EmbeddingProviderType;
 ...
 */
@JsonPropertyOrder({
  VectorizationSettingsDto.JSON_PROPERTY_TYPE,
  VectorizationSettingsDto.JSON_PROPERTY_NEED_RESET
})

public class VectorizationSettingsDto {
  public static final String JSON_PROPERTY_TYPE = "type";
  @javax.annotation.Nullable  private EmbeddingProviderType type;

  public static final String JSON_PROPERTY_NEED_RESET = "needReset";
  @javax.annotation.Nullable  private Boolean needReset;

  public VectorizationSettingsDto() {
  }


  public VectorizationSettingsDto type(@javax.annotation.Nullable EmbeddingProviderType type) {
  ...
  public EmbeddingProviderType getType() {
    return type;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setType(@javax.annotation.Nullable EmbeddingProviderType type) {
    this.type = type;
  }

  public VectorizationSettingsDto needReset(@javax.annotation.Nullable Boolean needReset) {
  ...
  public boolean equals(Object o) {
    ...
    VectorizationSettingsDto vectorizationSettingsDto = (VectorizationSettingsDto) o;
    return Objects.equals(this.type, vectorizationSettingsDto.type) &&
        Objects.equals(this.needReset, vectorizationSettingsDto.needReset);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, needReset);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VectorizationSettingsDto {\n");
