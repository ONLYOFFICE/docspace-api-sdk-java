...
@JsonPropertyOrder({
  ...
  AiChatPrice.JSON_PROPERTY_COMPLETION
})
...
public class AiChatPrice {
  ...
  public AiChatPrice prompt(@javax.annotation.Nullable Double prompt) {
  ...
  public AiChatPrice completion(@javax.annotation.Nullable Double completion) {
  ...
  public boolean equals(Object o) {
    ...
    AiChatPrice aiChatPrice = (AiChatPrice) o;
    return Objects.equals(this.prompt, aiChatPrice.prompt) &&
        Objects.equals(this.completion, aiChatPrice.completion);
  }
