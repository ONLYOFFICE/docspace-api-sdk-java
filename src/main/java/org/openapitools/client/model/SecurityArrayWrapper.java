...
import org.openapitools.client.model.SecurityDto;
 ...
 */
@JsonPropertyOrder({
  SecurityArrayWrapper.JSON_PROPERTY_RESPONSE,
  SecurityArrayWrapper.JSON_PROPERTY_COUNT,
  SecurityArrayWrapper.JSON_PROPERTY_LINKS,
  SecurityArrayWrapper.JSON_PROPERTY_STATUS,
  SecurityArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class SecurityArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<SecurityDto> response = new ArrayList<>();
  ...
  public SecurityArrayWrapper addResponseItem(SecurityDto responseItem) {
  ...
  public List<SecurityDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<SecurityDto> response) {
    this.response = response;
  }

  public SecurityArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public SecurityArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public SecurityArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public SecurityArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public SecurityArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    SecurityArrayWrapper securityArrayWrapper = (SecurityArrayWrapper) o;
    return Objects.equals(this.response, securityArrayWrapper.response) &&
        Objects.equals(this.count, securityArrayWrapper.count) &&
        Objects.equals(this.links, securityArrayWrapper.links) &&
        Objects.equals(this.status, securityArrayWrapper.status) &&
        Objects.equals(this.statusCode, securityArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class SecurityArrayWrapper {\n");
