...
import org.openapitools.client.model.StorageSettings;
...
@JsonPropertyOrder({
  ...
  StorageSettingsWrapper.JSON_PROPERTY_COUNT,
  StorageSettingsWrapper.JSON_PROPERTY_LINKS,
  StorageSettingsWrapper.JSON_PROPERTY_STATUS,
  StorageSettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class StorageSettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private StorageSettings response;
  ...
  public StorageSettings getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable StorageSettings response) {
    this.response = response;
  }

  public StorageSettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public StorageSettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public StorageSettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public StorageSettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public StorageSettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    StorageSettingsWrapper storageSettingsWrapper = (StorageSettingsWrapper) o;
    return Objects.equals(this.response, storageSettingsWrapper.response) &&
        Objects.equals(this.count, storageSettingsWrapper.count) &&
        Objects.equals(this.links, storageSettingsWrapper.links) &&
        Objects.equals(this.status, storageSettingsWrapper.status) &&
        Objects.equals(this.statusCode, storageSettingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorageSettingsWrapper {\n");
