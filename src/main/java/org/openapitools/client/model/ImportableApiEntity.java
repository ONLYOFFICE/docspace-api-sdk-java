...
public class ImportableApiEntity {
  ...
  public boolean equals(Object o) {
    ...
    ImportableApiEntity importableApiEntity = (ImportableApiEntity) o;
    return Objects.equals(this.shouldImport, importableApiEntity.shouldImport);
  }

  @Override
  public int hashCode() {
    return Objects.hash(shouldImport);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ImportableApiEntity {\n");
