...
@JsonPropertyOrder({
  ...
  TenantDeepLinkSettingsWrapper.JSON_PROPERTY_COUNT,
  TenantDeepLinkSettingsWrapper.JSON_PROPERTY_LINKS,
  TenantDeepLinkSettingsWrapper.JSON_PROPERTY_STATUS,
  TenantDeepLinkSettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class TenantDeepLinkSettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private TenantDeepLinkSettings response;
  ...
  public TenantDeepLinkSettings getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable TenantDeepLinkSettings response) {
    this.response = response;
  }

  public TenantDeepLinkSettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public TenantDeepLinkSettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public TenantDeepLinkSettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public TenantDeepLinkSettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public TenantDeepLinkSettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    TenantDeepLinkSettingsWrapper tenantDeepLinkSettingsWrapper = (TenantDeepLinkSettingsWrapper) o;
    return Objects.equals(this.response, tenantDeepLinkSettingsWrapper.response) &&
        Objects.equals(this.count, tenantDeepLinkSettingsWrapper.count) &&
        Objects.equals(this.links, tenantDeepLinkSettingsWrapper.links) &&
        Objects.equals(this.status, tenantDeepLinkSettingsWrapper.status) &&
        Objects.equals(this.statusCode, tenantDeepLinkSettingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class TenantDeepLinkSettingsWrapper {\n");
