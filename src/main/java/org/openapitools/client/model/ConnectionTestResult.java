...
@JsonPropertyOrder({
  ...
  ConnectionTestResult.JSON_PROPERTY_ERROR
})
...
public class ConnectionTestResult {
  ...
  public ConnectionTestResult success(@javax.annotation.Nullable Boolean success) {
  ...
  public ConnectionTestResult error(@javax.annotation.Nullable String error) {
  ...
  public boolean equals(Object o) {
    ...
    ConnectionTestResult connectionTestResult = (ConnectionTestResult) o;
    return Objects.equals(this.success, connectionTestResult.success) &&
        equalsNullable(this.error, connectionTestResult.error);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(success, hashCodeNullable(error));
  }
  ...
  public String toString() {
    ...
    sb.append("class ConnectionTestResult {\n");
