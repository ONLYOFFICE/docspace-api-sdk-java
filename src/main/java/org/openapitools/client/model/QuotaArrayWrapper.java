...
import org.openapitools.client.model.QuotaDto;
 ...
 */
@JsonPropertyOrder({
  QuotaArrayWrapper.JSON_PROPERTY_RESPONSE,
  QuotaArrayWrapper.JSON_PROPERTY_COUNT,
  QuotaArrayWrapper.JSON_PROPERTY_LINKS,
  QuotaArrayWrapper.JSON_PROPERTY_STATUS,
  QuotaArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class QuotaArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<QuotaDto> response = new ArrayList<>();
  ...
  public QuotaArrayWrapper() {
  }


  public QuotaArrayWrapper response(@javax.annotation.Nullable List<QuotaDto> response) {
    
    this.response = response;
    return this;
  }

  public QuotaArrayWrapper addResponseItem(QuotaDto responseItem) {
  ...
  public List<QuotaDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<QuotaDto> response) {
    this.response = response;
  }

  public QuotaArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public QuotaArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public QuotaArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public QuotaArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public QuotaArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    QuotaArrayWrapper quotaArrayWrapper = (QuotaArrayWrapper) o;
    return Objects.equals(this.response, quotaArrayWrapper.response) &&
        Objects.equals(this.count, quotaArrayWrapper.count) &&
        Objects.equals(this.links, quotaArrayWrapper.links) &&
        Objects.equals(this.status, quotaArrayWrapper.status) &&
        Objects.equals(this.statusCode, quotaArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class QuotaArrayWrapper {\n");
