...
public class SsoSettingsRequestsDto {
  ...
  public boolean equals(Object o) {
    ...
    SsoSettingsRequestsDto ssoSettingsRequestsDto = (SsoSettingsRequestsDto) o;
    return Objects.equals(this.serializeSettings, ssoSettingsRequestsDto.serializeSettings);
  }

  @Override
  public int hashCode() {
    return Objects.hash(serializeSettings);
  }
  ...
  public String toString() {
    ...
    sb.append("    serializeSettings: ").append(toIndentedString(serializeSettings)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `serializeSettings` to the URL query string
    if (getSerializeSettings() != null) {
      try {
        joiner.add(String.format("%sserializeSettings%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getSerializeSettings()), "UTF-8").replaceAll("\\+", "%20")));
