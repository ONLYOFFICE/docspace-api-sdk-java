...
import org.openapitools.client.model.TenantUserQuotaSettings;
 ...
 */
@JsonPropertyOrder({
  TenantUserQuotaSettingsWrapper.JSON_PROPERTY_RESPONSE,
  TenantUserQuotaSettingsWrapper.JSON_PROPERTY_COUNT,
  TenantUserQuotaSettingsWrapper.JSON_PROPERTY_LINKS,
  TenantUserQuotaSettingsWrapper.JSON_PROPERTY_STATUS,
  TenantUserQuotaSettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class TenantUserQuotaSettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private TenantUserQuotaSettings response;
  ...
  public TenantUserQuotaSettingsWrapper() {
  }


  public TenantUserQuotaSettingsWrapper response(@javax.annotation.Nullable TenantUserQuotaSettings response) {
  ...
  public TenantUserQuotaSettings getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable TenantUserQuotaSettings response) {
    this.response = response;
  }

  public TenantUserQuotaSettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public TenantUserQuotaSettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public TenantUserQuotaSettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public TenantUserQuotaSettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public TenantUserQuotaSettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    TenantUserQuotaSettingsWrapper tenantUserQuotaSettingsWrapper = (TenantUserQuotaSettingsWrapper) o;
    return Objects.equals(this.response, tenantUserQuotaSettingsWrapper.response) &&
        Objects.equals(this.count, tenantUserQuotaSettingsWrapper.count) &&
        Objects.equals(this.links, tenantUserQuotaSettingsWrapper.links) &&
        Objects.equals(this.status, tenantUserQuotaSettingsWrapper.status) &&
        Objects.equals(this.statusCode, tenantUserQuotaSettingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class TenantUserQuotaSettingsWrapper {\n");
