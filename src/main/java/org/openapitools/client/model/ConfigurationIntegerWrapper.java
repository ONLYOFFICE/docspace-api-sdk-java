...
import org.openapitools.client.model.ConfigurationDtoInteger;
 ...
 */
@JsonPropertyOrder({
  ConfigurationIntegerWrapper.JSON_PROPERTY_RESPONSE,
  ConfigurationIntegerWrapper.JSON_PROPERTY_COUNT,
  ConfigurationIntegerWrapper.JSON_PROPERTY_LINKS,
  ConfigurationIntegerWrapper.JSON_PROPERTY_STATUS,
  ConfigurationIntegerWrapper.JSON_PROPERTY_STATUS_CODE
})

public class ConfigurationIntegerWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private ConfigurationDtoInteger response;
  ...
  public ConfigurationDtoInteger getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable ConfigurationDtoInteger response) {
    this.response = response;
  }

  public ConfigurationIntegerWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public ConfigurationIntegerWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public ConfigurationIntegerWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public ConfigurationIntegerWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public ConfigurationIntegerWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    ConfigurationIntegerWrapper configurationIntegerWrapper = (ConfigurationIntegerWrapper) o;
    return Objects.equals(this.response, configurationIntegerWrapper.response) &&
        Objects.equals(this.count, configurationIntegerWrapper.count) &&
        Objects.equals(this.links, configurationIntegerWrapper.links) &&
        Objects.equals(this.status, configurationIntegerWrapper.status) &&
        Objects.equals(this.statusCode, configurationIntegerWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConfigurationIntegerWrapper {\n");
