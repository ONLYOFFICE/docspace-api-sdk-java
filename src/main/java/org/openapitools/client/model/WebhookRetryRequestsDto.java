 ...
 */
@JsonPropertyOrder({
  WebhookRetryRequestsDto.JSON_PROPERTY_IDS
})
...
public class WebhookRetryRequestsDto {
  ...
  public WebhookRetryRequestsDto addIdsItem(Integer idsItem) {
    if (this.ids == null || !this.ids.isPresent()) {
      this.ids = JsonNullable.<List<Integer>>of(new ArrayList<>());
    }
    try {
  ...
  @JsonProperty(JSON_PROPERTY_IDS)
  public void setIds_JsonNullable(JsonNullable<List<Integer>> ids) {
    this.ids = ids;
  }
  ...
  public boolean equals(Object o) {
    ...
    WebhookRetryRequestsDto webhookRetryRequestsDto = (WebhookRetryRequestsDto) o;
    return equalsNullable(this.ids, webhookRetryRequestsDto.ids);
  }
