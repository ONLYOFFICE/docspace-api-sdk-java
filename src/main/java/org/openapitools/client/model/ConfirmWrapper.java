...
import org.openapitools.client.model.ConfirmDto;
...
@JsonPropertyOrder({
  ...
  ConfirmWrapper.JSON_PROPERTY_COUNT,
  ConfirmWrapper.JSON_PROPERTY_LINKS,
  ConfirmWrapper.JSON_PROPERTY_STATUS,
  ConfirmWrapper.JSON_PROPERTY_STATUS_CODE
})

public class ConfirmWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private ConfirmDto response;
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable ConfirmDto response) {
    this.response = response;
  }

  public ConfirmWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public ConfirmWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public ConfirmWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public ConfirmWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public ConfirmWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    ConfirmWrapper confirmWrapper = (ConfirmWrapper) o;
    return Objects.equals(this.response, confirmWrapper.response) &&
        Objects.equals(this.count, confirmWrapper.count) &&
        Objects.equals(this.links, confirmWrapper.links) &&
        Objects.equals(this.status, confirmWrapper.status) &&
        Objects.equals(this.statusCode, confirmWrapper.statusCode);
  }
