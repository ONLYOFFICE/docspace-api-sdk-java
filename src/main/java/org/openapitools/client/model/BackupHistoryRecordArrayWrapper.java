...
import org.openapitools.client.model.BackupHistoryRecord;
...
@JsonPropertyOrder({
  ...
  BackupHistoryRecordArrayWrapper.JSON_PROPERTY_COUNT,
  BackupHistoryRecordArrayWrapper.JSON_PROPERTY_LINKS,
  BackupHistoryRecordArrayWrapper.JSON_PROPERTY_STATUS,
  BackupHistoryRecordArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class BackupHistoryRecordArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<BackupHistoryRecord> response = new ArrayList<>();
  ...
  public BackupHistoryRecordArrayWrapper addResponseItem(BackupHistoryRecord responseItem) {
  ...
  public List<BackupHistoryRecord> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<BackupHistoryRecord> response) {
    this.response = response;
  }

  public BackupHistoryRecordArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public BackupHistoryRecordArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public BackupHistoryRecordArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public BackupHistoryRecordArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public BackupHistoryRecordArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    BackupHistoryRecordArrayWrapper backupHistoryRecordArrayWrapper = (BackupHistoryRecordArrayWrapper) o;
    return Objects.equals(this.response, backupHistoryRecordArrayWrapper.response) &&
        Objects.equals(this.count, backupHistoryRecordArrayWrapper.count) &&
        Objects.equals(this.links, backupHistoryRecordArrayWrapper.links) &&
        Objects.equals(this.status, backupHistoryRecordArrayWrapper.status) &&
        Objects.equals(this.statusCode, backupHistoryRecordArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class BackupHistoryRecordArrayWrapper {\n");
