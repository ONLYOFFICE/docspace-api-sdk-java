...
import org.openapitools.client.model.ActiveConnectionsDto;
...
@JsonPropertyOrder({
  ...
  ActiveConnectionsWrapper.JSON_PROPERTY_COUNT,
  ActiveConnectionsWrapper.JSON_PROPERTY_LINKS,
  ActiveConnectionsWrapper.JSON_PROPERTY_STATUS,
  ActiveConnectionsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class ActiveConnectionsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private ActiveConnectionsDto response;
  ...
  public ActiveConnectionsDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable ActiveConnectionsDto response) {
    this.response = response;
  }

  public ActiveConnectionsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public ActiveConnectionsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public ActiveConnectionsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public ActiveConnectionsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public ActiveConnectionsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    ActiveConnectionsWrapper activeConnectionsWrapper = (ActiveConnectionsWrapper) o;
    return Objects.equals(this.response, activeConnectionsWrapper.response) &&
        Objects.equals(this.count, activeConnectionsWrapper.count) &&
        Objects.equals(this.links, activeConnectionsWrapper.links) &&
        Objects.equals(this.status, activeConnectionsWrapper.status) &&
        Objects.equals(this.statusCode, activeConnectionsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class ActiveConnectionsWrapper {\n");
