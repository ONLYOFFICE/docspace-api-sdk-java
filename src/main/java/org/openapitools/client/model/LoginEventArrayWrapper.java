...
import org.openapitools.client.model.LoginEventDto;
...
@JsonPropertyOrder({
  ...
  LoginEventArrayWrapper.JSON_PROPERTY_COUNT,
  LoginEventArrayWrapper.JSON_PROPERTY_LINKS,
  LoginEventArrayWrapper.JSON_PROPERTY_STATUS,
  LoginEventArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class LoginEventArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<LoginEventDto> response = new ArrayList<>();
  ...
  public LoginEventArrayWrapper addResponseItem(LoginEventDto responseItem) {
  ...
  public List<LoginEventDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<LoginEventDto> response) {
    this.response = response;
  }

  public LoginEventArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public LoginEventArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public LoginEventArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public LoginEventArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public LoginEventArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    LoginEventArrayWrapper loginEventArrayWrapper = (LoginEventArrayWrapper) o;
    return Objects.equals(this.response, loginEventArrayWrapper.response) &&
        Objects.equals(this.count, loginEventArrayWrapper.count) &&
        Objects.equals(this.links, loginEventArrayWrapper.links) &&
        Objects.equals(this.status, loginEventArrayWrapper.status) &&
        Objects.equals(this.statusCode, loginEventArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoginEventArrayWrapper {\n");
