 ...
 */
@JsonPropertyOrder({
  CreateAgentRequestDto.JSON_PROPERTY_TITLE,
  CreateAgentRequestDto.JSON_PROPERTY_QUOTA,
  CreateAgentRequestDto.JSON_PROPERTY_INDEXING,
  CreateAgentRequestDto.JSON_PROPERTY_DENY_DOWNLOAD,
  CreateAgentRequestDto.JSON_PROPERTY_LIFETIME,
  CreateAgentRequestDto.JSON_PROPERTY_WATERMARK,
  CreateAgentRequestDto.JSON_PROPERTY_LOGO,
  CreateAgentRequestDto.JSON_PROPERTY_TAGS,
  CreateAgentRequestDto.JSON_PROPERTY_COLOR,
  CreateAgentRequestDto.JSON_PROPERTY_COVER,
  CreateAgentRequestDto.JSON_PROPERTY_PRIVATE,
  CreateAgentRequestDto.JSON_PROPERTY_SHARE,
  CreateAgentRequestDto.JSON_PROPERTY_CHAT_SETTINGS,
  CreateAgentRequestDto.JSON_PROPERTY_ATTACH_DEFAULT_TOOLS
})
...
public class CreateAgentRequestDto {
  ...
  @javax.annotation.Nonnull  private ChatSettings chatSettings;
  ...
  public CreateAgentRequestDto title(@javax.annotation.Nullable String title) {
  ...
  public CreateAgentRequestDto quota(@javax.annotation.Nullable Long quota) {
  ...
  public CreateAgentRequestDto indexing(@javax.annotation.Nullable Boolean indexing) {
  ...
  public CreateAgentRequestDto denyDownload(@javax.annotation.Nullable Boolean denyDownload) {
  ...
  public CreateAgentRequestDto lifetime(@javax.annotation.Nullable RoomDataLifetimeDto lifetime) {
  ...
  public CreateAgentRequestDto watermark(@javax.annotation.Nullable WatermarkRequestDto watermark) {
  ...
  public CreateAgentRequestDto logo(@javax.annotation.Nullable LogoRequest logo) {
  ...
  public CreateAgentRequestDto tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = JsonNullable.<List<String>>of(tags);
    
    return this;
  }

  public CreateAgentRequestDto addTagsItem(String tagsItem) {
  ...
  public CreateAgentRequestDto color(@javax.annotation.Nullable String color) {
  ...
  public CreateAgentRequestDto cover(@javax.annotation.Nullable String cover) {
  ...
  public CreateAgentRequestDto _private(@javax.annotation.Nullable Boolean _private) {
  ...
  public CreateAgentRequestDto share(@javax.annotation.Nullable List<FileShareParams> share) {
    this.share = JsonNullable.<List<FileShareParams>>of(share);
    
    return this;
  }

  public CreateAgentRequestDto addShareItem(FileShareParams shareItem) {
  ...
  public CreateAgentRequestDto chatSettings(@javax.annotation.Nonnull ChatSettings chatSettings) {
   ...
   * @return chatSettings
   */
  @javax.annotation.Nonnull  @JsonProperty(value = JSON_PROPERTY_CHAT_SETTINGS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  @JsonProperty(value = JSON_PROPERTY_CHAT_SETTINGS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setChatSettings(@javax.annotation.Nonnull ChatSettings chatSettings) {
    this.chatSettings = chatSettings;
  }

  public CreateAgentRequestDto attachDefaultTools(@javax.annotation.Nullable Boolean attachDefaultTools) {
  ...
  public boolean equals(Object o) {
    ...
    CreateAgentRequestDto createAgentRequestDto = (CreateAgentRequestDto) o;
    return Objects.equals(this.title, createAgentRequestDto.title) &&
        equalsNullable(this.quota, createAgentRequestDto.quota) &&
        equalsNullable(this.indexing, createAgentRequestDto.indexing) &&
        equalsNullable(this.denyDownload, createAgentRequestDto.denyDownload) &&
        Objects.equals(this.lifetime, createAgentRequestDto.lifetime) &&
        Objects.equals(this.watermark, createAgentRequestDto.watermark) &&
        Objects.equals(this.logo, createAgentRequestDto.logo) &&
        equalsNullable(this.tags, createAgentRequestDto.tags) &&
        equalsNullable(this.color, createAgentRequestDto.color) &&
        equalsNullable(this.cover, createAgentRequestDto.cover) &&
        Objects.equals(this._private, createAgentRequestDto._private) &&
        equalsNullable(this.share, createAgentRequestDto.share) &&
        Objects.equals(this.chatSettings, createAgentRequestDto.chatSettings) &&
        Objects.equals(this.attachDefaultTools, createAgentRequestDto.attachDefaultTools);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, hashCodeNullable(quota), hashCodeNullable(indexing), hashCodeNullable(denyDownload), lifetime, watermark, logo, hashCodeNullable(tags), hashCodeNullable(color), hashCodeNullable(cover), _private, hashCodeNullable(share), chatSettings, attachDefaultTools);
  }
