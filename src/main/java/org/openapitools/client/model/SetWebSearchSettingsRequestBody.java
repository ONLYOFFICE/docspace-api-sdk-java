 ...
 */
@JsonPropertyOrder({
  SetWebSearchSettingsRequestBody.JSON_PROPERTY_ENABLED,
  SetWebSearchSettingsRequestBody.JSON_PROPERTY_TYPE,
  SetWebSearchSettingsRequestBody.JSON_PROPERTY_KEY
})
...
public class SetWebSearchSettingsRequestBody {
  ...
  @javax.annotation.Nullable  private EngineType type;

  public static final String JSON_PROPERTY_KEY = "key";
  @javax.annotation.Nullable  private JsonNullable<String> key = JsonNullable.<String>undefined();

  public SetWebSearchSettingsRequestBody() {
  }


  public SetWebSearchSettingsRequestBody enabled(@javax.annotation.Nullable Boolean enabled) {
  ...
  public SetWebSearchSettingsRequestBody type(@javax.annotation.Nullable EngineType type) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setType(@javax.annotation.Nullable EngineType type) {
    this.type = type;
  }

  public SetWebSearchSettingsRequestBody key(@javax.annotation.Nullable String key) {
  ...
  public boolean equals(Object o) {
    ...
    SetWebSearchSettingsRequestBody setWebSearchSettingsRequestBody = (SetWebSearchSettingsRequestBody) o;
    return Objects.equals(this.enabled, setWebSearchSettingsRequestBody.enabled) &&
        Objects.equals(this.type, setWebSearchSettingsRequestBody.type) &&
        equalsNullable(this.key, setWebSearchSettingsRequestBody.key);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(enabled, type, hashCodeNullable(key));
  }
