...
@JsonPropertyOrder({
  ...
  RoomGroupWrapper.JSON_PROPERTY_COUNT,
  RoomGroupWrapper.JSON_PROPERTY_LINKS,
  RoomGroupWrapper.JSON_PROPERTY_STATUS,
  RoomGroupWrapper.JSON_PROPERTY_STATUS_CODE
})

public class RoomGroupWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private RoomGroupDto response;
  ...
  public RoomGroupWrapper() {
  }


  public RoomGroupWrapper response(@javax.annotation.Nullable RoomGroupDto response) {
  ...
  public RoomGroupDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable RoomGroupDto response) {
    this.response = response;
  }

  public RoomGroupWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public RoomGroupWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public RoomGroupWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public RoomGroupWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public RoomGroupWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    RoomGroupWrapper roomGroupWrapper = (RoomGroupWrapper) o;
    return Objects.equals(this.response, roomGroupWrapper.response) &&
        Objects.equals(this.count, roomGroupWrapper.count) &&
        Objects.equals(this.links, roomGroupWrapper.links) &&
        Objects.equals(this.status, roomGroupWrapper.status) &&
        Objects.equals(this.statusCode, roomGroupWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class RoomGroupWrapper {\n");
