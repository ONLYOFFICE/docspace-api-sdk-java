...
import org.openapitools.client.model.CurrenciesDto;
...
@JsonPropertyOrder({
  ...
  CurrenciesArrayWrapper.JSON_PROPERTY_COUNT,
  CurrenciesArrayWrapper.JSON_PROPERTY_LINKS,
  CurrenciesArrayWrapper.JSON_PROPERTY_STATUS,
  CurrenciesArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class CurrenciesArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<CurrenciesDto> response = new ArrayList<>();
  ...
  public CurrenciesArrayWrapper addResponseItem(CurrenciesDto responseItem) {
  ...
  public List<CurrenciesDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<CurrenciesDto> response) {
    this.response = response;
  }

  public CurrenciesArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public CurrenciesArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public CurrenciesArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public CurrenciesArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public CurrenciesArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    CurrenciesArrayWrapper currenciesArrayWrapper = (CurrenciesArrayWrapper) o;
    return Objects.equals(this.response, currenciesArrayWrapper.response) &&
        Objects.equals(this.count, currenciesArrayWrapper.count) &&
        Objects.equals(this.links, currenciesArrayWrapper.links) &&
        Objects.equals(this.status, currenciesArrayWrapper.status) &&
        Objects.equals(this.statusCode, currenciesArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class CurrenciesArrayWrapper {\n");
