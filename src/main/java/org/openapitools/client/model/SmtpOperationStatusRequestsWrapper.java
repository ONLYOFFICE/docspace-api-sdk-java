...
import org.openapitools.client.model.SmtpOperationStatusRequestsDto;
 ...
 */
@JsonPropertyOrder({
  SmtpOperationStatusRequestsWrapper.JSON_PROPERTY_RESPONSE,
  SmtpOperationStatusRequestsWrapper.JSON_PROPERTY_COUNT,
  SmtpOperationStatusRequestsWrapper.JSON_PROPERTY_LINKS,
  SmtpOperationStatusRequestsWrapper.JSON_PROPERTY_STATUS,
  SmtpOperationStatusRequestsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class SmtpOperationStatusRequestsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private SmtpOperationStatusRequestsDto response;
  ...
  public SmtpOperationStatusRequestsDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable SmtpOperationStatusRequestsDto response) {
    this.response = response;
  }

  public SmtpOperationStatusRequestsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public SmtpOperationStatusRequestsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public SmtpOperationStatusRequestsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public SmtpOperationStatusRequestsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public SmtpOperationStatusRequestsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    SmtpOperationStatusRequestsWrapper smtpOperationStatusRequestsWrapper = (SmtpOperationStatusRequestsWrapper) o;
    return Objects.equals(this.response, smtpOperationStatusRequestsWrapper.response) &&
        Objects.equals(this.count, smtpOperationStatusRequestsWrapper.count) &&
        Objects.equals(this.links, smtpOperationStatusRequestsWrapper.links) &&
        Objects.equals(this.status, smtpOperationStatusRequestsWrapper.status) &&
        Objects.equals(this.statusCode, smtpOperationStatusRequestsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class SmtpOperationStatusRequestsWrapper {\n");
