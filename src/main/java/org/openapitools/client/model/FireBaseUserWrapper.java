...
import org.openapitools.client.model.FireBaseUser;
 ...
 */
@JsonPropertyOrder({
  FireBaseUserWrapper.JSON_PROPERTY_RESPONSE,
  FireBaseUserWrapper.JSON_PROPERTY_COUNT,
  FireBaseUserWrapper.JSON_PROPERTY_LINKS,
  FireBaseUserWrapper.JSON_PROPERTY_STATUS,
  FireBaseUserWrapper.JSON_PROPERTY_STATUS_CODE
})

public class FireBaseUserWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private FireBaseUser response;
  ...
  public FireBaseUser getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable FireBaseUser response) {
    this.response = response;
  }

  public FireBaseUserWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public FireBaseUserWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public FireBaseUserWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public FireBaseUserWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public FireBaseUserWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    FireBaseUserWrapper fireBaseUserWrapper = (FireBaseUserWrapper) o;
    return Objects.equals(this.response, fireBaseUserWrapper.response) &&
        Objects.equals(this.count, fireBaseUserWrapper.count) &&
        Objects.equals(this.links, fireBaseUserWrapper.links) &&
        Objects.equals(this.status, fireBaseUserWrapper.status) &&
        Objects.equals(this.statusCode, fireBaseUserWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class FireBaseUserWrapper {\n");
