...
import org.openapitools.client.model.FolderDtoString;
...
@JsonPropertyOrder({
  ...
  FolderStringArrayWrapper.JSON_PROPERTY_COUNT,
  FolderStringArrayWrapper.JSON_PROPERTY_LINKS,
  FolderStringArrayWrapper.JSON_PROPERTY_STATUS,
  FolderStringArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class FolderStringArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<FolderDtoString> response = new ArrayList<>();
  ...
  public FolderStringArrayWrapper() {
  }


  public FolderStringArrayWrapper response(@javax.annotation.Nullable List<FolderDtoString> response) {
    
    this.response = response;
    return this;
  }

  public FolderStringArrayWrapper addResponseItem(FolderDtoString responseItem) {
  ...
  public List<FolderDtoString> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<FolderDtoString> response) {
    this.response = response;
  }

  public FolderStringArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public FolderStringArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public FolderStringArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public FolderStringArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public FolderStringArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    FolderStringArrayWrapper folderStringArrayWrapper = (FolderStringArrayWrapper) o;
    return Objects.equals(this.response, folderStringArrayWrapper.response) &&
        Objects.equals(this.count, folderStringArrayWrapper.count) &&
        Objects.equals(this.links, folderStringArrayWrapper.links) &&
        Objects.equals(this.status, folderStringArrayWrapper.status) &&
        Objects.equals(this.statusCode, folderStringArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class FolderStringArrayWrapper {\n");
