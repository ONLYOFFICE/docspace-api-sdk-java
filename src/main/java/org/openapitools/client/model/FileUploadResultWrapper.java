...
import org.openapitools.client.model.FileUploadResultDto;
...
@JsonPropertyOrder({
  ...
  FileUploadResultWrapper.JSON_PROPERTY_COUNT,
  FileUploadResultWrapper.JSON_PROPERTY_LINKS,
  FileUploadResultWrapper.JSON_PROPERTY_STATUS,
  FileUploadResultWrapper.JSON_PROPERTY_STATUS_CODE
})

public class FileUploadResultWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private FileUploadResultDto response;
  ...
  public FileUploadResultDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable FileUploadResultDto response) {
    this.response = response;
  }

  public FileUploadResultWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public FileUploadResultWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public FileUploadResultWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public FileUploadResultWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public FileUploadResultWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    FileUploadResultWrapper fileUploadResultWrapper = (FileUploadResultWrapper) o;
    return Objects.equals(this.response, fileUploadResultWrapper.response) &&
        Objects.equals(this.count, fileUploadResultWrapper.count) &&
        Objects.equals(this.links, fileUploadResultWrapper.links) &&
        Objects.equals(this.status, fileUploadResultWrapper.status) &&
        Objects.equals(this.statusCode, fileUploadResultWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class FileUploadResultWrapper {\n");
