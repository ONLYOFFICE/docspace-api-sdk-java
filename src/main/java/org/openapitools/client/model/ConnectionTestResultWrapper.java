 ...
 */
@JsonPropertyOrder({
  ConnectionTestResultWrapper.JSON_PROPERTY_RESPONSE,
  ConnectionTestResultWrapper.JSON_PROPERTY_COUNT,
  ConnectionTestResultWrapper.JSON_PROPERTY_LINKS,
  ConnectionTestResultWrapper.JSON_PROPERTY_STATUS,
  ConnectionTestResultWrapper.JSON_PROPERTY_STATUS_CODE
})

public class ConnectionTestResultWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private ConnectionTestResult response;
  ...
  public ConnectionTestResultWrapper() {
  }


  public ConnectionTestResultWrapper response(@javax.annotation.Nullable ConnectionTestResult response) {
  ...
  public ConnectionTestResult getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable ConnectionTestResult response) {
    this.response = response;
  }

  public ConnectionTestResultWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public ConnectionTestResultWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public ConnectionTestResultWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public ConnectionTestResultWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public ConnectionTestResultWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    ConnectionTestResultWrapper connectionTestResultWrapper = (ConnectionTestResultWrapper) o;
    return Objects.equals(this.response, connectionTestResultWrapper.response) &&
        Objects.equals(this.count, connectionTestResultWrapper.count) &&
        Objects.equals(this.links, connectionTestResultWrapper.links) &&
        Objects.equals(this.status, connectionTestResultWrapper.status) &&
        Objects.equals(this.statusCode, connectionTestResultWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConnectionTestResultWrapper {\n");
