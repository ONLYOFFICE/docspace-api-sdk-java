...
public class LockFileParameters {
  ...
  public boolean equals(Object o) {
    ...
    LockFileParameters lockFileParameters = (LockFileParameters) o;
    return Objects.equals(this.lockFile, lockFileParameters.lockFile);
  }

  @Override
  public int hashCode() {
    return Objects.hash(lockFile);
  }
  ...
  public String toString() {
    ...
    sb.append("    lockFile: ").append(toIndentedString(lockFile)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `lockFile` to the URL query string
    if (getLockFile() != null) {
      try {
        joiner.add(String.format("%slockFile%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getLockFile()), "UTF-8").replaceAll("\\+", "%20")));
