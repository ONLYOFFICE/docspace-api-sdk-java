...
import org.openapitools.client.model.UploadResultDto;
...
@JsonPropertyOrder({
  ...
  UploadResultWrapper.JSON_PROPERTY_COUNT,
  UploadResultWrapper.JSON_PROPERTY_LINKS,
  UploadResultWrapper.JSON_PROPERTY_STATUS,
  UploadResultWrapper.JSON_PROPERTY_STATUS_CODE
})

public class UploadResultWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private UploadResultDto response;
  ...
  public UploadResultDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable UploadResultDto response) {
    this.response = response;
  }

  public UploadResultWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public UploadResultWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public UploadResultWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public UploadResultWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public UploadResultWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    UploadResultWrapper uploadResultWrapper = (UploadResultWrapper) o;
    return Objects.equals(this.response, uploadResultWrapper.response) &&
        Objects.equals(this.count, uploadResultWrapper.count) &&
        Objects.equals(this.links, uploadResultWrapper.links) &&
        Objects.equals(this.status, uploadResultWrapper.status) &&
        Objects.equals(this.statusCode, uploadResultWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class UploadResultWrapper {\n");
