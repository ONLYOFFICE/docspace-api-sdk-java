...
import org.openapitools.client.model.ServicePayment;
 ...
 */
@JsonPropertyOrder({
  ServicePaymentWrapper.JSON_PROPERTY_RESPONSE,
  ServicePaymentWrapper.JSON_PROPERTY_COUNT,
  ServicePaymentWrapper.JSON_PROPERTY_LINKS,
  ServicePaymentWrapper.JSON_PROPERTY_STATUS,
  ServicePaymentWrapper.JSON_PROPERTY_STATUS_CODE
})

public class ServicePaymentWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private ServicePayment response;
  ...
  public ServicePaymentWrapper() {
  }


  public ServicePaymentWrapper response(@javax.annotation.Nullable ServicePayment response) {
  ...
  public ServicePayment getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable ServicePayment response) {
    this.response = response;
  }

  public ServicePaymentWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public ServicePaymentWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public ServicePaymentWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public ServicePaymentWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public ServicePaymentWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    ServicePaymentWrapper servicePaymentWrapper = (ServicePaymentWrapper) o;
    return Objects.equals(this.response, servicePaymentWrapper.response) &&
        Objects.equals(this.count, servicePaymentWrapper.count) &&
        Objects.equals(this.links, servicePaymentWrapper.links) &&
        Objects.equals(this.status, servicePaymentWrapper.status) &&
        Objects.equals(this.statusCode, servicePaymentWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class ServicePaymentWrapper {\n");
