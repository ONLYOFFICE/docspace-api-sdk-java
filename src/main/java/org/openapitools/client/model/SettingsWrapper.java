...
@JsonPropertyOrder({
  ...
  SettingsWrapper.JSON_PROPERTY_COUNT,
  SettingsWrapper.JSON_PROPERTY_LINKS,
  SettingsWrapper.JSON_PROPERTY_STATUS,
  SettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class SettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private SettingsDto response;
  ...
  public SettingsDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable SettingsDto response) {
    this.response = response;
  }

  public SettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public SettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public SettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public SettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public SettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    SettingsWrapper settingsWrapper = (SettingsWrapper) o;
    return Objects.equals(this.response, settingsWrapper.response) &&
        Objects.equals(this.count, settingsWrapper.count) &&
        Objects.equals(this.links, settingsWrapper.links) &&
        Objects.equals(this.status, settingsWrapper.status) &&
        Objects.equals(this.statusCode, settingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class SettingsWrapper {\n");
