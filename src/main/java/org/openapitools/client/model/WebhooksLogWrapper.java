...
@JsonPropertyOrder({
  ...
  WebhooksLogWrapper.JSON_PROPERTY_COUNT,
  WebhooksLogWrapper.JSON_PROPERTY_LINKS,
  WebhooksLogWrapper.JSON_PROPERTY_STATUS,
  WebhooksLogWrapper.JSON_PROPERTY_STATUS_CODE
})

public class WebhooksLogWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private WebhooksLogDto response;
  ...
  public WebhooksLogWrapper() {
  }


  public WebhooksLogWrapper response(@javax.annotation.Nullable WebhooksLogDto response) {
  ...
  public WebhooksLogDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable WebhooksLogDto response) {
    this.response = response;
  }

  public WebhooksLogWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public WebhooksLogWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public WebhooksLogWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public WebhooksLogWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public WebhooksLogWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    WebhooksLogWrapper webhooksLogWrapper = (WebhooksLogWrapper) o;
    return Objects.equals(this.response, webhooksLogWrapper.response) &&
        Objects.equals(this.count, webhooksLogWrapper.count) &&
        Objects.equals(this.links, webhooksLogWrapper.links) &&
        Objects.equals(this.status, webhooksLogWrapper.status) &&
        Objects.equals(this.statusCode, webhooksLogWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhooksLogWrapper {\n");
