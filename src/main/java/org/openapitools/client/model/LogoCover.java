 ...
 */
@JsonPropertyOrder({
  LogoCover.JSON_PROPERTY_ID,
  LogoCover.JSON_PROPERTY_DATA
})
...
public class LogoCover {
  ...
  public LogoCover data(@javax.annotation.Nullable String data) {
  ...
  public boolean equals(Object o) {
    ...
    LogoCover logoCover = (LogoCover) o;
    return Objects.equals(this.id, logoCover.id) &&
        Objects.equals(this.data, logoCover.data);
  }
