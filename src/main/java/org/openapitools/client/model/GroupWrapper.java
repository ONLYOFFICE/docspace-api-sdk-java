...
@JsonPropertyOrder({
  ...
  GroupWrapper.JSON_PROPERTY_COUNT,
  GroupWrapper.JSON_PROPERTY_LINKS,
  GroupWrapper.JSON_PROPERTY_STATUS,
  GroupWrapper.JSON_PROPERTY_STATUS_CODE
})

public class GroupWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private GroupDto response;
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable GroupDto response) {
    this.response = response;
  }

  public GroupWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public GroupWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public GroupWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public GroupWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public GroupWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    GroupWrapper groupWrapper = (GroupWrapper) o;
    return Objects.equals(this.response, groupWrapper.response) &&
        Objects.equals(this.count, groupWrapper.count) &&
        Objects.equals(this.links, groupWrapper.links) &&
        Objects.equals(this.status, groupWrapper.status) &&
        Objects.equals(this.statusCode, groupWrapper.statusCode);
  }
