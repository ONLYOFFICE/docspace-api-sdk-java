...
import org.openapitools.client.model.TfaConfirmDataDto;
 ...
 */
@JsonPropertyOrder({
  TfaConfirmDataWrapper.JSON_PROPERTY_RESPONSE,
  TfaConfirmDataWrapper.JSON_PROPERTY_COUNT,
  TfaConfirmDataWrapper.JSON_PROPERTY_LINKS,
  TfaConfirmDataWrapper.JSON_PROPERTY_STATUS,
  TfaConfirmDataWrapper.JSON_PROPERTY_STATUS_CODE
})

public class TfaConfirmDataWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private TfaConfirmDataDto response;
  ...
  public TfaConfirmDataWrapper() {
  }


  public TfaConfirmDataWrapper response(@javax.annotation.Nullable TfaConfirmDataDto response) {
  ...
  public TfaConfirmDataDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable TfaConfirmDataDto response) {
    this.response = response;
  }

  public TfaConfirmDataWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public TfaConfirmDataWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public TfaConfirmDataWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public TfaConfirmDataWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public TfaConfirmDataWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    TfaConfirmDataWrapper tfaConfirmDataWrapper = (TfaConfirmDataWrapper) o;
    return Objects.equals(this.response, tfaConfirmDataWrapper.response) &&
        Objects.equals(this.count, tfaConfirmDataWrapper.count) &&
        Objects.equals(this.links, tfaConfirmDataWrapper.links) &&
        Objects.equals(this.status, tfaConfirmDataWrapper.status) &&
        Objects.equals(this.statusCode, tfaConfirmDataWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class TfaConfirmDataWrapper {\n");
