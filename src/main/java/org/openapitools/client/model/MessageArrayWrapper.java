 ...
 */
@JsonPropertyOrder({
  MessageArrayWrapper.JSON_PROPERTY_RESPONSE,
  MessageArrayWrapper.JSON_PROPERTY_COUNT,
  MessageArrayWrapper.JSON_PROPERTY_LINKS,
  MessageArrayWrapper.JSON_PROPERTY_STATUS,
  MessageArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class MessageArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<MessageDto> response = new ArrayList<>();
  ...
  public MessageArrayWrapper() {
  }


  public MessageArrayWrapper response(@javax.annotation.Nullable List<MessageDto> response) {
    
    this.response = response;
    return this;
  }

  public MessageArrayWrapper addResponseItem(MessageDto responseItem) {
  ...
  public List<MessageDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<MessageDto> response) {
    this.response = response;
  }

  public MessageArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public MessageArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public MessageArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public MessageArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public MessageArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    MessageArrayWrapper messageArrayWrapper = (MessageArrayWrapper) o;
    return Objects.equals(this.response, messageArrayWrapper.response) &&
        Objects.equals(this.count, messageArrayWrapper.count) &&
        Objects.equals(this.links, messageArrayWrapper.links) &&
        Objects.equals(this.status, messageArrayWrapper.status) &&
        Objects.equals(this.statusCode, messageArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class MessageArrayWrapper {\n");
