...
import org.openapitools.client.model.TfaSettingsDto;
 ...
 */
@JsonPropertyOrder({
  TfaSettingsArrayWrapper.JSON_PROPERTY_RESPONSE,
  TfaSettingsArrayWrapper.JSON_PROPERTY_COUNT,
  TfaSettingsArrayWrapper.JSON_PROPERTY_LINKS,
  TfaSettingsArrayWrapper.JSON_PROPERTY_STATUS,
  TfaSettingsArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class TfaSettingsArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<TfaSettingsDto> response = new ArrayList<>();
  ...
  public TfaSettingsArrayWrapper addResponseItem(TfaSettingsDto responseItem) {
  ...
  public List<TfaSettingsDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<TfaSettingsDto> response) {
    this.response = response;
  }

  public TfaSettingsArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public TfaSettingsArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public TfaSettingsArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public TfaSettingsArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public TfaSettingsArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    TfaSettingsArrayWrapper tfaSettingsArrayWrapper = (TfaSettingsArrayWrapper) o;
    return Objects.equals(this.response, tfaSettingsArrayWrapper.response) &&
        Objects.equals(this.count, tfaSettingsArrayWrapper.count) &&
        Objects.equals(this.links, tfaSettingsArrayWrapper.links) &&
        Objects.equals(this.status, tfaSettingsArrayWrapper.status) &&
        Objects.equals(this.statusCode, tfaSettingsArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class TfaSettingsArrayWrapper {\n");
