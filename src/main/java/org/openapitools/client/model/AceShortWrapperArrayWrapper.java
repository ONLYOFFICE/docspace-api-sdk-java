 ...
 */
@JsonPropertyOrder({
  AceShortWrapperArrayWrapper.JSON_PROPERTY_RESPONSE,
  AceShortWrapperArrayWrapper.JSON_PROPERTY_COUNT,
  AceShortWrapperArrayWrapper.JSON_PROPERTY_LINKS,
  AceShortWrapperArrayWrapper.JSON_PROPERTY_STATUS,
  AceShortWrapperArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class AceShortWrapperArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<AceShortWrapper> response = new ArrayList<>();
  ...
  public AceShortWrapperArrayWrapper addResponseItem(AceShortWrapper responseItem) {
  ...
  public List<AceShortWrapper> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<AceShortWrapper> response) {
    this.response = response;
  }

  public AceShortWrapperArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public AceShortWrapperArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public AceShortWrapperArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public AceShortWrapperArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public AceShortWrapperArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    AceShortWrapperArrayWrapper aceShortWrapperArrayWrapper = (AceShortWrapperArrayWrapper) o;
    return Objects.equals(this.response, aceShortWrapperArrayWrapper.response) &&
        Objects.equals(this.count, aceShortWrapperArrayWrapper.count) &&
        Objects.equals(this.links, aceShortWrapperArrayWrapper.links) &&
        Objects.equals(this.status, aceShortWrapperArrayWrapper.status) &&
        Objects.equals(this.statusCode, aceShortWrapperArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class AceShortWrapperArrayWrapper {\n");
