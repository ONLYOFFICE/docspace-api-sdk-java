...
import org.openapitools.client.model.CompanyWhiteLabelSettings;
...
@JsonPropertyOrder({
  ...
  CompanyWhiteLabelSettingsArrayWrapper.JSON_PROPERTY_COUNT,
  CompanyWhiteLabelSettingsArrayWrapper.JSON_PROPERTY_LINKS,
  CompanyWhiteLabelSettingsArrayWrapper.JSON_PROPERTY_STATUS,
  CompanyWhiteLabelSettingsArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class CompanyWhiteLabelSettingsArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<CompanyWhiteLabelSettings> response = new ArrayList<>();
  ...
  public CompanyWhiteLabelSettingsArrayWrapper addResponseItem(CompanyWhiteLabelSettings responseItem) {
  ...
  public List<CompanyWhiteLabelSettings> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<CompanyWhiteLabelSettings> response) {
    this.response = response;
  }

  public CompanyWhiteLabelSettingsArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public CompanyWhiteLabelSettingsArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public CompanyWhiteLabelSettingsArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public CompanyWhiteLabelSettingsArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public CompanyWhiteLabelSettingsArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    CompanyWhiteLabelSettingsArrayWrapper companyWhiteLabelSettingsArrayWrapper = (CompanyWhiteLabelSettingsArrayWrapper) o;
    return Objects.equals(this.response, companyWhiteLabelSettingsArrayWrapper.response) &&
        Objects.equals(this.count, companyWhiteLabelSettingsArrayWrapper.count) &&
        Objects.equals(this.links, companyWhiteLabelSettingsArrayWrapper.links) &&
        Objects.equals(this.status, companyWhiteLabelSettingsArrayWrapper.status) &&
        Objects.equals(this.statusCode, companyWhiteLabelSettingsArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class CompanyWhiteLabelSettingsArrayWrapper {\n");
