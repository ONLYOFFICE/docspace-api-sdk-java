 ...
 */
@JsonPropertyOrder({
  EmailActivationSettingsWrapper.JSON_PROPERTY_RESPONSE,
  EmailActivationSettingsWrapper.JSON_PROPERTY_COUNT,
  EmailActivationSettingsWrapper.JSON_PROPERTY_LINKS,
  EmailActivationSettingsWrapper.JSON_PROPERTY_STATUS,
  EmailActivationSettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class EmailActivationSettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private EmailActivationSettings response;
  ...
  public EmailActivationSettings getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable EmailActivationSettings response) {
    this.response = response;
  }

  public EmailActivationSettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public EmailActivationSettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public EmailActivationSettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public EmailActivationSettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public EmailActivationSettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    EmailActivationSettingsWrapper emailActivationSettingsWrapper = (EmailActivationSettingsWrapper) o;
    return Objects.equals(this.response, emailActivationSettingsWrapper.response) &&
        Objects.equals(this.count, emailActivationSettingsWrapper.count) &&
        Objects.equals(this.links, emailActivationSettingsWrapper.links) &&
        Objects.equals(this.status, emailActivationSettingsWrapper.status) &&
        Objects.equals(this.statusCode, emailActivationSettingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmailActivationSettingsWrapper {\n");
