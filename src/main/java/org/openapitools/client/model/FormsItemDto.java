 ...
 */
@JsonPropertyOrder({
  FormsItemDto.JSON_PROPERTY_KEY,
  FormsItemDto.JSON_PROPERTY_TYPE
})
@javax.annotation.Generated(value = "com.example.codegen.MyJavaClientCodegen", date = "2025-11-10T06:17:22.719994700+03:00[Europe/Moscow]", comments = "Generator version: 7.14.0")
public class FormsItemDto {
  ...
  public FormsItemDto type(@javax.annotation.Nullable String type) {
  ...
  public boolean equals(Object o) {
    ...
    FormsItemDto formsItemDto = (FormsItemDto) o;
    return equalsNullable(this.key, formsItemDto.key) &&
        equalsNullable(this.type, formsItemDto.type);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(key), hashCodeNullable(type));
  }
