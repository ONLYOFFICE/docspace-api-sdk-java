 ...
 */
@JsonPropertyOrder({
  ContinueChatBody.JSON_PROPERTY_MESSAGE,
  ContinueChatBody.JSON_PROPERTY_CONTEXT_FOLDER_ID,
  ContinueChatBody.JSON_PROPERTY_FILES
})
...
public class ContinueChatBody {
  ...
  @javax.annotation.Nullable  private Integer contextFolderId;
  ...
  public ContinueChatBody() {
  }


  public ContinueChatBody message(@javax.annotation.Nullable String message) {
  ...
  public ContinueChatBody contextFolderId(@javax.annotation.Nullable Integer contextFolderId) {
   ...
   */
  @javax.annotation.Nullable  @JsonProperty(value = JSON_PROPERTY_CONTEXT_FOLDER_ID, required = false)
  ...
  public ContinueChatBody files(@javax.annotation.Nullable List<ContinueChatBodyFilesInner> files) {
    this.files = JsonNullable.<List<ContinueChatBodyFilesInner>>of(files);
    
    return this;
  }

  public ContinueChatBody addFilesItem(ContinueChatBodyFilesInner filesItem) {
  ...
  public boolean equals(Object o) {
    ...
    ContinueChatBody continueChatBody = (ContinueChatBody) o;
    return Objects.equals(this.message, continueChatBody.message) &&
        Objects.equals(this.contextFolderId, continueChatBody.contextFolderId) &&
        equalsNullable(this.files, continueChatBody.files);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(message, contextFolderId, hashCodeNullable(files));
  }
