...
@JsonPropertyOrder({
  ...
  ArrayArrayWrapper.JSON_PROPERTY_COUNT,
  ArrayArrayWrapper.JSON_PROPERTY_LINKS,
  ArrayArrayWrapper.JSON_PROPERTY_STATUS,
  ArrayArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class ArrayArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<List<String>> response = new ArrayList<>();
  ...
  public ArrayArrayWrapper addResponseItem(List<String> responseItem) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<List<String>> response) {
    this.response = response;
  }

  public ArrayArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public ArrayArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public ArrayArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public ArrayArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public ArrayArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    ArrayArrayWrapper arrayArrayWrapper = (ArrayArrayWrapper) o;
    return Objects.equals(this.response, arrayArrayWrapper.response) &&
        Objects.equals(this.count, arrayArrayWrapper.count) &&
        Objects.equals(this.links, arrayArrayWrapper.links) &&
        Objects.equals(this.status, arrayArrayWrapper.status) &&
        Objects.equals(this.statusCode, arrayArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class ArrayArrayWrapper {\n");
