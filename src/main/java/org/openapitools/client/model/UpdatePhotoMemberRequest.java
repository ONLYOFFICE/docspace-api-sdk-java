 ...
 */
@JsonPropertyOrder({
  UpdatePhotoMemberRequest.JSON_PROPERTY_FILES
})
...
public class UpdatePhotoMemberRequest {
  ...
  public boolean equals(Object o) {
    ...
    UpdatePhotoMemberRequest updatePhotoMemberRequest = (UpdatePhotoMemberRequest) o;
    return equalsNullable(this.files, updatePhotoMemberRequest.files);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(files));
  }
