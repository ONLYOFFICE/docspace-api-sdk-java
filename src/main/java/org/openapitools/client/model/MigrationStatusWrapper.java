...
import org.openapitools.client.model.MigrationStatusDto;
 ...
 */
@JsonPropertyOrder({
  MigrationStatusWrapper.JSON_PROPERTY_RESPONSE,
  MigrationStatusWrapper.JSON_PROPERTY_COUNT,
  MigrationStatusWrapper.JSON_PROPERTY_LINKS,
  MigrationStatusWrapper.JSON_PROPERTY_STATUS,
  MigrationStatusWrapper.JSON_PROPERTY_STATUS_CODE
})

public class MigrationStatusWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private MigrationStatusDto response;
  ...
  public MigrationStatusDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable MigrationStatusDto response) {
    this.response = response;
  }

  public MigrationStatusWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public MigrationStatusWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public MigrationStatusWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public MigrationStatusWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public MigrationStatusWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    MigrationStatusWrapper migrationStatusWrapper = (MigrationStatusWrapper) o;
    return Objects.equals(this.response, migrationStatusWrapper.response) &&
        Objects.equals(this.count, migrationStatusWrapper.count) &&
        Objects.equals(this.links, migrationStatusWrapper.links) &&
        Objects.equals(this.status, migrationStatusWrapper.status) &&
        Objects.equals(this.statusCode, migrationStatusWrapper.statusCode);
  }
