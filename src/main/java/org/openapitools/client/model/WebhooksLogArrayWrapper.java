...
import org.openapitools.client.model.WebhooksLogDto;
...
@JsonPropertyOrder({
  ...
  WebhooksLogArrayWrapper.JSON_PROPERTY_COUNT,
  WebhooksLogArrayWrapper.JSON_PROPERTY_LINKS,
  WebhooksLogArrayWrapper.JSON_PROPERTY_STATUS,
  WebhooksLogArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class WebhooksLogArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<WebhooksLogDto> response = new ArrayList<>();
  ...
  public WebhooksLogArrayWrapper addResponseItem(WebhooksLogDto responseItem) {
  ...
  public List<WebhooksLogDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<WebhooksLogDto> response) {
    this.response = response;
  }

  public WebhooksLogArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public WebhooksLogArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public WebhooksLogArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public WebhooksLogArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public WebhooksLogArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    WebhooksLogArrayWrapper webhooksLogArrayWrapper = (WebhooksLogArrayWrapper) o;
    return Objects.equals(this.response, webhooksLogArrayWrapper.response) &&
        Objects.equals(this.count, webhooksLogArrayWrapper.count) &&
        Objects.equals(this.links, webhooksLogArrayWrapper.links) &&
        Objects.equals(this.status, webhooksLogArrayWrapper.status) &&
        Objects.equals(this.statusCode, webhooksLogArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhooksLogArrayWrapper {\n");
