...
import org.openapitools.client.model.CheckDestFolderDto;
 ...
 */
@JsonPropertyOrder({
  CheckDestFolderWrapper.JSON_PROPERTY_RESPONSE,
  CheckDestFolderWrapper.JSON_PROPERTY_COUNT,
  CheckDestFolderWrapper.JSON_PROPERTY_LINKS,
  CheckDestFolderWrapper.JSON_PROPERTY_STATUS,
  CheckDestFolderWrapper.JSON_PROPERTY_STATUS_CODE
})

public class CheckDestFolderWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private CheckDestFolderDto response;
  ...
  public CheckDestFolderDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable CheckDestFolderDto response) {
    this.response = response;
  }

  public CheckDestFolderWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public CheckDestFolderWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public CheckDestFolderWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public CheckDestFolderWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public CheckDestFolderWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    CheckDestFolderWrapper checkDestFolderWrapper = (CheckDestFolderWrapper) o;
    return Objects.equals(this.response, checkDestFolderWrapper.response) &&
        Objects.equals(this.count, checkDestFolderWrapper.count) &&
        Objects.equals(this.links, checkDestFolderWrapper.links) &&
        Objects.equals(this.status, checkDestFolderWrapper.status) &&
        Objects.equals(this.statusCode, checkDestFolderWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class CheckDestFolderWrapper {\n");
