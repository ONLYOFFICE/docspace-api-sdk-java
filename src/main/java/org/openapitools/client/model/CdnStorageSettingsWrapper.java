...
import org.openapitools.client.model.CdnStorageSettings;
 ...
 */
@JsonPropertyOrder({
  CdnStorageSettingsWrapper.JSON_PROPERTY_RESPONSE,
  CdnStorageSettingsWrapper.JSON_PROPERTY_COUNT,
  CdnStorageSettingsWrapper.JSON_PROPERTY_LINKS,
  CdnStorageSettingsWrapper.JSON_PROPERTY_STATUS,
  CdnStorageSettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class CdnStorageSettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private CdnStorageSettings response;
  ...
  public CdnStorageSettings getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable CdnStorageSettings response) {
    this.response = response;
  }

  public CdnStorageSettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public CdnStorageSettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public CdnStorageSettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public CdnStorageSettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public CdnStorageSettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    CdnStorageSettingsWrapper cdnStorageSettingsWrapper = (CdnStorageSettingsWrapper) o;
    return Objects.equals(this.response, cdnStorageSettingsWrapper.response) &&
        Objects.equals(this.count, cdnStorageSettingsWrapper.count) &&
        Objects.equals(this.links, cdnStorageSettingsWrapper.links) &&
        Objects.equals(this.status, cdnStorageSettingsWrapper.status) &&
        Objects.equals(this.statusCode, cdnStorageSettingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class CdnStorageSettingsWrapper {\n");
