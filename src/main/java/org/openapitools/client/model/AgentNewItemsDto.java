...
@JsonPropertyOrder({
  ...
  AgentNewItemsDto.JSON_PROPERTY_ITEMS
})

public class AgentNewItemsDto {
  public static final String JSON_PROPERTY_AGENT = "agent";
  @javax.annotation.Nonnull  private FileEntryBaseDto agent;

  public static final String JSON_PROPERTY_ITEMS = "items";
  @javax.annotation.Nullable  private List<FileEntryBaseDto> items;

  public AgentNewItemsDto() {
  }


  public AgentNewItemsDto agent(@javax.annotation.Nonnull FileEntryBaseDto agent) {
  ...
  public FileEntryBaseDto getAgent() {
    return agent;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setAgent(@javax.annotation.Nonnull FileEntryBaseDto agent) {
    this.agent = agent;
  }

  public AgentNewItemsDto items(@javax.annotation.Nullable List<FileEntryBaseDto> items) {
    
    this.items = items;
    return this;
  }

  public AgentNewItemsDto addItemsItem(FileEntryBaseDto itemsItem) {
    if (this.items == null) {
  ...
  public boolean equals(Object o) {
    ...
    AgentNewItemsDto agentNewItemsDto = (AgentNewItemsDto) o;
    return Objects.equals(this.agent, agentNewItemsDto.agent) &&
        Objects.equals(this.items, agentNewItemsDto.items);
  }

  @Override
  public int hashCode() {
    return Objects.hash(agent, items);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AgentNewItemsDto {\n");
