...
import org.openapitools.client.model.ProductAdministratorDto;
...
@JsonPropertyOrder({
  ...
  ProductAdministratorWrapper.JSON_PROPERTY_COUNT,
  ProductAdministratorWrapper.JSON_PROPERTY_LINKS,
  ProductAdministratorWrapper.JSON_PROPERTY_STATUS,
  ProductAdministratorWrapper.JSON_PROPERTY_STATUS_CODE
})

public class ProductAdministratorWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private ProductAdministratorDto response;
  ...
  public ProductAdministratorDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable ProductAdministratorDto response) {
    this.response = response;
  }

  public ProductAdministratorWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public ProductAdministratorWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public ProductAdministratorWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public ProductAdministratorWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public ProductAdministratorWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    ProductAdministratorWrapper productAdministratorWrapper = (ProductAdministratorWrapper) o;
    return Objects.equals(this.response, productAdministratorWrapper.response) &&
        Objects.equals(this.count, productAdministratorWrapper.count) &&
        Objects.equals(this.links, productAdministratorWrapper.links) &&
        Objects.equals(this.status, productAdministratorWrapper.status) &&
        Objects.equals(this.statusCode, productAdministratorWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProductAdministratorWrapper {\n");
