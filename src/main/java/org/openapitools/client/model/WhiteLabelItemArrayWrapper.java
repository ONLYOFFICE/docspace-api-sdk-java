...
import org.openapitools.client.model.WhiteLabelItemDto;
...
@JsonPropertyOrder({
  ...
  WhiteLabelItemArrayWrapper.JSON_PROPERTY_COUNT,
  WhiteLabelItemArrayWrapper.JSON_PROPERTY_LINKS,
  WhiteLabelItemArrayWrapper.JSON_PROPERTY_STATUS,
  WhiteLabelItemArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class WhiteLabelItemArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<WhiteLabelItemDto> response = new ArrayList<>();
  ...
  public WhiteLabelItemArrayWrapper addResponseItem(WhiteLabelItemDto responseItem) {
  ...
  public List<WhiteLabelItemDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<WhiteLabelItemDto> response) {
    this.response = response;
  }

  public WhiteLabelItemArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public WhiteLabelItemArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public WhiteLabelItemArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public WhiteLabelItemArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public WhiteLabelItemArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    WhiteLabelItemArrayWrapper whiteLabelItemArrayWrapper = (WhiteLabelItemArrayWrapper) o;
    return Objects.equals(this.response, whiteLabelItemArrayWrapper.response) &&
        Objects.equals(this.count, whiteLabelItemArrayWrapper.count) &&
        Objects.equals(this.links, whiteLabelItemArrayWrapper.links) &&
        Objects.equals(this.status, whiteLabelItemArrayWrapper.status) &&
        Objects.equals(this.statusCode, whiteLabelItemArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class WhiteLabelItemArrayWrapper {\n");
