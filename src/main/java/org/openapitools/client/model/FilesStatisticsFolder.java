...
@JsonPropertyOrder({
  ...
  FilesStatisticsFolder.JSON_PROPERTY_USED_SPACE
})
...
public class FilesStatisticsFolder {
  ...
  @javax.annotation.Nullable  private Long usedSpace;
  ...
  public FilesStatisticsFolder usedSpace(@javax.annotation.Nullable Long usedSpace) {
  ...
  public boolean equals(Object o) {
    ...
    FilesStatisticsFolder filesStatisticsFolder = (FilesStatisticsFolder) o;
    return equalsNullable(this.title, filesStatisticsFolder.title) &&
        Objects.equals(this.usedSpace, filesStatisticsFolder.usedSpace);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(title), usedSpace);
  }
