...
import org.openapitools.client.model.StorageDto;
 ...
 */
@JsonPropertyOrder({
  StorageArrayWrapper.JSON_PROPERTY_RESPONSE,
  StorageArrayWrapper.JSON_PROPERTY_COUNT,
  StorageArrayWrapper.JSON_PROPERTY_LINKS,
  StorageArrayWrapper.JSON_PROPERTY_STATUS,
  StorageArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class StorageArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<StorageDto> response = new ArrayList<>();
  ...
  public StorageArrayWrapper addResponseItem(StorageDto responseItem) {
  ...
  public List<StorageDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<StorageDto> response) {
    this.response = response;
  }

  public StorageArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public StorageArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public StorageArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public StorageArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public StorageArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    StorageArrayWrapper storageArrayWrapper = (StorageArrayWrapper) o;
    return Objects.equals(this.response, storageArrayWrapper.response) &&
        Objects.equals(this.count, storageArrayWrapper.count) &&
        Objects.equals(this.links, storageArrayWrapper.links) &&
        Objects.equals(this.status, storageArrayWrapper.status) &&
        Objects.equals(this.statusCode, storageArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class StorageArrayWrapper {\n");
