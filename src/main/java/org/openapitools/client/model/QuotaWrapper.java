 ...
 */
@JsonPropertyOrder({
  QuotaWrapper.JSON_PROPERTY_RESPONSE,
  QuotaWrapper.JSON_PROPERTY_COUNT,
  QuotaWrapper.JSON_PROPERTY_LINKS,
  QuotaWrapper.JSON_PROPERTY_STATUS,
  QuotaWrapper.JSON_PROPERTY_STATUS_CODE
})

public class QuotaWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private QuotaDto response;
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable QuotaDto response) {
    this.response = response;
  }

  public QuotaWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public QuotaWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public QuotaWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public QuotaWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public QuotaWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    QuotaWrapper quotaWrapper = (QuotaWrapper) o;
    return Objects.equals(this.response, quotaWrapper.response) &&
        Objects.equals(this.count, quotaWrapper.count) &&
        Objects.equals(this.links, quotaWrapper.links) &&
        Objects.equals(this.status, quotaWrapper.status) &&
        Objects.equals(this.statusCode, quotaWrapper.statusCode);
  }
