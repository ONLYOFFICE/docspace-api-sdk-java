...
import org.openapitools.client.model.SsoSettingsV2;
 ...
 */
@JsonPropertyOrder({
  SsoSettingsV2Wrapper.JSON_PROPERTY_RESPONSE,
  SsoSettingsV2Wrapper.JSON_PROPERTY_COUNT,
  SsoSettingsV2Wrapper.JSON_PROPERTY_LINKS,
  SsoSettingsV2Wrapper.JSON_PROPERTY_STATUS,
  SsoSettingsV2Wrapper.JSON_PROPERTY_STATUS_CODE
})

public class SsoSettingsV2Wrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private SsoSettingsV2 response;
  ...
  public SsoSettingsV2 getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable SsoSettingsV2 response) {
    this.response = response;
  }

  public SsoSettingsV2Wrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public SsoSettingsV2Wrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public SsoSettingsV2Wrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public SsoSettingsV2Wrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public SsoSettingsV2Wrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    SsoSettingsV2Wrapper ssoSettingsV2Wrapper = (SsoSettingsV2Wrapper) o;
    return Objects.equals(this.response, ssoSettingsV2Wrapper.response) &&
        Objects.equals(this.count, ssoSettingsV2Wrapper.count) &&
        Objects.equals(this.links, ssoSettingsV2Wrapper.links) &&
        Objects.equals(this.status, ssoSettingsV2Wrapper.status) &&
        Objects.equals(this.statusCode, ssoSettingsV2Wrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class SsoSettingsV2Wrapper {\n");
