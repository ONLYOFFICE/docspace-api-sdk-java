 ...
 */
@JsonPropertyOrder({
  FolderIntegerArrayWrapper.JSON_PROPERTY_RESPONSE,
  FolderIntegerArrayWrapper.JSON_PROPERTY_COUNT,
  FolderIntegerArrayWrapper.JSON_PROPERTY_LINKS,
  FolderIntegerArrayWrapper.JSON_PROPERTY_STATUS,
  FolderIntegerArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class FolderIntegerArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<FolderDtoInteger> response = new ArrayList<>();
  ...
  public FolderIntegerArrayWrapper() {
  }


  public FolderIntegerArrayWrapper response(@javax.annotation.Nullable List<FolderDtoInteger> response) {
    
    this.response = response;
    return this;
  }

  public FolderIntegerArrayWrapper addResponseItem(FolderDtoInteger responseItem) {
  ...
  public List<FolderDtoInteger> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<FolderDtoInteger> response) {
    this.response = response;
  }

  public FolderIntegerArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public FolderIntegerArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public FolderIntegerArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public FolderIntegerArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public FolderIntegerArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    FolderIntegerArrayWrapper folderIntegerArrayWrapper = (FolderIntegerArrayWrapper) o;
    return Objects.equals(this.response, folderIntegerArrayWrapper.response) &&
        Objects.equals(this.count, folderIntegerArrayWrapper.count) &&
        Objects.equals(this.links, folderIntegerArrayWrapper.links) &&
        Objects.equals(this.status, folderIntegerArrayWrapper.status) &&
        Objects.equals(this.statusCode, folderIntegerArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class FolderIntegerArrayWrapper {\n");
