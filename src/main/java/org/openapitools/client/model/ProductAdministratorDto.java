 ...
 */
@JsonPropertyOrder({
  ProductAdministratorDto.JSON_PROPERTY_PRODUCT_ID,
  ProductAdministratorDto.JSON_PROPERTY_USER_ID,
  ProductAdministratorDto.JSON_PROPERTY_ADMINISTRATOR
})
...
public class ProductAdministratorDto {
  ...
  @javax.annotation.Nonnull  private Boolean administrator;
  ...
  public ProductAdministratorDto userId(@javax.annotation.Nonnull UUID userId) {
  ...
  public ProductAdministratorDto administrator(@javax.annotation.Nonnull Boolean administrator) {
   ...
   */
  @javax.annotation.Nonnull  @JsonProperty(value = JSON_PROPERTY_ADMINISTRATOR, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  @JsonProperty(value = JSON_PROPERTY_ADMINISTRATOR, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setAdministrator(@javax.annotation.Nonnull Boolean administrator) {
    this.administrator = administrator;
  }
  ...
  public boolean equals(Object o) {
    ...
    ProductAdministratorDto productAdministratorDto = (ProductAdministratorDto) o;
    return Objects.equals(this.productId, productAdministratorDto.productId) &&
        Objects.equals(this.userId, productAdministratorDto.userId) &&
        Objects.equals(this.administrator, productAdministratorDto.administrator);
  }
