...
@JsonPropertyOrder({
  ...
  UpdateApiKeyRequest.JSON_PROPERTY_PERMISSIONS,
  UpdateApiKeyRequest.JSON_PROPERTY_IS_ACTIVE
})
...
public class UpdateApiKeyRequest {
  ...
  public UpdateApiKeyRequest permissions(@javax.annotation.Nullable List<String> permissions) {
    this.permissions = JsonNullable.<List<String>>of(permissions);
    
    return this;
  }

  public UpdateApiKeyRequest addPermissionsItem(String permissionsItem) {
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.name, updateApiKeyRequest.name) &&
        equalsNullable(this.permissions, updateApiKeyRequest.permissions) &&
        equalsNullable(this.isActive, updateApiKeyRequest.isActive);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(name), hashCodeNullable(permissions), hashCodeNullable(isActive));
  }
