...
@JsonPropertyOrder({
  ...
  AutoCleanUpDataWrapper.JSON_PROPERTY_COUNT,
  AutoCleanUpDataWrapper.JSON_PROPERTY_LINKS,
  AutoCleanUpDataWrapper.JSON_PROPERTY_STATUS,
  AutoCleanUpDataWrapper.JSON_PROPERTY_STATUS_CODE
})

public class AutoCleanUpDataWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private AutoCleanUpData response;
  ...
  public AutoCleanUpData getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable AutoCleanUpData response) {
    this.response = response;
  }

  public AutoCleanUpDataWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public AutoCleanUpDataWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public AutoCleanUpDataWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public AutoCleanUpDataWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public AutoCleanUpDataWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    AutoCleanUpDataWrapper autoCleanUpDataWrapper = (AutoCleanUpDataWrapper) o;
    return Objects.equals(this.response, autoCleanUpDataWrapper.response) &&
        Objects.equals(this.count, autoCleanUpDataWrapper.count) &&
        Objects.equals(this.links, autoCleanUpDataWrapper.links) &&
        Objects.equals(this.status, autoCleanUpDataWrapper.status) &&
        Objects.equals(this.statusCode, autoCleanUpDataWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class AutoCleanUpDataWrapper {\n");
