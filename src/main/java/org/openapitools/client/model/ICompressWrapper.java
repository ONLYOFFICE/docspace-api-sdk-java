...
@JsonPropertyOrder({
  ...
  ICompressWrapper.JSON_PROPERTY_COUNT,
  ICompressWrapper.JSON_PROPERTY_LINKS,
  ICompressWrapper.JSON_PROPERTY_STATUS,
  ICompressWrapper.JSON_PROPERTY_STATUS_CODE
})

public class ICompressWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private Object response;
  ...
  public ICompressWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public ICompressWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public ICompressWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public ICompressWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public ICompressWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    ICompressWrapper icompressWrapper = (ICompressWrapper) o;
    return Objects.equals(this.response, icompressWrapper.response) &&
        Objects.equals(this.count, icompressWrapper.count) &&
        Objects.equals(this.links, icompressWrapper.links) &&
        Objects.equals(this.status, icompressWrapper.status) &&
        Objects.equals(this.statusCode, icompressWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class ICompressWrapper {\n");
