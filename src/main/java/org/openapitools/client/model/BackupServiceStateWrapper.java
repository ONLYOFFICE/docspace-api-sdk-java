...
import org.openapitools.client.model.BackupServiceStateDto;
 ...
 */
@JsonPropertyOrder({
  BackupServiceStateWrapper.JSON_PROPERTY_RESPONSE,
  BackupServiceStateWrapper.JSON_PROPERTY_COUNT,
  BackupServiceStateWrapper.JSON_PROPERTY_LINKS,
  BackupServiceStateWrapper.JSON_PROPERTY_STATUS,
  BackupServiceStateWrapper.JSON_PROPERTY_STATUS_CODE
})

public class BackupServiceStateWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private BackupServiceStateDto response;
  ...
  public BackupServiceStateDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable BackupServiceStateDto response) {
    this.response = response;
  }

  public BackupServiceStateWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public BackupServiceStateWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public BackupServiceStateWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public BackupServiceStateWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public BackupServiceStateWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    BackupServiceStateWrapper backupServiceStateWrapper = (BackupServiceStateWrapper) o;
    return Objects.equals(this.response, backupServiceStateWrapper.response) &&
        Objects.equals(this.count, backupServiceStateWrapper.count) &&
        Objects.equals(this.links, backupServiceStateWrapper.links) &&
        Objects.equals(this.status, backupServiceStateWrapper.status) &&
        Objects.equals(this.statusCode, backupServiceStateWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class BackupServiceStateWrapper {\n");
