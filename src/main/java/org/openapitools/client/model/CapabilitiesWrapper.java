...
import org.openapitools.client.model.CapabilitiesDto;
 ...
 */
@JsonPropertyOrder({
  CapabilitiesWrapper.JSON_PROPERTY_RESPONSE,
  CapabilitiesWrapper.JSON_PROPERTY_COUNT,
  CapabilitiesWrapper.JSON_PROPERTY_LINKS,
  CapabilitiesWrapper.JSON_PROPERTY_STATUS,
  CapabilitiesWrapper.JSON_PROPERTY_STATUS_CODE
})

public class CapabilitiesWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private CapabilitiesDto response;
  ...
  public CapabilitiesDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable CapabilitiesDto response) {
    this.response = response;
  }

  public CapabilitiesWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public CapabilitiesWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public CapabilitiesWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public CapabilitiesWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public CapabilitiesWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    CapabilitiesWrapper capabilitiesWrapper = (CapabilitiesWrapper) o;
    return Objects.equals(this.response, capabilitiesWrapper.response) &&
        Objects.equals(this.count, capabilitiesWrapper.count) &&
        Objects.equals(this.links, capabilitiesWrapper.links) &&
        Objects.equals(this.status, capabilitiesWrapper.status) &&
        Objects.equals(this.statusCode, capabilitiesWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class CapabilitiesWrapper {\n");
