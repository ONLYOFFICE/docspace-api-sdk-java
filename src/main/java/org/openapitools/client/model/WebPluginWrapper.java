...
@JsonPropertyOrder({
  ...
  WebPluginWrapper.JSON_PROPERTY_COUNT,
  WebPluginWrapper.JSON_PROPERTY_LINKS,
  WebPluginWrapper.JSON_PROPERTY_STATUS,
  WebPluginWrapper.JSON_PROPERTY_STATUS_CODE
})

public class WebPluginWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private WebPluginDto response;
  ...
  public WebPluginDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable WebPluginDto response) {
    this.response = response;
  }

  public WebPluginWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public WebPluginWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public WebPluginWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public WebPluginWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public WebPluginWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    WebPluginWrapper webPluginWrapper = (WebPluginWrapper) o;
    return Objects.equals(this.response, webPluginWrapper.response) &&
        Objects.equals(this.count, webPluginWrapper.count) &&
        Objects.equals(this.links, webPluginWrapper.links) &&
        Objects.equals(this.status, webPluginWrapper.status) &&
        Objects.equals(this.statusCode, webPluginWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebPluginWrapper {\n");
