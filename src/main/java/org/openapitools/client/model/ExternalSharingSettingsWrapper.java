...
import org.openapitools.client.model.ExternalSharingSettingsDto;
 ...
 */
@JsonPropertyOrder({
  ExternalSharingSettingsWrapper.JSON_PROPERTY_RESPONSE,
  ExternalSharingSettingsWrapper.JSON_PROPERTY_COUNT,
  ExternalSharingSettingsWrapper.JSON_PROPERTY_LINKS,
  ExternalSharingSettingsWrapper.JSON_PROPERTY_STATUS,
  ExternalSharingSettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class ExternalSharingSettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private ExternalSharingSettingsDto response;
  ...
  public ExternalSharingSettingsWrapper() {
  }


  public ExternalSharingSettingsWrapper response(@javax.annotation.Nullable ExternalSharingSettingsDto response) {
  ...
  public ExternalSharingSettingsDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable ExternalSharingSettingsDto response) {
    this.response = response;
  }

  public ExternalSharingSettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public ExternalSharingSettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public ExternalSharingSettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public ExternalSharingSettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public ExternalSharingSettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    ExternalSharingSettingsWrapper externalSharingSettingsWrapper = (ExternalSharingSettingsWrapper) o;
    return Objects.equals(this.response, externalSharingSettingsWrapper.response) &&
        Objects.equals(this.count, externalSharingSettingsWrapper.count) &&
        Objects.equals(this.links, externalSharingSettingsWrapper.links) &&
        Objects.equals(this.status, externalSharingSettingsWrapper.status) &&
        Objects.equals(this.statusCode, externalSharingSettingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExternalSharingSettingsWrapper {\n");
