...
import org.openapitools.client.model.FormRoleDto;
...
@JsonPropertyOrder({
  ...
  FormRoleArrayWrapper.JSON_PROPERTY_COUNT,
  FormRoleArrayWrapper.JSON_PROPERTY_LINKS,
  FormRoleArrayWrapper.JSON_PROPERTY_STATUS,
  FormRoleArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class FormRoleArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<FormRoleDto> response = new ArrayList<>();
  ...
  public FormRoleArrayWrapper addResponseItem(FormRoleDto responseItem) {
  ...
  public List<FormRoleDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<FormRoleDto> response) {
    this.response = response;
  }

  public FormRoleArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public FormRoleArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public FormRoleArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public FormRoleArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public FormRoleArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    FormRoleArrayWrapper formRoleArrayWrapper = (FormRoleArrayWrapper) o;
    return Objects.equals(this.response, formRoleArrayWrapper.response) &&
        Objects.equals(this.count, formRoleArrayWrapper.count) &&
        Objects.equals(this.links, formRoleArrayWrapper.links) &&
        Objects.equals(this.status, formRoleArrayWrapper.status) &&
        Objects.equals(this.statusCode, formRoleArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class FormRoleArrayWrapper {\n");
