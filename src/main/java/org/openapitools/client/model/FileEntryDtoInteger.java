 ...
 */
@JsonPropertyOrder({
  FileEntryDtoInteger.JSON_PROPERTY_TITLE,
  FileEntryDtoInteger.JSON_PROPERTY_ACCESS,
  FileEntryDtoInteger.JSON_PROPERTY_SHARED_BY,
  ...
  FileEntryDtoInteger.JSON_PROPERTY_CREATED_BY,
  FileEntryDtoInteger.JSON_PROPERTY_UPDATED,
  FileEntryDtoInteger.JSON_PROPERTY_AUTO_DELETE,
  FileEntryDtoInteger.JSON_PROPERTY_ROOT_FOLDER_TYPE,
  FileEntryDtoInteger.JSON_PROPERTY_PARENT_ROOM_TYPE,
  FileEntryDtoInteger.JSON_PROPERTY_UPDATED_BY,
  FileEntryDtoInteger.JSON_PROPERTY_PROVIDER_ITEM,
  FileEntryDtoInteger.JSON_PROPERTY_PROVIDER_KEY,
  FileEntryDtoInteger.JSON_PROPERTY_PROVIDER_ID,
  FileEntryDtoInteger.JSON_PROPERTY_ORDER,
  FileEntryDtoInteger.JSON_PROPERTY_IS_FAVORITE,
  FileEntryDtoInteger.JSON_PROPERTY_FILE_ENTRY_TYPE,
  FileEntryDtoInteger.JSON_PROPERTY_ID,
  FileEntryDtoInteger.JSON_PROPERTY_ROOT_FOLDER_ID,
  FileEntryDtoInteger.JSON_PROPERTY_ORIGIN_ID,
  FileEntryDtoInteger.JSON_PROPERTY_ORIGIN_ROOM_ID,
  FileEntryDtoInteger.JSON_PROPERTY_ORIGIN_TITLE,
  FileEntryDtoInteger.JSON_PROPERTY_ORIGIN_ROOM_TITLE,
  FileEntryDtoInteger.JSON_PROPERTY_CAN_SHARE,
  FileEntryDtoInteger.JSON_PROPERTY_SHARE_SETTINGS,
  FileEntryDtoInteger.JSON_PROPERTY_SECURITY,
  FileEntryDtoInteger.JSON_PROPERTY_AVAILABLE_SHARE_RIGHTS,
  FileEntryDtoInteger.JSON_PROPERTY_REQUEST_TOKEN,
  FileEntryDtoInteger.JSON_PROPERTY_EXTERNAL,
...
public class FileEntryDtoInteger {
  ...
  public FileEntryDtoInteger title(@javax.annotation.Nullable String title) {
  ...
  public FileEntryDtoInteger access(@javax.annotation.Nullable FileShare access) {
  ...
  public FileEntryDtoInteger sharedBy(@javax.annotation.Nullable EmployeeDto sharedBy) {
  ...
  public FileEntryDtoInteger ownedBy(@javax.annotation.Nullable EmployeeDto ownedBy) {
  ...
  public FileEntryDtoInteger shared(@javax.annotation.Nullable Boolean shared) {
  ...
  public FileEntryDtoInteger sharedForUser(@javax.annotation.Nullable Boolean sharedForUser) {
  ...
  public FileEntryDtoInteger shortWebUrl(@javax.annotation.Nullable URI shortWebUrl) {
  ...
  public FileEntryDtoInteger created(@javax.annotation.Nullable ApiDateTime created) {
  ...
  public FileEntryDtoInteger createdBy(@javax.annotation.Nullable EmployeeDto createdBy) {
  ...
  public FileEntryDtoInteger updated(@javax.annotation.Nullable ApiDateTime updated) {
  ...
  public FileEntryDtoInteger autoDelete(@javax.annotation.Nullable ApiDateTime autoDelete) {
  ...
  public FileEntryDtoInteger rootFolderType(@javax.annotation.Nullable FolderType rootFolderType) {
  ...
  public FileEntryDtoInteger parentRoomType(@javax.annotation.Nullable FolderType parentRoomType) {
  ...
  public FileEntryDtoInteger updatedBy(@javax.annotation.Nullable EmployeeDto updatedBy) {
  ...
  public FileEntryDtoInteger providerItem(@javax.annotation.Nullable Boolean providerItem) {
  ...
  public FileEntryDtoInteger providerKey(@javax.annotation.Nullable String providerKey) {
  ...
  public FileEntryDtoInteger providerId(@javax.annotation.Nullable Integer providerId) {
  ...
  public FileEntryDtoInteger order(@javax.annotation.Nullable String order) {
  ...
  public FileEntryDtoInteger isFavorite(@javax.annotation.Nullable Boolean isFavorite) {
  ...
  public FileEntryDtoInteger fileEntryType(@javax.annotation.Nullable FileEntryType fileEntryType) {
  ...
  public FileEntryDtoInteger id(@javax.annotation.Nullable Integer id) {
  ...
  public FileEntryDtoInteger rootFolderId(@javax.annotation.Nullable Integer rootFolderId) {
  ...
  public FileEntryDtoInteger originId(@javax.annotation.Nullable Integer originId) {
  ...
  public FileEntryDtoInteger originRoomId(@javax.annotation.Nullable Integer originRoomId) {
  ...
  public FileEntryDtoInteger originTitle(@javax.annotation.Nullable String originTitle) {
  ...
  public FileEntryDtoInteger originRoomTitle(@javax.annotation.Nullable String originRoomTitle) {
  ...
  public FileEntryDtoInteger canShare(@javax.annotation.Nullable Boolean canShare) {
  ...
  public FileEntryDtoInteger external(@javax.annotation.Nullable Boolean external) {
  ...
  public FileEntryDtoInteger expirationDate(@javax.annotation.Nullable ApiDateTime expirationDate) {
  ...
  public FileEntryDtoInteger isLinkExpired(@javax.annotation.Nullable Boolean isLinkExpired) {
  ...
  public boolean equals(Object o) {
    ...
    FileEntryDtoInteger fileEntryDtoInteger = (FileEntryDtoInteger) o;
    return equalsNullable(this.title, fileEntryDtoInteger.title) &&
        Objects.equals(this.access, fileEntryDtoInteger.access) &&
        Objects.equals(this.sharedBy, fileEntryDtoInteger.sharedBy) &&
        ...
        Objects.equals(this.createdBy, fileEntryDtoInteger.createdBy) &&
        Objects.equals(this.updated, fileEntryDtoInteger.updated) &&
        Objects.equals(this.autoDelete, fileEntryDtoInteger.autoDelete) &&
        Objects.equals(this.rootFolderType, fileEntryDtoInteger.rootFolderType) &&
        Objects.equals(this.parentRoomType, fileEntryDtoInteger.parentRoomType) &&
        Objects.equals(this.updatedBy, fileEntryDtoInteger.updatedBy) &&
        equalsNullable(this.providerItem, fileEntryDtoInteger.providerItem) &&
        equalsNullable(this.providerKey, fileEntryDtoInteger.providerKey) &&
        equalsNullable(this.providerId, fileEntryDtoInteger.providerId) &&
        equalsNullable(this.order, fileEntryDtoInteger.order) &&
        equalsNullable(this.isFavorite, fileEntryDtoInteger.isFavorite) &&
        Objects.equals(this.fileEntryType, fileEntryDtoInteger.fileEntryType) &&
        Objects.equals(this.id, fileEntryDtoInteger.id) &&
        Objects.equals(this.rootFolderId, fileEntryDtoInteger.rootFolderId) &&
        Objects.equals(this.originId, fileEntryDtoInteger.originId) &&
        Objects.equals(this.originRoomId, fileEntryDtoInteger.originRoomId) &&
        equalsNullable(this.originTitle, fileEntryDtoInteger.originTitle) &&
        equalsNullable(this.originRoomTitle, fileEntryDtoInteger.originRoomTitle) &&
        Objects.equals(this.canShare, fileEntryDtoInteger.canShare) &&
        equalsNullable(this.shareSettings, fileEntryDtoInteger.shareSettings) &&
        equalsNullable(this.security, fileEntryDtoInteger.security) &&
        equalsNullable(this.availableShareRights, fileEntryDtoInteger.availableShareRights) &&
        equalsNullable(this.requestToken, fileEntryDtoInteger.requestToken) &&
        equalsNullable(this.external, fileEntryDtoInteger.external) &&
        Objects.equals(this.expirationDate, fileEntryDtoInteger.expirationDate) &&
        equalsNullable(this.isLinkExpired, fileEntryDtoInteger.isLinkExpired);
  }
