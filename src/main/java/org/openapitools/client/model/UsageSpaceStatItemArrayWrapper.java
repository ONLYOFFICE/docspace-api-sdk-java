...
import org.openapitools.client.model.UsageSpaceStatItemDto;
...
@JsonPropertyOrder({
  ...
  UsageSpaceStatItemArrayWrapper.JSON_PROPERTY_COUNT,
  UsageSpaceStatItemArrayWrapper.JSON_PROPERTY_LINKS,
  UsageSpaceStatItemArrayWrapper.JSON_PROPERTY_STATUS,
  UsageSpaceStatItemArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class UsageSpaceStatItemArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<UsageSpaceStatItemDto> response = new ArrayList<>();
  ...
  public UsageSpaceStatItemArrayWrapper addResponseItem(UsageSpaceStatItemDto responseItem) {
  ...
  public List<UsageSpaceStatItemDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<UsageSpaceStatItemDto> response) {
    this.response = response;
  }

  public UsageSpaceStatItemArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public UsageSpaceStatItemArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public UsageSpaceStatItemArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public UsageSpaceStatItemArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public UsageSpaceStatItemArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    UsageSpaceStatItemArrayWrapper usageSpaceStatItemArrayWrapper = (UsageSpaceStatItemArrayWrapper) o;
    return Objects.equals(this.response, usageSpaceStatItemArrayWrapper.response) &&
        Objects.equals(this.count, usageSpaceStatItemArrayWrapper.count) &&
        Objects.equals(this.links, usageSpaceStatItemArrayWrapper.links) &&
        Objects.equals(this.status, usageSpaceStatItemArrayWrapper.status) &&
        Objects.equals(this.statusCode, usageSpaceStatItemArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class UsageSpaceStatItemArrayWrapper {\n");
