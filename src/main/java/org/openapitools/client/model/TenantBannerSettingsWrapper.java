...
import org.openapitools.client.model.TenantBannerSettings;
 ...
 */
@JsonPropertyOrder({
  TenantBannerSettingsWrapper.JSON_PROPERTY_RESPONSE,
  TenantBannerSettingsWrapper.JSON_PROPERTY_COUNT,
  TenantBannerSettingsWrapper.JSON_PROPERTY_LINKS,
  TenantBannerSettingsWrapper.JSON_PROPERTY_STATUS,
  TenantBannerSettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class TenantBannerSettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private TenantBannerSettings response;
  ...
  public TenantBannerSettings getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable TenantBannerSettings response) {
    this.response = response;
  }

  public TenantBannerSettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public TenantBannerSettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public TenantBannerSettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public TenantBannerSettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public TenantBannerSettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    TenantBannerSettingsWrapper tenantBannerSettingsWrapper = (TenantBannerSettingsWrapper) o;
    return Objects.equals(this.response, tenantBannerSettingsWrapper.response) &&
        Objects.equals(this.count, tenantBannerSettingsWrapper.count) &&
        Objects.equals(this.links, tenantBannerSettingsWrapper.links) &&
        Objects.equals(this.status, tenantBannerSettingsWrapper.status) &&
        Objects.equals(this.statusCode, tenantBannerSettingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class TenantBannerSettingsWrapper {\n");
