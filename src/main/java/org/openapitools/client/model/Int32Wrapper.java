...
@JsonPropertyOrder({
  ...
  Int32Wrapper.JSON_PROPERTY_COUNT,
  Int32Wrapper.JSON_PROPERTY_LINKS,
  Int32Wrapper.JSON_PROPERTY_STATUS,
  Int32Wrapper.JSON_PROPERTY_STATUS_CODE
})
...
public class Int32Wrapper {
  ...
  public Int32Wrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public Int32Wrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public Int32Wrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public Int32Wrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public Int32Wrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    Int32Wrapper int32Wrapper = (Int32Wrapper) o;
    return Objects.equals(this.response, int32Wrapper.response) &&
        Objects.equals(this.count, int32Wrapper.count) &&
        Objects.equals(this.links, int32Wrapper.links) &&
        Objects.equals(this.status, int32Wrapper.status) &&
        Objects.equals(this.statusCode, int32Wrapper.statusCode);
  }
