...
import org.openapitools.client.model.TenantQuota;
...
@JsonPropertyOrder({
  ...
  TenantQuotaWrapper.JSON_PROPERTY_COUNT,
  TenantQuotaWrapper.JSON_PROPERTY_LINKS,
  TenantQuotaWrapper.JSON_PROPERTY_STATUS,
  TenantQuotaWrapper.JSON_PROPERTY_STATUS_CODE
})

public class TenantQuotaWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private TenantQuota response;
  ...
  public TenantQuotaWrapper() {
  }


  public TenantQuotaWrapper response(@javax.annotation.Nullable TenantQuota response) {
  ...
  public TenantQuota getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable TenantQuota response) {
    this.response = response;
  }

  public TenantQuotaWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public TenantQuotaWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public TenantQuotaWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public TenantQuotaWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public TenantQuotaWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    TenantQuotaWrapper tenantQuotaWrapper = (TenantQuotaWrapper) o;
    return Objects.equals(this.response, tenantQuotaWrapper.response) &&
        Objects.equals(this.count, tenantQuotaWrapper.count) &&
        Objects.equals(this.links, tenantQuotaWrapper.links) &&
        Objects.equals(this.status, tenantQuotaWrapper.status) &&
        Objects.equals(this.statusCode, tenantQuotaWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class TenantQuotaWrapper {\n");
