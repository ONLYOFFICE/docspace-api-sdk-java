 ...
 */
@JsonPropertyOrder({
  SmtpSettingsWrapper.JSON_PROPERTY_RESPONSE,
  SmtpSettingsWrapper.JSON_PROPERTY_COUNT,
  SmtpSettingsWrapper.JSON_PROPERTY_LINKS,
  SmtpSettingsWrapper.JSON_PROPERTY_STATUS,
  SmtpSettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class SmtpSettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private SmtpSettingsDto response;
  ...
  public SmtpSettingsDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable SmtpSettingsDto response) {
    this.response = response;
  }

  public SmtpSettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public SmtpSettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public SmtpSettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public SmtpSettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public SmtpSettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    SmtpSettingsWrapper smtpSettingsWrapper = (SmtpSettingsWrapper) o;
    return Objects.equals(this.response, smtpSettingsWrapper.response) &&
        Objects.equals(this.count, smtpSettingsWrapper.count) &&
        Objects.equals(this.links, smtpSettingsWrapper.links) &&
        Objects.equals(this.status, smtpSettingsWrapper.status) &&
        Objects.equals(this.statusCode, smtpSettingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class SmtpSettingsWrapper {\n");
