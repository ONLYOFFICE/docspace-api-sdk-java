...
import org.openapitools.client.model.UserChatSettingsDto;
 ...
 */
@JsonPropertyOrder({
  UserChatSettingsWrapper.JSON_PROPERTY_RESPONSE,
  UserChatSettingsWrapper.JSON_PROPERTY_COUNT,
  UserChatSettingsWrapper.JSON_PROPERTY_LINKS,
  UserChatSettingsWrapper.JSON_PROPERTY_STATUS,
  UserChatSettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class UserChatSettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private UserChatSettingsDto response;
  ...
  public UserChatSettingsWrapper() {
  }


  public UserChatSettingsWrapper response(@javax.annotation.Nullable UserChatSettingsDto response) {
  ...
  public UserChatSettingsDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable UserChatSettingsDto response) {
    this.response = response;
  }

  public UserChatSettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public UserChatSettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public UserChatSettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public UserChatSettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public UserChatSettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    UserChatSettingsWrapper userChatSettingsWrapper = (UserChatSettingsWrapper) o;
    return Objects.equals(this.response, userChatSettingsWrapper.response) &&
        Objects.equals(this.count, userChatSettingsWrapper.count) &&
        Objects.equals(this.links, userChatSettingsWrapper.links) &&
        Objects.equals(this.status, userChatSettingsWrapper.status) &&
        Objects.equals(this.statusCode, userChatSettingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserChatSettingsWrapper {\n");
