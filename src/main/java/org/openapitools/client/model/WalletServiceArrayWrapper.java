...
@JsonPropertyOrder({
  ...
  WalletServiceArrayWrapper.JSON_PROPERTY_COUNT,
  WalletServiceArrayWrapper.JSON_PROPERTY_LINKS,
  WalletServiceArrayWrapper.JSON_PROPERTY_STATUS,
  WalletServiceArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class WalletServiceArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<WalletServiceDto> response = new ArrayList<>();
  ...
  public WalletServiceArrayWrapper() {
  }


  public WalletServiceArrayWrapper response(@javax.annotation.Nullable List<WalletServiceDto> response) {
    
    this.response = response;
    return this;
  }

  public WalletServiceArrayWrapper addResponseItem(WalletServiceDto responseItem) {
  ...
  public List<WalletServiceDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<WalletServiceDto> response) {
    this.response = response;
  }

  public WalletServiceArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public WalletServiceArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public WalletServiceArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public WalletServiceArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public WalletServiceArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    WalletServiceArrayWrapper walletServiceArrayWrapper = (WalletServiceArrayWrapper) o;
    return Objects.equals(this.response, walletServiceArrayWrapper.response) &&
        Objects.equals(this.count, walletServiceArrayWrapper.count) &&
        Objects.equals(this.links, walletServiceArrayWrapper.links) &&
        Objects.equals(this.status, walletServiceArrayWrapper.status) &&
        Objects.equals(this.statusCode, walletServiceArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class WalletServiceArrayWrapper {\n");
