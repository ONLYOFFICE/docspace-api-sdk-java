 ...
 */
@JsonPropertyOrder({
  TenantAiAccessSettings.JSON_PROPERTY_ENABLED,
  TenantAiAccessSettings.JSON_PROPERTY_LAST_MODIFIED
})

public class TenantAiAccessSettings {
  ...
  public TenantAiAccessSettings() {
  }


  public TenantAiAccessSettings enabled(@javax.annotation.Nullable Boolean enabled) {
  ...
  public TenantAiAccessSettings lastModified(@javax.annotation.Nullable OffsetDateTime lastModified) {
  ...
  public boolean equals(Object o) {
    ...
    TenantAiAccessSettings tenantAiAccessSettings = (TenantAiAccessSettings) o;
    return Objects.equals(this.enabled, tenantAiAccessSettings.enabled) &&
        Objects.equals(this.lastModified, tenantAiAccessSettings.lastModified);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, lastModified);
  }
