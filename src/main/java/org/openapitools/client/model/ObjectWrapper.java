...
@JsonPropertyOrder({
  ...
  ObjectWrapper.JSON_PROPERTY_COUNT,
  ObjectWrapper.JSON_PROPERTY_LINKS,
  ObjectWrapper.JSON_PROPERTY_STATUS,
  ObjectWrapper.JSON_PROPERTY_STATUS_CODE
})
...
public class ObjectWrapper {
  ...
  public ObjectWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public ObjectWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public ObjectWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public ObjectWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public ObjectWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.response, objectWrapper.response) &&
        Objects.equals(this.count, objectWrapper.count) &&
        Objects.equals(this.links, objectWrapper.links) &&
        Objects.equals(this.status, objectWrapper.status) &&
        Objects.equals(this.statusCode, objectWrapper.statusCode);
  }
