 ...
 */
@JsonPropertyOrder({
  CreateWebhooksConfigRequestsDto.JSON_PROPERTY_NAME,
  CreateWebhooksConfigRequestsDto.JSON_PROPERTY_URI,
  CreateWebhooksConfigRequestsDto.JSON_PROPERTY_SECRET_KEY,
  CreateWebhooksConfigRequestsDto.JSON_PROPERTY_ENABLED,
  CreateWebhooksConfigRequestsDto.JSON_PROPERTY_SSL,
  CreateWebhooksConfigRequestsDto.JSON_PROPERTY_TRIGGERS,
  CreateWebhooksConfigRequestsDto.JSON_PROPERTY_TARGET_ID
})
...
public class CreateWebhooksConfigRequestsDto {
  ...
  public CreateWebhooksConfigRequestsDto uri(@javax.annotation.Nonnull String uri) {
  ...
  public CreateWebhooksConfigRequestsDto secretKey(@javax.annotation.Nullable String secretKey) {
  ...
  public CreateWebhooksConfigRequestsDto enabled(@javax.annotation.Nullable Boolean enabled) {
  ...
  public CreateWebhooksConfigRequestsDto ssl(@javax.annotation.Nullable Boolean ssl) {
  ...
  public CreateWebhooksConfigRequestsDto triggers(@javax.annotation.Nullable WebhookTrigger triggers) {
  ...
  public CreateWebhooksConfigRequestsDto targetId(@javax.annotation.Nullable String targetId) {
  ...
  public boolean equals(Object o) {
    ...
    CreateWebhooksConfigRequestsDto createWebhooksConfigRequestsDto = (CreateWebhooksConfigRequestsDto) o;
    return Objects.equals(this.name, createWebhooksConfigRequestsDto.name) &&
        Objects.equals(this.uri, createWebhooksConfigRequestsDto.uri) &&
        equalsNullable(this.secretKey, createWebhooksConfigRequestsDto.secretKey) &&
        Objects.equals(this.enabled, createWebhooksConfigRequestsDto.enabled) &&
        Objects.equals(this.ssl, createWebhooksConfigRequestsDto.ssl) &&
        Objects.equals(this.triggers, createWebhooksConfigRequestsDto.triggers) &&
        equalsNullable(this.targetId, createWebhooksConfigRequestsDto.targetId);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, uri, hashCodeNullable(secretKey), enabled, ssl, triggers, hashCodeNullable(targetId));
  }
