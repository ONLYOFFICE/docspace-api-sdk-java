...
import org.openapitools.client.model.McpToolDto;
 ...
 */
@JsonPropertyOrder({
  McpToolArrayWrapper.JSON_PROPERTY_RESPONSE,
  McpToolArrayWrapper.JSON_PROPERTY_COUNT,
  McpToolArrayWrapper.JSON_PROPERTY_LINKS,
  McpToolArrayWrapper.JSON_PROPERTY_STATUS,
  McpToolArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class McpToolArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<McpToolDto> response = new ArrayList<>();
  ...
  public McpToolArrayWrapper() {
  }


  public McpToolArrayWrapper response(@javax.annotation.Nullable List<McpToolDto> response) {
    
    this.response = response;
    return this;
  }

  public McpToolArrayWrapper addResponseItem(McpToolDto responseItem) {
  ...
  public List<McpToolDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<McpToolDto> response) {
    this.response = response;
  }

  public McpToolArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public McpToolArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public McpToolArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public McpToolArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public McpToolArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    McpToolArrayWrapper mcpToolArrayWrapper = (McpToolArrayWrapper) o;
    return Objects.equals(this.response, mcpToolArrayWrapper.response) &&
        Objects.equals(this.count, mcpToolArrayWrapper.count) &&
        Objects.equals(this.links, mcpToolArrayWrapper.links) &&
        Objects.equals(this.status, mcpToolArrayWrapper.status) &&
        Objects.equals(this.statusCode, mcpToolArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class McpToolArrayWrapper {\n");
