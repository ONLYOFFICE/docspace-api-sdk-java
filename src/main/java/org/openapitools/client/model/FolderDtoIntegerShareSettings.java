 ...
 */
@JsonPropertyOrder({
  FolderDtoIntegerShareSettings.JSON_PROPERTY_USER,
  FolderDtoIntegerShareSettings.JSON_PROPERTY_EXTERNAL_LINK,
  FolderDtoIntegerShareSettings.JSON_PROPERTY_GROUP,
  FolderDtoIntegerShareSettings.JSON_PROPERTY_INVITATION_LINK,
  FolderDtoIntegerShareSettings.JSON_PROPERTY_PRIMARY_EXTERNAL_LINK
})
@JsonTypeName("FolderDtoInteger_shareSettings")

public class FolderDtoIntegerShareSettings {
  public static final String JSON_PROPERTY_USER = "User";
  @javax.annotation.Nullable  private Integer user;

  public static final String JSON_PROPERTY_EXTERNAL_LINK = "ExternalLink";
  @javax.annotation.Nullable  private Integer externalLink;

  public static final String JSON_PROPERTY_GROUP = "Group";
  @javax.annotation.Nullable  private Integer group;

  public static final String JSON_PROPERTY_INVITATION_LINK = "InvitationLink";
  @javax.annotation.Nullable  private Integer invitationLink;

  public static final String JSON_PROPERTY_PRIMARY_EXTERNAL_LINK = "PrimaryExternalLink";
  @javax.annotation.Nullable  private Integer primaryExternalLink;

  public FolderDtoIntegerShareSettings() {
  }


  public FolderDtoIntegerShareSettings user(@javax.annotation.Nullable Integer user) {
  ...
  public FolderDtoIntegerShareSettings externalLink(@javax.annotation.Nullable Integer externalLink) {
  ...
  public FolderDtoIntegerShareSettings group(@javax.annotation.Nullable Integer group) {
  ...
  public FolderDtoIntegerShareSettings invitationLink(@javax.annotation.Nullable Integer invitationLink) {
  ...
  public FolderDtoIntegerShareSettings primaryExternalLink(@javax.annotation.Nullable Integer primaryExternalLink) {
  ...
  public boolean equals(Object o) {
    ...
    FolderDtoIntegerShareSettings folderDtoIntegerShareSettings = (FolderDtoIntegerShareSettings) o;
    return Objects.equals(this.user, folderDtoIntegerShareSettings.user) &&
        Objects.equals(this.externalLink, folderDtoIntegerShareSettings.externalLink) &&
        Objects.equals(this.group, folderDtoIntegerShareSettings.group) &&
        Objects.equals(this.invitationLink, folderDtoIntegerShareSettings.invitationLink) &&
        Objects.equals(this.primaryExternalLink, folderDtoIntegerShareSettings.primaryExternalLink);
  }
