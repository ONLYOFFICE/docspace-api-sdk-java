...
import org.openapitools.client.model.FormSubmissionsDto;
 ...
 */
@JsonPropertyOrder({
  FormSubmissionsWrapper.JSON_PROPERTY_RESPONSE,
  FormSubmissionsWrapper.JSON_PROPERTY_COUNT,
  FormSubmissionsWrapper.JSON_PROPERTY_LINKS,
  FormSubmissionsWrapper.JSON_PROPERTY_STATUS,
  FormSubmissionsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class FormSubmissionsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private FormSubmissionsDto response;
  ...
  public FormSubmissionsWrapper() {
  }


  public FormSubmissionsWrapper response(@javax.annotation.Nullable FormSubmissionsDto response) {
  ...
  public FormSubmissionsDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable FormSubmissionsDto response) {
    this.response = response;
  }

  public FormSubmissionsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public FormSubmissionsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public FormSubmissionsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public FormSubmissionsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public FormSubmissionsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    FormSubmissionsWrapper formSubmissionsWrapper = (FormSubmissionsWrapper) o;
    return Objects.equals(this.response, formSubmissionsWrapper.response) &&
        Objects.equals(this.count, formSubmissionsWrapper.count) &&
        Objects.equals(this.links, formSubmissionsWrapper.links) &&
        Objects.equals(this.status, formSubmissionsWrapper.status) &&
        Objects.equals(this.statusCode, formSubmissionsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class FormSubmissionsWrapper {\n");
