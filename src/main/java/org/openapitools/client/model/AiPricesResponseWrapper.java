...
import org.openapitools.client.model.AiPricesResponse;
...
@JsonPropertyOrder({
  ...
  AiPricesResponseWrapper.JSON_PROPERTY_COUNT,
  AiPricesResponseWrapper.JSON_PROPERTY_LINKS,
  AiPricesResponseWrapper.JSON_PROPERTY_STATUS,
  AiPricesResponseWrapper.JSON_PROPERTY_STATUS_CODE
})

public class AiPricesResponseWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private AiPricesResponse response;
  ...
  public AiPricesResponseWrapper() {
  }


  public AiPricesResponseWrapper response(@javax.annotation.Nullable AiPricesResponse response) {
  ...
  public AiPricesResponse getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable AiPricesResponse response) {
    this.response = response;
  }

  public AiPricesResponseWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public AiPricesResponseWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public AiPricesResponseWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public AiPricesResponseWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public AiPricesResponseWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    AiPricesResponseWrapper aiPricesResponseWrapper = (AiPricesResponseWrapper) o;
    return Objects.equals(this.response, aiPricesResponseWrapper.response) &&
        Objects.equals(this.count, aiPricesResponseWrapper.count) &&
        Objects.equals(this.links, aiPricesResponseWrapper.links) &&
        Objects.equals(this.status, aiPricesResponseWrapper.status) &&
        Objects.equals(this.statusCode, aiPricesResponseWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class AiPricesResponseWrapper {\n");
