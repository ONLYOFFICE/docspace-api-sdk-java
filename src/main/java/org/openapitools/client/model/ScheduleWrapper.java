...
import org.openapitools.client.model.ScheduleDto;
 ...
 */
@JsonPropertyOrder({
  ScheduleWrapper.JSON_PROPERTY_RESPONSE,
  ScheduleWrapper.JSON_PROPERTY_COUNT,
  ScheduleWrapper.JSON_PROPERTY_LINKS,
  ScheduleWrapper.JSON_PROPERTY_STATUS,
  ScheduleWrapper.JSON_PROPERTY_STATUS_CODE
})

public class ScheduleWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private ScheduleDto response;
  ...
  public ScheduleDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable ScheduleDto response) {
    this.response = response;
  }

  public ScheduleWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public ScheduleWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public ScheduleWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public ScheduleWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public ScheduleWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    ScheduleWrapper scheduleWrapper = (ScheduleWrapper) o;
    return Objects.equals(this.response, scheduleWrapper.response) &&
        Objects.equals(this.count, scheduleWrapper.count) &&
        Objects.equals(this.links, scheduleWrapper.links) &&
        Objects.equals(this.status, scheduleWrapper.status) &&
        Objects.equals(this.statusCode, scheduleWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class ScheduleWrapper {\n");
