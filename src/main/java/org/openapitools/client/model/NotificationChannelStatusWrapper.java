...
import org.openapitools.client.model.NotificationChannelStatusDto;
 ...
 */
@JsonPropertyOrder({
  NotificationChannelStatusWrapper.JSON_PROPERTY_RESPONSE,
  NotificationChannelStatusWrapper.JSON_PROPERTY_COUNT,
  NotificationChannelStatusWrapper.JSON_PROPERTY_LINKS,
  NotificationChannelStatusWrapper.JSON_PROPERTY_STATUS,
  NotificationChannelStatusWrapper.JSON_PROPERTY_STATUS_CODE
})

public class NotificationChannelStatusWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private NotificationChannelStatusDto response;
  ...
  public NotificationChannelStatusDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable NotificationChannelStatusDto response) {
    this.response = response;
  }

  public NotificationChannelStatusWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public NotificationChannelStatusWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public NotificationChannelStatusWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public NotificationChannelStatusWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public NotificationChannelStatusWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    NotificationChannelStatusWrapper notificationChannelStatusWrapper = (NotificationChannelStatusWrapper) o;
    return Objects.equals(this.response, notificationChannelStatusWrapper.response) &&
        Objects.equals(this.count, notificationChannelStatusWrapper.count) &&
        Objects.equals(this.links, notificationChannelStatusWrapper.links) &&
        Objects.equals(this.status, notificationChannelStatusWrapper.status) &&
        Objects.equals(this.statusCode, notificationChannelStatusWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class NotificationChannelStatusWrapper {\n");
