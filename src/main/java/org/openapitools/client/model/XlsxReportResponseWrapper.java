...
import org.openapitools.client.model.XlsxReportResponseDto;
...
@JsonPropertyOrder({
  ...
  XlsxReportResponseWrapper.JSON_PROPERTY_COUNT,
  XlsxReportResponseWrapper.JSON_PROPERTY_LINKS,
  XlsxReportResponseWrapper.JSON_PROPERTY_STATUS,
  XlsxReportResponseWrapper.JSON_PROPERTY_STATUS_CODE
})

public class XlsxReportResponseWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private XlsxReportResponseDto response;
  ...
  public XlsxReportResponseWrapper() {
  }


  public XlsxReportResponseWrapper response(@javax.annotation.Nullable XlsxReportResponseDto response) {
  ...
  public XlsxReportResponseDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable XlsxReportResponseDto response) {
    this.response = response;
  }

  public XlsxReportResponseWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public XlsxReportResponseWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public XlsxReportResponseWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public XlsxReportResponseWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public XlsxReportResponseWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    XlsxReportResponseWrapper xlsxReportResponseWrapper = (XlsxReportResponseWrapper) o;
    return Objects.equals(this.response, xlsxReportResponseWrapper.response) &&
        Objects.equals(this.count, xlsxReportResponseWrapper.count) &&
        Objects.equals(this.links, xlsxReportResponseWrapper.links) &&
        Objects.equals(this.status, xlsxReportResponseWrapper.status) &&
        Objects.equals(this.statusCode, xlsxReportResponseWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class XlsxReportResponseWrapper {\n");
