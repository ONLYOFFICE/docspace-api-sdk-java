...
public class CreateProviderRequestDto {
  ...
  public CreateProviderRequestDto type(@javax.annotation.Nullable ProviderType type) {
  ...
  public CreateProviderRequestDto title(@javax.annotation.Nullable String title) {
  ...
  public CreateProviderRequestDto url(@javax.annotation.Nullable String url) {
  ...
  public CreateProviderRequestDto key(@javax.annotation.Nullable String key) {
  ...
  public boolean equals(Object o) {
    ...
    CreateProviderRequestDto createProviderRequestDto = (CreateProviderRequestDto) o;
