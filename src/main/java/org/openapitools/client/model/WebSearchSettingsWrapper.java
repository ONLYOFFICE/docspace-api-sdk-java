...
import org.openapitools.client.model.WebSearchSettingsDto;
 ...
 */
@JsonPropertyOrder({
  WebSearchSettingsWrapper.JSON_PROPERTY_RESPONSE,
  WebSearchSettingsWrapper.JSON_PROPERTY_COUNT,
  WebSearchSettingsWrapper.JSON_PROPERTY_LINKS,
  WebSearchSettingsWrapper.JSON_PROPERTY_STATUS,
  WebSearchSettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class WebSearchSettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private WebSearchSettingsDto response;
  ...
  public WebSearchSettingsWrapper() {
  }


  public WebSearchSettingsWrapper response(@javax.annotation.Nullable WebSearchSettingsDto response) {
  ...
  public WebSearchSettingsDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable WebSearchSettingsDto response) {
    this.response = response;
  }

  public WebSearchSettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public WebSearchSettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public WebSearchSettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public WebSearchSettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public WebSearchSettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    WebSearchSettingsWrapper webSearchSettingsWrapper = (WebSearchSettingsWrapper) o;
    return Objects.equals(this.response, webSearchSettingsWrapper.response) &&
        Objects.equals(this.count, webSearchSettingsWrapper.count) &&
        Objects.equals(this.links, webSearchSettingsWrapper.links) &&
        Objects.equals(this.status, webSearchSettingsWrapper.status) &&
        Objects.equals(this.statusCode, webSearchSettingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebSearchSettingsWrapper {\n");
