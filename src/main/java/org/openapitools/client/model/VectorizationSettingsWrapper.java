...
import org.openapitools.client.model.VectorizationSettingsDto;
 ...
 */
@JsonPropertyOrder({
  VectorizationSettingsWrapper.JSON_PROPERTY_RESPONSE,
  VectorizationSettingsWrapper.JSON_PROPERTY_COUNT,
  VectorizationSettingsWrapper.JSON_PROPERTY_LINKS,
  VectorizationSettingsWrapper.JSON_PROPERTY_STATUS,
  VectorizationSettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class VectorizationSettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private VectorizationSettingsDto response;
  ...
  public VectorizationSettingsWrapper() {
  }


  public VectorizationSettingsWrapper response(@javax.annotation.Nullable VectorizationSettingsDto response) {
  ...
  public VectorizationSettingsDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable VectorizationSettingsDto response) {
    this.response = response;
  }

  public VectorizationSettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public VectorizationSettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public VectorizationSettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public VectorizationSettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public VectorizationSettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    VectorizationSettingsWrapper vectorizationSettingsWrapper = (VectorizationSettingsWrapper) o;
    return Objects.equals(this.response, vectorizationSettingsWrapper.response) &&
        Objects.equals(this.count, vectorizationSettingsWrapper.count) &&
        Objects.equals(this.links, vectorizationSettingsWrapper.links) &&
        Objects.equals(this.status, vectorizationSettingsWrapper.status) &&
        Objects.equals(this.statusCode, vectorizationSettingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class VectorizationSettingsWrapper {\n");
