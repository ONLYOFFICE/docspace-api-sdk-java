...
import org.openapitools.client.model.EditHistoryDataDto;
 ...
 */
@JsonPropertyOrder({
  EditHistoryDataWrapper.JSON_PROPERTY_RESPONSE,
  EditHistoryDataWrapper.JSON_PROPERTY_COUNT,
  EditHistoryDataWrapper.JSON_PROPERTY_LINKS,
  EditHistoryDataWrapper.JSON_PROPERTY_STATUS,
  EditHistoryDataWrapper.JSON_PROPERTY_STATUS_CODE
})

public class EditHistoryDataWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private EditHistoryDataDto response;
  ...
  public EditHistoryDataDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable EditHistoryDataDto response) {
    this.response = response;
  }

  public EditHistoryDataWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public EditHistoryDataWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public EditHistoryDataWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public EditHistoryDataWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public EditHistoryDataWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    EditHistoryDataWrapper editHistoryDataWrapper = (EditHistoryDataWrapper) o;
    return Objects.equals(this.response, editHistoryDataWrapper.response) &&
        Objects.equals(this.count, editHistoryDataWrapper.count) &&
        Objects.equals(this.links, editHistoryDataWrapper.links) &&
        Objects.equals(this.status, editHistoryDataWrapper.status) &&
        Objects.equals(this.statusCode, editHistoryDataWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class EditHistoryDataWrapper {\n");
