...
import org.openapitools.client.model.TenantDevToolsAccessSettings;
...
@JsonPropertyOrder({
  ...
  TenantDevToolsAccessSettingsWrapper.JSON_PROPERTY_COUNT,
  TenantDevToolsAccessSettingsWrapper.JSON_PROPERTY_LINKS,
  TenantDevToolsAccessSettingsWrapper.JSON_PROPERTY_STATUS,
  TenantDevToolsAccessSettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class TenantDevToolsAccessSettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private TenantDevToolsAccessSettings response;
  ...
  public TenantDevToolsAccessSettings getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable TenantDevToolsAccessSettings response) {
    this.response = response;
  }

  public TenantDevToolsAccessSettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public TenantDevToolsAccessSettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public TenantDevToolsAccessSettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public TenantDevToolsAccessSettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public TenantDevToolsAccessSettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    TenantDevToolsAccessSettingsWrapper tenantDevToolsAccessSettingsWrapper = (TenantDevToolsAccessSettingsWrapper) o;
    return Objects.equals(this.response, tenantDevToolsAccessSettingsWrapper.response) &&
        Objects.equals(this.count, tenantDevToolsAccessSettingsWrapper.count) &&
        Objects.equals(this.links, tenantDevToolsAccessSettingsWrapper.links) &&
        Objects.equals(this.status, tenantDevToolsAccessSettingsWrapper.status) &&
        Objects.equals(this.statusCode, tenantDevToolsAccessSettingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class TenantDevToolsAccessSettingsWrapper {\n");
