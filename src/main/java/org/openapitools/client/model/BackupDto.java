...
@JsonPropertyOrder({
  ...
  BackupDto.JSON_PROPERTY_STORAGE_PARAMS,
  BackupDto.JSON_PROPERTY_DUMP
})
...
public class BackupDto {
  ...
  public BackupDto storageParams(@javax.annotation.Nullable List<ItemKeyValuePairObjectObject> storageParams) {
    this.storageParams = JsonNullable.<List<ItemKeyValuePairObjectObject>>of(storageParams);
    
    return this;
  }

  public BackupDto addStorageParamsItem(ItemKeyValuePairObjectObject storageParamsItem) {
  ...
  public BackupDto dump(@javax.annotation.Nullable Boolean dump) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.storageType, backupDto.storageType) &&
        equalsNullable(this.storageParams, backupDto.storageParams) &&
        Objects.equals(this.dump, backupDto.dump);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(storageType, hashCodeNullable(storageParams), dump);
  }
