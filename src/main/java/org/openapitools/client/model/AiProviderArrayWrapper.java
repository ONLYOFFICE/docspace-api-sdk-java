...
import org.openapitools.client.model.AiProviderDto;
 ...
 */
@JsonPropertyOrder({
  AiProviderArrayWrapper.JSON_PROPERTY_RESPONSE,
  AiProviderArrayWrapper.JSON_PROPERTY_COUNT,
  AiProviderArrayWrapper.JSON_PROPERTY_LINKS,
  AiProviderArrayWrapper.JSON_PROPERTY_STATUS,
  AiProviderArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class AiProviderArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<AiProviderDto> response = new ArrayList<>();
  ...
  public AiProviderArrayWrapper() {
  }


  public AiProviderArrayWrapper response(@javax.annotation.Nullable List<AiProviderDto> response) {
    
    this.response = response;
    return this;
  }

  public AiProviderArrayWrapper addResponseItem(AiProviderDto responseItem) {
  ...
  public List<AiProviderDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<AiProviderDto> response) {
    this.response = response;
  }

  public AiProviderArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public AiProviderArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public AiProviderArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public AiProviderArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public AiProviderArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    AiProviderArrayWrapper aiProviderArrayWrapper = (AiProviderArrayWrapper) o;
    return Objects.equals(this.response, aiProviderArrayWrapper.response) &&
        Objects.equals(this.count, aiProviderArrayWrapper.count) &&
        Objects.equals(this.links, aiProviderArrayWrapper.links) &&
        Objects.equals(this.status, aiProviderArrayWrapper.status) &&
        Objects.equals(this.statusCode, aiProviderArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class AiProviderArrayWrapper {\n");
