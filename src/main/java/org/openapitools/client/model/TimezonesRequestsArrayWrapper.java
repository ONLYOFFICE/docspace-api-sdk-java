...
import org.openapitools.client.model.TimezonesRequestsDto;
...
@JsonPropertyOrder({
  ...
  TimezonesRequestsArrayWrapper.JSON_PROPERTY_COUNT,
  TimezonesRequestsArrayWrapper.JSON_PROPERTY_LINKS,
  TimezonesRequestsArrayWrapper.JSON_PROPERTY_STATUS,
  TimezonesRequestsArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class TimezonesRequestsArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<TimezonesRequestsDto> response = new ArrayList<>();
  ...
  public TimezonesRequestsArrayWrapper addResponseItem(TimezonesRequestsDto responseItem) {
  ...
  public List<TimezonesRequestsDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<TimezonesRequestsDto> response) {
    this.response = response;
  }

  public TimezonesRequestsArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public TimezonesRequestsArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public TimezonesRequestsArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public TimezonesRequestsArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public TimezonesRequestsArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    TimezonesRequestsArrayWrapper timezonesRequestsArrayWrapper = (TimezonesRequestsArrayWrapper) o;
    return Objects.equals(this.response, timezonesRequestsArrayWrapper.response) &&
        Objects.equals(this.count, timezonesRequestsArrayWrapper.count) &&
        Objects.equals(this.links, timezonesRequestsArrayWrapper.links) &&
        Objects.equals(this.status, timezonesRequestsArrayWrapper.status) &&
        Objects.equals(this.statusCode, timezonesRequestsArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class TimezonesRequestsArrayWrapper {\n");
