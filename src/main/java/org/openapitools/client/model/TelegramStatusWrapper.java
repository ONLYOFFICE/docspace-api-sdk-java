...
import org.openapitools.client.model.TelegramStatusDto;
...
@JsonPropertyOrder({
  ...
  TelegramStatusWrapper.JSON_PROPERTY_COUNT,
  TelegramStatusWrapper.JSON_PROPERTY_LINKS,
  TelegramStatusWrapper.JSON_PROPERTY_STATUS,
  TelegramStatusWrapper.JSON_PROPERTY_STATUS_CODE
})

public class TelegramStatusWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private TelegramStatusDto response;
  ...
  public TelegramStatusDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable TelegramStatusDto response) {
    this.response = response;
  }

  public TelegramStatusWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public TelegramStatusWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public TelegramStatusWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public TelegramStatusWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public TelegramStatusWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    TelegramStatusWrapper telegramStatusWrapper = (TelegramStatusWrapper) o;
    return Objects.equals(this.response, telegramStatusWrapper.response) &&
        Objects.equals(this.count, telegramStatusWrapper.count) &&
        Objects.equals(this.links, telegramStatusWrapper.links) &&
        Objects.equals(this.status, telegramStatusWrapper.status) &&
        Objects.equals(this.statusCode, telegramStatusWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class TelegramStatusWrapper {\n");
