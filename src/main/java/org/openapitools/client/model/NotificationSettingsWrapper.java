...
import org.openapitools.client.model.NotificationSettingsDto;
 ...
 */
@JsonPropertyOrder({
  NotificationSettingsWrapper.JSON_PROPERTY_RESPONSE,
  NotificationSettingsWrapper.JSON_PROPERTY_COUNT,
  NotificationSettingsWrapper.JSON_PROPERTY_LINKS,
  NotificationSettingsWrapper.JSON_PROPERTY_STATUS,
  NotificationSettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class NotificationSettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private NotificationSettingsDto response;
  ...
  public NotificationSettingsDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable NotificationSettingsDto response) {
    this.response = response;
  }

  public NotificationSettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public NotificationSettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public NotificationSettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public NotificationSettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public NotificationSettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    NotificationSettingsWrapper notificationSettingsWrapper = (NotificationSettingsWrapper) o;
    return Objects.equals(this.response, notificationSettingsWrapper.response) &&
        Objects.equals(this.count, notificationSettingsWrapper.count) &&
        Objects.equals(this.links, notificationSettingsWrapper.links) &&
        Objects.equals(this.status, notificationSettingsWrapper.status) &&
        Objects.equals(this.statusCode, notificationSettingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class NotificationSettingsWrapper {\n");
