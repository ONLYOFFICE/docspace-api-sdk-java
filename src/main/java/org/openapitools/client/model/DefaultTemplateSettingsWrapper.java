...
import org.openapitools.client.model.DefaultTemplateSettingsDto;
 ...
 */
@JsonPropertyOrder({
  DefaultTemplateSettingsWrapper.JSON_PROPERTY_RESPONSE,
  DefaultTemplateSettingsWrapper.JSON_PROPERTY_COUNT,
  DefaultTemplateSettingsWrapper.JSON_PROPERTY_LINKS,
  DefaultTemplateSettingsWrapper.JSON_PROPERTY_STATUS,
  DefaultTemplateSettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class DefaultTemplateSettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private DefaultTemplateSettingsDto response;
  ...
  public DefaultTemplateSettingsWrapper() {
  }


  public DefaultTemplateSettingsWrapper response(@javax.annotation.Nullable DefaultTemplateSettingsDto response) {
  ...
  public DefaultTemplateSettingsDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable DefaultTemplateSettingsDto response) {
    this.response = response;
  }

  public DefaultTemplateSettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public DefaultTemplateSettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public DefaultTemplateSettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public DefaultTemplateSettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public DefaultTemplateSettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    DefaultTemplateSettingsWrapper defaultTemplateSettingsWrapper = (DefaultTemplateSettingsWrapper) o;
    return Objects.equals(this.response, defaultTemplateSettingsWrapper.response) &&
        Objects.equals(this.count, defaultTemplateSettingsWrapper.count) &&
        Objects.equals(this.links, defaultTemplateSettingsWrapper.links) &&
        Objects.equals(this.status, defaultTemplateSettingsWrapper.status) &&
        Objects.equals(this.statusCode, defaultTemplateSettingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class DefaultTemplateSettingsWrapper {\n");
