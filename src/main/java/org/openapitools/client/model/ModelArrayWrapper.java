 ...
 */
@JsonPropertyOrder({
  ModelArrayWrapper.JSON_PROPERTY_RESPONSE,
  ModelArrayWrapper.JSON_PROPERTY_COUNT,
  ModelArrayWrapper.JSON_PROPERTY_LINKS,
  ModelArrayWrapper.JSON_PROPERTY_STATUS,
  ModelArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class ModelArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<ModelDto> response = new ArrayList<>();
  ...
  public ModelArrayWrapper() {
  }


  public ModelArrayWrapper response(@javax.annotation.Nullable List<ModelDto> response) {
    
    this.response = response;
    return this;
  }

  public ModelArrayWrapper addResponseItem(ModelDto responseItem) {
  ...
  public List<ModelDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<ModelDto> response) {
    this.response = response;
  }

  public ModelArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public ModelArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public ModelArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public ModelArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public ModelArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    ModelArrayWrapper modelArrayWrapper = (ModelArrayWrapper) o;
    return Objects.equals(this.response, modelArrayWrapper.response) &&
        Objects.equals(this.count, modelArrayWrapper.count) &&
        Objects.equals(this.links, modelArrayWrapper.links) &&
        Objects.equals(this.status, modelArrayWrapper.status) &&
        Objects.equals(this.statusCode, modelArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModelArrayWrapper {\n");
