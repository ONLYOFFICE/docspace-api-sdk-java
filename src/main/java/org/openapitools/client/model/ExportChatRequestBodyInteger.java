 ...
 */
@JsonPropertyOrder({
  ExportChatRequestBodyInteger.JSON_PROPERTY_FOLDER_ID,
  ExportChatRequestBodyInteger.JSON_PROPERTY_TITLE
})

public class ExportChatRequestBodyInteger {
  ...
  public ExportChatRequestBodyInteger() {
  }


  public ExportChatRequestBodyInteger folderId(@javax.annotation.Nonnull Integer folderId) {
  ...
  public ExportChatRequestBodyInteger title(@javax.annotation.Nullable String title) {
  ...
  public boolean equals(Object o) {
    ...
    ExportChatRequestBodyInteger exportChatRequestBodyInteger = (ExportChatRequestBodyInteger) o;
    return Objects.equals(this.folderId, exportChatRequestBodyInteger.folderId) &&
        Objects.equals(this.title, exportChatRequestBodyInteger.title);
  }
