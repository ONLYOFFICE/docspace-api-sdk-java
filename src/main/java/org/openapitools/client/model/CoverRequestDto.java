 ...
 */
@JsonPropertyOrder({
  CoverRequestDto.JSON_PROPERTY_COLOR,
  CoverRequestDto.JSON_PROPERTY_COVER
})
...
public class CoverRequestDto {
  ...
  public CoverRequestDto cover(@javax.annotation.Nullable String cover) {
  ...
  public boolean equals(Object o) {
    ...
    CoverRequestDto coverRequestDto = (CoverRequestDto) o;
    return equalsNullable(this.color, coverRequestDto.color) &&
        equalsNullable(this.cover, coverRequestDto.cover);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(color), hashCodeNullable(cover));
  }
