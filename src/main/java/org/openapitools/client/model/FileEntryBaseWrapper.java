...
@JsonPropertyOrder({
  ...
  FileEntryBaseWrapper.JSON_PROPERTY_COUNT,
  FileEntryBaseWrapper.JSON_PROPERTY_LINKS,
  FileEntryBaseWrapper.JSON_PROPERTY_STATUS,
  FileEntryBaseWrapper.JSON_PROPERTY_STATUS_CODE
})

public class FileEntryBaseWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private FileEntryBaseDto response;
  ...
  public FileEntryBaseWrapper() {
  }


  public FileEntryBaseWrapper response(@javax.annotation.Nullable FileEntryBaseDto response) {
  ...
  public FileEntryBaseDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable FileEntryBaseDto response) {
    this.response = response;
  }

  public FileEntryBaseWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public FileEntryBaseWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public FileEntryBaseWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public FileEntryBaseWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public FileEntryBaseWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    FileEntryBaseWrapper fileEntryBaseWrapper = (FileEntryBaseWrapper) o;
    return Objects.equals(this.response, fileEntryBaseWrapper.response) &&
        Objects.equals(this.count, fileEntryBaseWrapper.count) &&
        Objects.equals(this.links, fileEntryBaseWrapper.links) &&
        Objects.equals(this.status, fileEntryBaseWrapper.status) &&
        Objects.equals(this.statusCode, fileEntryBaseWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class FileEntryBaseWrapper {\n");
