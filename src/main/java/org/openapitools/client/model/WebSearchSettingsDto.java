 ...
 */
@JsonPropertyOrder({
  WebSearchSettingsDto.JSON_PROPERTY_ENABLED,
  WebSearchSettingsDto.JSON_PROPERTY_TYPE,
  WebSearchSettingsDto.JSON_PROPERTY_NEED_RESET
})
...
public class WebSearchSettingsDto {
  ...
  public WebSearchSettingsDto() {
  }


  public WebSearchSettingsDto enabled(@javax.annotation.Nullable Boolean enabled) {
  ...
  public WebSearchSettingsDto type(@javax.annotation.Nullable EngineType type) {
  ...
  public WebSearchSettingsDto needReset(@javax.annotation.Nullable Boolean needReset) {
  ...
  public boolean equals(Object o) {
    ...
    WebSearchSettingsDto webSearchSettingsDto = (WebSearchSettingsDto) o;
    return Objects.equals(this.enabled, webSearchSettingsDto.enabled) &&
        Objects.equals(this.type, webSearchSettingsDto.type) &&
        Objects.equals(this.needReset, webSearchSettingsDto.needReset);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, type, needReset);
  }
