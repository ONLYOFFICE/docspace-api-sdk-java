 ...
 */
@JsonPropertyOrder({
  FolderContentIntegerWrapper.JSON_PROPERTY_RESPONSE,
  FolderContentIntegerWrapper.JSON_PROPERTY_COUNT,
  FolderContentIntegerWrapper.JSON_PROPERTY_LINKS,
  FolderContentIntegerWrapper.JSON_PROPERTY_STATUS,
  FolderContentIntegerWrapper.JSON_PROPERTY_STATUS_CODE
})

public class FolderContentIntegerWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private FolderContentDtoInteger response;
  ...
  public FolderContentDtoInteger getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable FolderContentDtoInteger response) {
    this.response = response;
  }

  public FolderContentIntegerWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public FolderContentIntegerWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public FolderContentIntegerWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public FolderContentIntegerWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public FolderContentIntegerWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    FolderContentIntegerWrapper folderContentIntegerWrapper = (FolderContentIntegerWrapper) o;
    return Objects.equals(this.response, folderContentIntegerWrapper.response) &&
        Objects.equals(this.count, folderContentIntegerWrapper.count) &&
        Objects.equals(this.links, folderContentIntegerWrapper.links) &&
        Objects.equals(this.status, folderContentIntegerWrapper.status) &&
        Objects.equals(this.statusCode, folderContentIntegerWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class FolderContentIntegerWrapper {\n");
