...
import org.openapitools.client.model.ExternalDbSyncTaskDto;
...
@JsonPropertyOrder({
  ...
  ExternalDbSyncTaskWrapper.JSON_PROPERTY_COUNT,
  ExternalDbSyncTaskWrapper.JSON_PROPERTY_LINKS,
  ExternalDbSyncTaskWrapper.JSON_PROPERTY_STATUS,
  ExternalDbSyncTaskWrapper.JSON_PROPERTY_STATUS_CODE
})

public class ExternalDbSyncTaskWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private ExternalDbSyncTaskDto response;
  ...
  public ExternalDbSyncTaskWrapper() {
  }


  public ExternalDbSyncTaskWrapper response(@javax.annotation.Nullable ExternalDbSyncTaskDto response) {
  ...
  public ExternalDbSyncTaskDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable ExternalDbSyncTaskDto response) {
    this.response = response;
  }

  public ExternalDbSyncTaskWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public ExternalDbSyncTaskWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public ExternalDbSyncTaskWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public ExternalDbSyncTaskWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public ExternalDbSyncTaskWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    ExternalDbSyncTaskWrapper externalDbSyncTaskWrapper = (ExternalDbSyncTaskWrapper) o;
    return Objects.equals(this.response, externalDbSyncTaskWrapper.response) &&
        Objects.equals(this.count, externalDbSyncTaskWrapper.count) &&
        Objects.equals(this.links, externalDbSyncTaskWrapper.links) &&
        Objects.equals(this.status, externalDbSyncTaskWrapper.status) &&
        Objects.equals(this.statusCode, externalDbSyncTaskWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExternalDbSyncTaskWrapper {\n");
