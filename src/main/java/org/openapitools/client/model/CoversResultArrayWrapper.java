...
import org.openapitools.client.model.CoversResultDto;
 ...
 */
@JsonPropertyOrder({
  CoversResultArrayWrapper.JSON_PROPERTY_RESPONSE,
  CoversResultArrayWrapper.JSON_PROPERTY_COUNT,
  CoversResultArrayWrapper.JSON_PROPERTY_LINKS,
  CoversResultArrayWrapper.JSON_PROPERTY_STATUS,
  CoversResultArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class CoversResultArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<CoversResultDto> response = new ArrayList<>();
  ...
  public CoversResultArrayWrapper addResponseItem(CoversResultDto responseItem) {
  ...
  public List<CoversResultDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<CoversResultDto> response) {
    this.response = response;
  }

  public CoversResultArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public CoversResultArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public CoversResultArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public CoversResultArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public CoversResultArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    CoversResultArrayWrapper coversResultArrayWrapper = (CoversResultArrayWrapper) o;
    return Objects.equals(this.response, coversResultArrayWrapper.response) &&
        Objects.equals(this.count, coversResultArrayWrapper.count) &&
        Objects.equals(this.links, coversResultArrayWrapper.links) &&
        Objects.equals(this.status, coversResultArrayWrapper.status) &&
        Objects.equals(this.statusCode, coversResultArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class CoversResultArrayWrapper {\n");
