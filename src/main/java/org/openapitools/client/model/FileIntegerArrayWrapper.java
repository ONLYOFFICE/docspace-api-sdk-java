 ...
 */
@JsonPropertyOrder({
  FileIntegerArrayWrapper.JSON_PROPERTY_RESPONSE,
  FileIntegerArrayWrapper.JSON_PROPERTY_COUNT,
  FileIntegerArrayWrapper.JSON_PROPERTY_LINKS,
  FileIntegerArrayWrapper.JSON_PROPERTY_STATUS,
  FileIntegerArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class FileIntegerArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<FileDtoInteger> response = new ArrayList<>();
  ...
  public FileIntegerArrayWrapper() {
  }


  public FileIntegerArrayWrapper response(@javax.annotation.Nullable List<FileDtoInteger> response) {
    
    this.response = response;
    return this;
  }

  public FileIntegerArrayWrapper addResponseItem(FileDtoInteger responseItem) {
  ...
  public List<FileDtoInteger> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<FileDtoInteger> response) {
    this.response = response;
  }

  public FileIntegerArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public FileIntegerArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public FileIntegerArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public FileIntegerArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public FileIntegerArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    FileIntegerArrayWrapper fileIntegerArrayWrapper = (FileIntegerArrayWrapper) o;
    return Objects.equals(this.response, fileIntegerArrayWrapper.response) &&
        Objects.equals(this.count, fileIntegerArrayWrapper.count) &&
        Objects.equals(this.links, fileIntegerArrayWrapper.links) &&
        Objects.equals(this.status, fileIntegerArrayWrapper.status) &&
        Objects.equals(this.statusCode, fileIntegerArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class FileIntegerArrayWrapper {\n");
