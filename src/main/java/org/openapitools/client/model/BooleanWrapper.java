 ...
 */
@JsonPropertyOrder({
  BooleanWrapper.JSON_PROPERTY_RESPONSE,
  BooleanWrapper.JSON_PROPERTY_COUNT,
  BooleanWrapper.JSON_PROPERTY_LINKS,
  BooleanWrapper.JSON_PROPERTY_STATUS,
  BooleanWrapper.JSON_PROPERTY_STATUS_CODE
})

public class BooleanWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private Boolean response;
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable Boolean response) {
    this.response = response;
  }

  public BooleanWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public BooleanWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public BooleanWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public BooleanWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public BooleanWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.response, booleanWrapper.response) &&
        Objects.equals(this.count, booleanWrapper.count) &&
        Objects.equals(this.links, booleanWrapper.links) &&
        Objects.equals(this.status, booleanWrapper.status) &&
        Objects.equals(this.statusCode, booleanWrapper.statusCode);
  }
