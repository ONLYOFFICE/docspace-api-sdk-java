...
@JsonPropertyOrder({
  ...
  FileEntryBaseArrayWrapper.JSON_PROPERTY_COUNT,
  FileEntryBaseArrayWrapper.JSON_PROPERTY_LINKS,
  FileEntryBaseArrayWrapper.JSON_PROPERTY_STATUS,
  FileEntryBaseArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class FileEntryBaseArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<FileEntryBaseDto> response = new ArrayList<>();
  ...
  public FileEntryBaseArrayWrapper addResponseItem(FileEntryBaseDto responseItem) {
  ...
  public List<FileEntryBaseDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<FileEntryBaseDto> response) {
    this.response = response;
  }

  public FileEntryBaseArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public FileEntryBaseArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public FileEntryBaseArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public FileEntryBaseArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public FileEntryBaseArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    FileEntryBaseArrayWrapper fileEntryBaseArrayWrapper = (FileEntryBaseArrayWrapper) o;
    return Objects.equals(this.response, fileEntryBaseArrayWrapper.response) &&
        Objects.equals(this.count, fileEntryBaseArrayWrapper.count) &&
        Objects.equals(this.links, fileEntryBaseArrayWrapper.links) &&
        Objects.equals(this.status, fileEntryBaseArrayWrapper.status) &&
        Objects.equals(this.statusCode, fileEntryBaseArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class FileEntryBaseArrayWrapper {\n");
