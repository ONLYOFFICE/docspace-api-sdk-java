...
import org.openapitools.client.model.ChatDto;
 ...
 */
@JsonPropertyOrder({
  ChatArrayWrapper.JSON_PROPERTY_RESPONSE,
  ChatArrayWrapper.JSON_PROPERTY_COUNT,
  ChatArrayWrapper.JSON_PROPERTY_LINKS,
  ChatArrayWrapper.JSON_PROPERTY_STATUS,
  ChatArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class ChatArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<ChatDto> response = new ArrayList<>();
  ...
  public ChatArrayWrapper() {
  }


  public ChatArrayWrapper response(@javax.annotation.Nullable List<ChatDto> response) {
    
    this.response = response;
    return this;
  }

  public ChatArrayWrapper addResponseItem(ChatDto responseItem) {
  ...
  public List<ChatDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<ChatDto> response) {
    this.response = response;
  }

  public ChatArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public ChatArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public ChatArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public ChatArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public ChatArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    ChatArrayWrapper chatArrayWrapper = (ChatArrayWrapper) o;
    return Objects.equals(this.response, chatArrayWrapper.response) &&
        Objects.equals(this.count, chatArrayWrapper.count) &&
        Objects.equals(this.links, chatArrayWrapper.links) &&
        Objects.equals(this.status, chatArrayWrapper.status) &&
        Objects.equals(this.statusCode, chatArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChatArrayWrapper {\n");
