...
@JsonPropertyOrder({
  ...
  FeatureUsedDto.JSON_PROPERTY_TITLE
})
...
public class FeatureUsedDto {
  ...
  public FeatureUsedDto title(@javax.annotation.Nullable String title) {
  ...
  public boolean equals(Object o) {
    ...
    FeatureUsedDto featureUsedDto = (FeatureUsedDto) o;
    return Objects.equals(this.value, featureUsedDto.value) &&
        equalsNullable(this.title, featureUsedDto.title);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(value, hashCodeNullable(title));
  }
