...
@JsonPropertyOrder({
  ...
  ObjectArrayWrapper.JSON_PROPERTY_COUNT,
  ObjectArrayWrapper.JSON_PROPERTY_LINKS,
...
public class ObjectArrayWrapper {
  ...
  @javax.annotation.Nullable  private List<Object> response = new ArrayList<>();
  ...
  public ObjectArrayWrapper response(@javax.annotation.Nullable List<Object> response) {
    
    this.response = response;
    return this;
  }

  public ObjectArrayWrapper addResponseItem(Object responseItem) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<Object> response) {
    this.response = response;
  }

  public ObjectArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public ObjectArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public ObjectArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public ObjectArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public ObjectArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    ObjectArrayWrapper objectArrayWrapper = (ObjectArrayWrapper) o;
    return Objects.equals(this.response, objectArrayWrapper.response) &&
        Objects.equals(this.count, objectArrayWrapper.count) &&
        Objects.equals(this.links, objectArrayWrapper.links) &&
        Objects.equals(this.status, objectArrayWrapper.status) &&
        Objects.equals(this.statusCode, objectArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class ObjectArrayWrapper {\n");
