 ...
 */
@JsonPropertyOrder({
  PageableResponseClientInfoResponse.JSON_PROPERTY_DATA,
  PageableResponseClientInfoResponse.JSON_PROPERTY_LIMIT,
  PageableResponseClientInfoResponse.JSON_PROPERTY_LAST_CLIENT_ID,
  PageableResponseClientInfoResponse.JSON_PROPERTY_LAST_CREATED_ON
})
...
public class PageableResponseClientInfoResponse {
  ...
  public PageableResponseClientInfoResponse data(@javax.annotation.Nullable Object data) {
  ...
  public PageableResponseClientInfoResponse limit(@javax.annotation.Nullable Integer limit) {
  ...
  public PageableResponseClientInfoResponse lastClientId(@javax.annotation.Nullable String lastClientId) {
  ...
  public PageableResponseClientInfoResponse lastCreatedOn(@javax.annotation.Nullable OffsetDateTime lastCreatedOn) {
  ...
  public boolean equals(Object o) {
    ...
    PageableResponseClientInfoResponse pageableResponseClientInfoResponse = (PageableResponseClientInfoResponse) o;
    return Objects.equals(this.data, pageableResponseClientInfoResponse.data) &&
        Objects.equals(this.limit, pageableResponseClientInfoResponse.limit) &&
        Objects.equals(this.lastClientId, pageableResponseClientInfoResponse.lastClientId) &&
        Objects.equals(this.lastCreatedOn, pageableResponseClientInfoResponse.lastCreatedOn);
  }
