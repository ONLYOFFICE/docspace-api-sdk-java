...
import org.openapitools.client.model.DefaultProviderDto;
 ...
 */
@JsonPropertyOrder({
  DefaultProviderWrapper.JSON_PROPERTY_RESPONSE,
  DefaultProviderWrapper.JSON_PROPERTY_COUNT,
  DefaultProviderWrapper.JSON_PROPERTY_LINKS,
  DefaultProviderWrapper.JSON_PROPERTY_STATUS,
  DefaultProviderWrapper.JSON_PROPERTY_STATUS_CODE
})

public class DefaultProviderWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private DefaultProviderDto response;
  ...
  public DefaultProviderWrapper() {
  }


  public DefaultProviderWrapper response(@javax.annotation.Nullable DefaultProviderDto response) {
  ...
  public DefaultProviderDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable DefaultProviderDto response) {
    this.response = response;
  }

  public DefaultProviderWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public DefaultProviderWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public DefaultProviderWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public DefaultProviderWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public DefaultProviderWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    DefaultProviderWrapper defaultProviderWrapper = (DefaultProviderWrapper) o;
    return Objects.equals(this.response, defaultProviderWrapper.response) &&
        Objects.equals(this.count, defaultProviderWrapper.count) &&
        Objects.equals(this.links, defaultProviderWrapper.links) &&
        Objects.equals(this.status, defaultProviderWrapper.status) &&
        Objects.equals(this.statusCode, defaultProviderWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class DefaultProviderWrapper {\n");
