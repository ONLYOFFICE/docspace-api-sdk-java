...
import org.openapitools.client.model.CookieSettingsDto;
 ...
 */
@JsonPropertyOrder({
  CookieSettingsWrapper.JSON_PROPERTY_RESPONSE,
  CookieSettingsWrapper.JSON_PROPERTY_COUNT,
  CookieSettingsWrapper.JSON_PROPERTY_LINKS,
  CookieSettingsWrapper.JSON_PROPERTY_STATUS,
  CookieSettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class CookieSettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private CookieSettingsDto response;
  ...
  public CookieSettingsDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable CookieSettingsDto response) {
    this.response = response;
  }

  public CookieSettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public CookieSettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public CookieSettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public CookieSettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public CookieSettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    CookieSettingsWrapper cookieSettingsWrapper = (CookieSettingsWrapper) o;
    return Objects.equals(this.response, cookieSettingsWrapper.response) &&
        Objects.equals(this.count, cookieSettingsWrapper.count) &&
        Objects.equals(this.links, cookieSettingsWrapper.links) &&
        Objects.equals(this.status, cookieSettingsWrapper.status) &&
        Objects.equals(this.statusCode, cookieSettingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class CookieSettingsWrapper {\n");
