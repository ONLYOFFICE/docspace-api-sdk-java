...
import org.openapitools.client.model.ThirdPartyParams;
...
@JsonPropertyOrder({
  ...
  ThirdPartyParamsArrayWrapper.JSON_PROPERTY_COUNT,
  ThirdPartyParamsArrayWrapper.JSON_PROPERTY_LINKS,
  ThirdPartyParamsArrayWrapper.JSON_PROPERTY_STATUS,
  ThirdPartyParamsArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class ThirdPartyParamsArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<ThirdPartyParams> response = new ArrayList<>();
  ...
  public ThirdPartyParamsArrayWrapper addResponseItem(ThirdPartyParams responseItem) {
  ...
  public List<ThirdPartyParams> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<ThirdPartyParams> response) {
    this.response = response;
  }

  public ThirdPartyParamsArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public ThirdPartyParamsArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public ThirdPartyParamsArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public ThirdPartyParamsArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public ThirdPartyParamsArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    ThirdPartyParamsArrayWrapper thirdPartyParamsArrayWrapper = (ThirdPartyParamsArrayWrapper) o;
    return Objects.equals(this.response, thirdPartyParamsArrayWrapper.response) &&
        Objects.equals(this.count, thirdPartyParamsArrayWrapper.count) &&
        Objects.equals(this.links, thirdPartyParamsArrayWrapper.links) &&
        Objects.equals(this.status, thirdPartyParamsArrayWrapper.status) &&
        Objects.equals(this.statusCode, thirdPartyParamsArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class ThirdPartyParamsArrayWrapper {\n");
