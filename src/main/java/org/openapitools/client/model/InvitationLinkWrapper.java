...
import org.openapitools.client.model.InvitationLinkDto;
 ...
 */
@JsonPropertyOrder({
  InvitationLinkWrapper.JSON_PROPERTY_RESPONSE,
  InvitationLinkWrapper.JSON_PROPERTY_COUNT,
  InvitationLinkWrapper.JSON_PROPERTY_LINKS,
  InvitationLinkWrapper.JSON_PROPERTY_STATUS,
  InvitationLinkWrapper.JSON_PROPERTY_STATUS_CODE
})

public class InvitationLinkWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private InvitationLinkDto response;
  ...
  public InvitationLinkWrapper() {
  }


  public InvitationLinkWrapper response(@javax.annotation.Nullable InvitationLinkDto response) {
  ...
  public InvitationLinkDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable InvitationLinkDto response) {
    this.response = response;
  }

  public InvitationLinkWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public InvitationLinkWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public InvitationLinkWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public InvitationLinkWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public InvitationLinkWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    InvitationLinkWrapper invitationLinkWrapper = (InvitationLinkWrapper) o;
    return Objects.equals(this.response, invitationLinkWrapper.response) &&
        Objects.equals(this.count, invitationLinkWrapper.count) &&
        Objects.equals(this.links, invitationLinkWrapper.links) &&
        Objects.equals(this.status, invitationLinkWrapper.status) &&
        Objects.equals(this.statusCode, invitationLinkWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class InvitationLinkWrapper {\n");
