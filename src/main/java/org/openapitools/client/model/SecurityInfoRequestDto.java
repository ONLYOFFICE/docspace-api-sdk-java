...
public class SecurityInfoRequestDto {
  ...
  public SecurityInfoRequestDto folderIds(@javax.annotation.Nullable List<Integer> folderIds) {
    this.folderIds = JsonNullable.<List<Integer>>of(folderIds);
    
    return this;
  }

  public SecurityInfoRequestDto addFolderIdsItem(Integer folderIdsItem) {
  ...
  public SecurityInfoRequestDto fileIds(@javax.annotation.Nullable List<Integer> fileIds) {
    this.fileIds = JsonNullable.<List<Integer>>of(fileIds);
    
    return this;
  }

  public SecurityInfoRequestDto addFileIdsItem(Integer fileIdsItem) {
