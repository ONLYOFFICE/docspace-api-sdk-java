...
import org.openapitools.client.model.FillingFormResultDtoInteger;
 ...
 */
@JsonPropertyOrder({
  FillingFormResultIntegerWrapper.JSON_PROPERTY_RESPONSE,
  FillingFormResultIntegerWrapper.JSON_PROPERTY_COUNT,
  FillingFormResultIntegerWrapper.JSON_PROPERTY_LINKS,
  FillingFormResultIntegerWrapper.JSON_PROPERTY_STATUS,
  FillingFormResultIntegerWrapper.JSON_PROPERTY_STATUS_CODE
})

public class FillingFormResultIntegerWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private FillingFormResultDtoInteger response;
  ...
  public FillingFormResultDtoInteger getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable FillingFormResultDtoInteger response) {
    this.response = response;
  }

  public FillingFormResultIntegerWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public FillingFormResultIntegerWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public FillingFormResultIntegerWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public FillingFormResultIntegerWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public FillingFormResultIntegerWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    FillingFormResultIntegerWrapper fillingFormResultIntegerWrapper = (FillingFormResultIntegerWrapper) o;
    return Objects.equals(this.response, fillingFormResultIntegerWrapper.response) &&
        Objects.equals(this.count, fillingFormResultIntegerWrapper.count) &&
        Objects.equals(this.links, fillingFormResultIntegerWrapper.links) &&
        Objects.equals(this.status, fillingFormResultIntegerWrapper.status) &&
        Objects.equals(this.statusCode, fillingFormResultIntegerWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class FillingFormResultIntegerWrapper {\n");
