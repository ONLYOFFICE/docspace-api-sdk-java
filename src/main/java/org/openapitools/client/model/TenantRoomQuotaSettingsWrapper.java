...
import org.openapitools.client.model.TenantRoomQuotaSettings;
...
@JsonPropertyOrder({
  ...
  TenantRoomQuotaSettingsWrapper.JSON_PROPERTY_COUNT,
  TenantRoomQuotaSettingsWrapper.JSON_PROPERTY_LINKS,
  TenantRoomQuotaSettingsWrapper.JSON_PROPERTY_STATUS,
  TenantRoomQuotaSettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class TenantRoomQuotaSettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private TenantRoomQuotaSettings response;
  ...
  public TenantRoomQuotaSettingsWrapper() {
  }


  public TenantRoomQuotaSettingsWrapper response(@javax.annotation.Nullable TenantRoomQuotaSettings response) {
  ...
  public TenantRoomQuotaSettings getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable TenantRoomQuotaSettings response) {
    this.response = response;
  }

  public TenantRoomQuotaSettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public TenantRoomQuotaSettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public TenantRoomQuotaSettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public TenantRoomQuotaSettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public TenantRoomQuotaSettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    TenantRoomQuotaSettingsWrapper tenantRoomQuotaSettingsWrapper = (TenantRoomQuotaSettingsWrapper) o;
    return Objects.equals(this.response, tenantRoomQuotaSettingsWrapper.response) &&
        Objects.equals(this.count, tenantRoomQuotaSettingsWrapper.count) &&
        Objects.equals(this.links, tenantRoomQuotaSettingsWrapper.links) &&
        Objects.equals(this.status, tenantRoomQuotaSettingsWrapper.status) &&
        Objects.equals(this.statusCode, tenantRoomQuotaSettingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class TenantRoomQuotaSettingsWrapper {\n");
