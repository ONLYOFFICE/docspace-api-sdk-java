...
import org.openapitools.client.model.RoomSecurityDto;
 ...
 */
@JsonPropertyOrder({
  RoomSecurityWrapper.JSON_PROPERTY_RESPONSE,
  RoomSecurityWrapper.JSON_PROPERTY_COUNT,
  RoomSecurityWrapper.JSON_PROPERTY_LINKS,
  RoomSecurityWrapper.JSON_PROPERTY_STATUS,
  RoomSecurityWrapper.JSON_PROPERTY_STATUS_CODE
})

public class RoomSecurityWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private RoomSecurityDto response;
  ...
  public RoomSecurityDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable RoomSecurityDto response) {
    this.response = response;
  }

  public RoomSecurityWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public RoomSecurityWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public RoomSecurityWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public RoomSecurityWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public RoomSecurityWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    RoomSecurityWrapper roomSecurityWrapper = (RoomSecurityWrapper) o;
    return Objects.equals(this.response, roomSecurityWrapper.response) &&
        Objects.equals(this.count, roomSecurityWrapper.count) &&
        Objects.equals(this.links, roomSecurityWrapper.links) &&
        Objects.equals(this.status, roomSecurityWrapper.status) &&
        Objects.equals(this.statusCode, roomSecurityWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class RoomSecurityWrapper {\n");
