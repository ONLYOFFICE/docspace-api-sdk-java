...
@JsonPropertyOrder({
  ...
  TenantQuotaSettingsWrapper.JSON_PROPERTY_COUNT,
  TenantQuotaSettingsWrapper.JSON_PROPERTY_LINKS,
  TenantQuotaSettingsWrapper.JSON_PROPERTY_STATUS,
  TenantQuotaSettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class TenantQuotaSettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private TenantQuotaSettings response;
  ...
  public TenantQuotaSettingsWrapper() {
  }


  public TenantQuotaSettingsWrapper response(@javax.annotation.Nullable TenantQuotaSettings response) {
  ...
  public TenantQuotaSettings getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable TenantQuotaSettings response) {
    this.response = response;
  }

  public TenantQuotaSettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public TenantQuotaSettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public TenantQuotaSettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public TenantQuotaSettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public TenantQuotaSettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    TenantQuotaSettingsWrapper tenantQuotaSettingsWrapper = (TenantQuotaSettingsWrapper) o;
    return Objects.equals(this.response, tenantQuotaSettingsWrapper.response) &&
        Objects.equals(this.count, tenantQuotaSettingsWrapper.count) &&
        Objects.equals(this.links, tenantQuotaSettingsWrapper.links) &&
        Objects.equals(this.status, tenantQuotaSettingsWrapper.status) &&
        Objects.equals(this.statusCode, tenantQuotaSettingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class TenantQuotaSettingsWrapper {\n");
