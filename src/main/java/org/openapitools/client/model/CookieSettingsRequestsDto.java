 ...
 */
@JsonPropertyOrder({
  CookieSettingsRequestsDto.JSON_PROPERTY_LIFE_TIME,
  CookieSettingsRequestsDto.JSON_PROPERTY_ENABLED
})
...
public class CookieSettingsRequestsDto {
  ...
  public CookieSettingsRequestsDto enabled(@javax.annotation.Nullable Boolean enabled) {
  ...
  public boolean equals(Object o) {
    ...
    CookieSettingsRequestsDto cookieSettingsRequestsDto = (CookieSettingsRequestsDto) o;
    return Objects.equals(this.lifeTime, cookieSettingsRequestsDto.lifeTime) &&
        Objects.equals(this.enabled, cookieSettingsRequestsDto.enabled);
  }
