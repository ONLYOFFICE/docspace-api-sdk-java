...
import org.openapitools.client.model.ExternalShareDto;
...
@JsonPropertyOrder({
  ...
  ExternalShareWrapper.JSON_PROPERTY_COUNT,
  ExternalShareWrapper.JSON_PROPERTY_LINKS,
  ExternalShareWrapper.JSON_PROPERTY_STATUS,
  ExternalShareWrapper.JSON_PROPERTY_STATUS_CODE
})

public class ExternalShareWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private ExternalShareDto response;
  ...
  public ExternalShareDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable ExternalShareDto response) {
    this.response = response;
  }

  public ExternalShareWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public ExternalShareWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public ExternalShareWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public ExternalShareWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public ExternalShareWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    ExternalShareWrapper externalShareWrapper = (ExternalShareWrapper) o;
    return Objects.equals(this.response, externalShareWrapper.response) &&
        Objects.equals(this.count, externalShareWrapper.count) &&
        Objects.equals(this.links, externalShareWrapper.links) &&
        Objects.equals(this.status, externalShareWrapper.status) &&
        Objects.equals(this.statusCode, externalShareWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExternalShareWrapper {\n");
