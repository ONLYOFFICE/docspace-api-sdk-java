 ...
 */
@JsonPropertyOrder({
  FolderIntegerWrapper.JSON_PROPERTY_RESPONSE,
  FolderIntegerWrapper.JSON_PROPERTY_COUNT,
  FolderIntegerWrapper.JSON_PROPERTY_LINKS,
  FolderIntegerWrapper.JSON_PROPERTY_STATUS,
  FolderIntegerWrapper.JSON_PROPERTY_STATUS_CODE
})

public class FolderIntegerWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private FolderDtoInteger response;
  ...
  public FolderIntegerWrapper() {
  }


  public FolderIntegerWrapper response(@javax.annotation.Nullable FolderDtoInteger response) {
  ...
  public FolderDtoInteger getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable FolderDtoInteger response) {
    this.response = response;
  }

  public FolderIntegerWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public FolderIntegerWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public FolderIntegerWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public FolderIntegerWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public FolderIntegerWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    FolderIntegerWrapper folderIntegerWrapper = (FolderIntegerWrapper) o;
    return Objects.equals(this.response, folderIntegerWrapper.response) &&
        Objects.equals(this.count, folderIntegerWrapper.count) &&
        Objects.equals(this.links, folderIntegerWrapper.links) &&
        Objects.equals(this.status, folderIntegerWrapper.status) &&
        Objects.equals(this.statusCode, folderIntegerWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class FolderIntegerWrapper {\n");
