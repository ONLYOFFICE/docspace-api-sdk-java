...
import org.openapitools.client.model.FileEntryDtoInteger;
...
@JsonPropertyOrder({
  ...
  FileEntryIntegerArrayWrapper.JSON_PROPERTY_COUNT,
  FileEntryIntegerArrayWrapper.JSON_PROPERTY_LINKS,
  FileEntryIntegerArrayWrapper.JSON_PROPERTY_STATUS,
  FileEntryIntegerArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class FileEntryIntegerArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<FileEntryDtoInteger> response = new ArrayList<>();
  ...
  public FileEntryIntegerArrayWrapper addResponseItem(FileEntryDtoInteger responseItem) {
  ...
  public List<FileEntryDtoInteger> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<FileEntryDtoInteger> response) {
    this.response = response;
  }

  public FileEntryIntegerArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public FileEntryIntegerArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public FileEntryIntegerArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public FileEntryIntegerArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public FileEntryIntegerArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    FileEntryIntegerArrayWrapper fileEntryIntegerArrayWrapper = (FileEntryIntegerArrayWrapper) o;
    return Objects.equals(this.response, fileEntryIntegerArrayWrapper.response) &&
        Objects.equals(this.count, fileEntryIntegerArrayWrapper.count) &&
        Objects.equals(this.links, fileEntryIntegerArrayWrapper.links) &&
        Objects.equals(this.status, fileEntryIntegerArrayWrapper.status) &&
        Objects.equals(this.statusCode, fileEntryIntegerArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class FileEntryIntegerArrayWrapper {\n");
