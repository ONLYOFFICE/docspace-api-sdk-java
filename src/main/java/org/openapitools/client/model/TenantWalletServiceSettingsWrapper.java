...
import org.openapitools.client.model.TenantWalletServiceSettings;
 ...
 */
@JsonPropertyOrder({
  TenantWalletServiceSettingsWrapper.JSON_PROPERTY_RESPONSE,
  TenantWalletServiceSettingsWrapper.JSON_PROPERTY_COUNT,
  TenantWalletServiceSettingsWrapper.JSON_PROPERTY_LINKS,
  TenantWalletServiceSettingsWrapper.JSON_PROPERTY_STATUS,
  TenantWalletServiceSettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class TenantWalletServiceSettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private TenantWalletServiceSettings response;
  ...
  public TenantWalletServiceSettings getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable TenantWalletServiceSettings response) {
    this.response = response;
  }

  public TenantWalletServiceSettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public TenantWalletServiceSettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public TenantWalletServiceSettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public TenantWalletServiceSettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public TenantWalletServiceSettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    TenantWalletServiceSettingsWrapper tenantWalletServiceSettingsWrapper = (TenantWalletServiceSettingsWrapper) o;
    return Objects.equals(this.response, tenantWalletServiceSettingsWrapper.response) &&
        Objects.equals(this.count, tenantWalletServiceSettingsWrapper.count) &&
        Objects.equals(this.links, tenantWalletServiceSettingsWrapper.links) &&
        Objects.equals(this.status, tenantWalletServiceSettingsWrapper.status) &&
        Objects.equals(this.statusCode, tenantWalletServiceSettingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class TenantWalletServiceSettingsWrapper {\n");
