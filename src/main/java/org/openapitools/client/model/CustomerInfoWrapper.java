...
import org.openapitools.client.model.CustomerInfoDto;
 ...
 */
@JsonPropertyOrder({
  CustomerInfoWrapper.JSON_PROPERTY_RESPONSE,
  CustomerInfoWrapper.JSON_PROPERTY_COUNT,
  CustomerInfoWrapper.JSON_PROPERTY_LINKS,
  CustomerInfoWrapper.JSON_PROPERTY_STATUS,
  CustomerInfoWrapper.JSON_PROPERTY_STATUS_CODE
})

public class CustomerInfoWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private CustomerInfoDto response;
  ...
  public CustomerInfoDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable CustomerInfoDto response) {
    this.response = response;
  }

  public CustomerInfoWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public CustomerInfoWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public CustomerInfoWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public CustomerInfoWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public CustomerInfoWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    CustomerInfoWrapper customerInfoWrapper = (CustomerInfoWrapper) o;
    return Objects.equals(this.response, customerInfoWrapper.response) &&
        Objects.equals(this.count, customerInfoWrapper.count) &&
        Objects.equals(this.links, customerInfoWrapper.links) &&
        Objects.equals(this.status, customerInfoWrapper.status) &&
        Objects.equals(this.statusCode, customerInfoWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class CustomerInfoWrapper {\n");
