 ...
 */
@JsonPropertyOrder({
  ThirdPartyRequestDto.JSON_PROPERTY_URL,
  ThirdPartyRequestDto.JSON_PROPERTY_LOGIN,
  ThirdPartyRequestDto.JSON_PROPERTY_PASSWORD,
  ThirdPartyRequestDto.JSON_PROPERTY_TOKEN,
  ThirdPartyRequestDto.JSON_PROPERTY_CUSTOMER_TITLE,
...
public class ThirdPartyRequestDto {
  ...
  @javax.annotation.Nullable  private String customerTitle;
  ...
  public ThirdPartyRequestDto login(@javax.annotation.Nullable String login) {
  ...
  public ThirdPartyRequestDto password(@javax.annotation.Nullable String password) {
  ...
  public ThirdPartyRequestDto token(@javax.annotation.Nullable String token) {
  ...
  public ThirdPartyRequestDto customerTitle(@javax.annotation.Nullable String customerTitle) {
   ...
   */
  @javax.annotation.Nullable  @JsonProperty(value = JSON_PROPERTY_CUSTOMER_TITLE, required = false)
  ...
  public ThirdPartyRequestDto providerKey(@javax.annotation.Nullable String providerKey) {
  ...
  public ThirdPartyRequestDto providerId(@javax.annotation.Nullable Integer providerId) {
  ...
  public boolean equals(Object o) {
    ...
    ThirdPartyRequestDto thirdPartyRequestDto = (ThirdPartyRequestDto) o;
    return equalsNullable(this.url, thirdPartyRequestDto.url) &&
        equalsNullable(this.login, thirdPartyRequestDto.login) &&
        equalsNullable(this.password, thirdPartyRequestDto.password) &&
        equalsNullable(this.token, thirdPartyRequestDto.token) &&
        Objects.equals(this.customerTitle, thirdPartyRequestDto.customerTitle) &&
        Objects.equals(this.providerKey, thirdPartyRequestDto.providerKey) &&
        equalsNullable(this.providerId, thirdPartyRequestDto.providerId);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(url), hashCodeNullable(login), hashCodeNullable(password), hashCodeNullable(token), customerTitle, providerKey, hashCodeNullable(providerId));
  }
