...
@JsonPropertyOrder({
  ...
  ItemKeyValuePairStringString.JSON_PROPERTY_VALUE
})

public class ItemKeyValuePairStringString {
  ...
  public ItemKeyValuePairStringString value(@javax.annotation.Nullable String value) {
  ...
  public boolean equals(Object o) {
    ...
    ItemKeyValuePairStringString itemKeyValuePairStringString = (ItemKeyValuePairStringString) o;
    return equalsNullable(this.key, itemKeyValuePairStringString.key) &&
        equalsNullable(this.value, itemKeyValuePairStringString.value);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(key), hashCodeNullable(value));
  }
  ...
  public String toString() {
    ...
    sb.append("class ItemKeyValuePairStringString {\n");
