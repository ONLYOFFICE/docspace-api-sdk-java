 ...
 */
@JsonPropertyOrder({
  TenantEntityQuotaSettings.JSON_PROPERTY_ENABLE_QUOTA,
...
public class TenantEntityQuotaSettings {
  ...
  public TenantEntityQuotaSettings enableQuota(@javax.annotation.Nullable Boolean enableQuota) {
  ...
  public TenantEntityQuotaSettings defaultQuota(@javax.annotation.Nullable Long defaultQuota) {
  ...
  public TenantEntityQuotaSettings lastRecalculateDate(@javax.annotation.Nullable OffsetDateTime lastRecalculateDate) {
  ...
  public boolean equals(Object o) {
    ...
    TenantEntityQuotaSettings tenantEntityQuotaSettings = (TenantEntityQuotaSettings) o;
    return Objects.equals(this.enableQuota, tenantEntityQuotaSettings.enableQuota) &&
        Objects.equals(this.defaultQuota, tenantEntityQuotaSettings.defaultQuota) &&
        equalsNullable(this.lastRecalculateDate, tenantEntityQuotaSettings.lastRecalculateDate);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(enableQuota, defaultQuota, hashCodeNullable(lastRecalculateDate));
  }
