...
public class NoContentResultWrapper {
  ...
  private NoContentResult response;
  ...
  public NoContentResultWrapper links(@javax.annotation.Nullable List<ActiveConnectionsWrapperLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public NoContentResultWrapper addLinksItem(ActiveConnectionsWrapperLinksInner linksItem) {
    if (this.links == null) {
