...
import org.openapitools.client.model.LoginSettingsDto;
 ...
 */
@JsonPropertyOrder({
  LoginSettingsWrapper.JSON_PROPERTY_RESPONSE,
  LoginSettingsWrapper.JSON_PROPERTY_COUNT,
  LoginSettingsWrapper.JSON_PROPERTY_LINKS,
  LoginSettingsWrapper.JSON_PROPERTY_STATUS,
  LoginSettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class LoginSettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private LoginSettingsDto response;
  ...
  public LoginSettingsDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable LoginSettingsDto response) {
    this.response = response;
  }

  public LoginSettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public LoginSettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public LoginSettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public LoginSettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public LoginSettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    LoginSettingsWrapper loginSettingsWrapper = (LoginSettingsWrapper) o;
    return Objects.equals(this.response, loginSettingsWrapper.response) &&
        Objects.equals(this.count, loginSettingsWrapper.count) &&
        Objects.equals(this.links, loginSettingsWrapper.links) &&
        Objects.equals(this.status, loginSettingsWrapper.status) &&
        Objects.equals(this.statusCode, loginSettingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoginSettingsWrapper {\n");
