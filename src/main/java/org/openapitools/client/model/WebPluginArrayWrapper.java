...
import org.openapitools.client.model.WebPluginDto;
 ...
 */
@JsonPropertyOrder({
  WebPluginArrayWrapper.JSON_PROPERTY_RESPONSE,
  WebPluginArrayWrapper.JSON_PROPERTY_COUNT,
  WebPluginArrayWrapper.JSON_PROPERTY_LINKS,
  WebPluginArrayWrapper.JSON_PROPERTY_STATUS,
  WebPluginArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class WebPluginArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<WebPluginDto> response = new ArrayList<>();
  ...
  public WebPluginArrayWrapper() {
  }


  public WebPluginArrayWrapper response(@javax.annotation.Nullable List<WebPluginDto> response) {
    
    this.response = response;
    return this;
  }

  public WebPluginArrayWrapper addResponseItem(WebPluginDto responseItem) {
  ...
  public List<WebPluginDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<WebPluginDto> response) {
    this.response = response;
  }

  public WebPluginArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public WebPluginArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public WebPluginArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public WebPluginArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public WebPluginArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    WebPluginArrayWrapper webPluginArrayWrapper = (WebPluginArrayWrapper) o;
    return Objects.equals(this.response, webPluginArrayWrapper.response) &&
        Objects.equals(this.count, webPluginArrayWrapper.count) &&
        Objects.equals(this.links, webPluginArrayWrapper.links) &&
        Objects.equals(this.status, webPluginArrayWrapper.status) &&
        Objects.equals(this.statusCode, webPluginArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebPluginArrayWrapper {\n");
