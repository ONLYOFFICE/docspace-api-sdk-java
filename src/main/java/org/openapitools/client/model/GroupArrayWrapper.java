...
@JsonPropertyOrder({
  ...
  GroupArrayWrapper.JSON_PROPERTY_COUNT,
  GroupArrayWrapper.JSON_PROPERTY_LINKS,
  GroupArrayWrapper.JSON_PROPERTY_STATUS,
  GroupArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class GroupArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<GroupDto> response = new ArrayList<>();
  ...
  public GroupArrayWrapper() {
  }


  public GroupArrayWrapper response(@javax.annotation.Nullable List<GroupDto> response) {
    
    this.response = response;
    return this;
  }

  public GroupArrayWrapper addResponseItem(GroupDto responseItem) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<GroupDto> response) {
    this.response = response;
  }

  public GroupArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public GroupArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public GroupArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public GroupArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public GroupArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    GroupArrayWrapper groupArrayWrapper = (GroupArrayWrapper) o;
    return Objects.equals(this.response, groupArrayWrapper.response) &&
        Objects.equals(this.count, groupArrayWrapper.count) &&
        Objects.equals(this.links, groupArrayWrapper.links) &&
        Objects.equals(this.status, groupArrayWrapper.status) &&
        Objects.equals(this.statusCode, groupArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class GroupArrayWrapper {\n");
