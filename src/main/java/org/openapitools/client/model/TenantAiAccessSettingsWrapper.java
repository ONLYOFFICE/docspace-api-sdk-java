...
import org.openapitools.client.model.TenantAiAccessSettings;
 ...
 */
@JsonPropertyOrder({
  TenantAiAccessSettingsWrapper.JSON_PROPERTY_RESPONSE,
  TenantAiAccessSettingsWrapper.JSON_PROPERTY_COUNT,
  TenantAiAccessSettingsWrapper.JSON_PROPERTY_LINKS,
  TenantAiAccessSettingsWrapper.JSON_PROPERTY_STATUS,
  TenantAiAccessSettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class TenantAiAccessSettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private TenantAiAccessSettings response;
  ...
  public TenantAiAccessSettingsWrapper() {
  }


  public TenantAiAccessSettingsWrapper response(@javax.annotation.Nullable TenantAiAccessSettings response) {
  ...
  public TenantAiAccessSettings getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable TenantAiAccessSettings response) {
    this.response = response;
  }

  public TenantAiAccessSettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public TenantAiAccessSettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public TenantAiAccessSettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public TenantAiAccessSettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public TenantAiAccessSettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    TenantAiAccessSettingsWrapper tenantAiAccessSettingsWrapper = (TenantAiAccessSettingsWrapper) o;
    return Objects.equals(this.response, tenantAiAccessSettingsWrapper.response) &&
        Objects.equals(this.count, tenantAiAccessSettingsWrapper.count) &&
        Objects.equals(this.links, tenantAiAccessSettingsWrapper.links) &&
        Objects.equals(this.status, tenantAiAccessSettingsWrapper.status) &&
        Objects.equals(this.statusCode, tenantAiAccessSettingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class TenantAiAccessSettingsWrapper {\n");
