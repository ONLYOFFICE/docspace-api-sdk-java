...
import org.openapitools.client.model.PaymentSettingsDto;
...
@JsonPropertyOrder({
  ...
  PaymentSettingsWrapper.JSON_PROPERTY_COUNT,
  PaymentSettingsWrapper.JSON_PROPERTY_LINKS,
  PaymentSettingsWrapper.JSON_PROPERTY_STATUS,
  PaymentSettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class PaymentSettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private PaymentSettingsDto response;
  ...
  public PaymentSettingsDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable PaymentSettingsDto response) {
    this.response = response;
  }

  public PaymentSettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public PaymentSettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public PaymentSettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public PaymentSettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public PaymentSettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentSettingsWrapper paymentSettingsWrapper = (PaymentSettingsWrapper) o;
    return Objects.equals(this.response, paymentSettingsWrapper.response) &&
        Objects.equals(this.count, paymentSettingsWrapper.count) &&
        Objects.equals(this.links, paymentSettingsWrapper.links) &&
        Objects.equals(this.status, paymentSettingsWrapper.status) &&
        Objects.equals(this.statusCode, paymentSettingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentSettingsWrapper {\n");
