...
public class EmployeeFullDto {
  ...
  @javax.annotation.Nullable  private Boolean isLDAP;
   ...
   * @return isLDAP
   */
  @javax.annotation.Nullable  @JsonProperty(value = JSON_PROPERTY_IS_L_D_A_P, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_IS_L_D_A_P, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
