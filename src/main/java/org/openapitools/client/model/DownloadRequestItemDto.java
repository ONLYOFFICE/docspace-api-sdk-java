...
@JsonPropertyOrder({
  ...
  DownloadRequestItemDto.JSON_PROPERTY_VALUE,
  DownloadRequestItemDto.JSON_PROPERTY_PASSWORD
})
...
public class DownloadRequestItemDto {
  ...
  public DownloadRequestItemDto value(@javax.annotation.Nullable String value) {
  ...
  public DownloadRequestItemDto password(@javax.annotation.Nullable String password) {
  ...
  public boolean equals(Object o) {
    ...
    DownloadRequestItemDto downloadRequestItemDto = (DownloadRequestItemDto) o;
    return Objects.equals(this.key, downloadRequestItemDto.key) &&
        Objects.equals(this.value, downloadRequestItemDto.value) &&
        equalsNullable(this.password, downloadRequestItemDto.password);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(key, value, hashCodeNullable(password));
  }
