 ...
 */
@JsonPropertyOrder({
  WhiteLabelItemPathDto.JSON_PROPERTY_LIGHT,
  WhiteLabelItemPathDto.JSON_PROPERTY_DARK
})
...
public class WhiteLabelItemPathDto {
  ...
  public WhiteLabelItemPathDto dark(@javax.annotation.Nullable String dark) {
  ...
  public boolean equals(Object o) {
    ...
    WhiteLabelItemPathDto whiteLabelItemPathDto = (WhiteLabelItemPathDto) o;
    return equalsNullable(this.light, whiteLabelItemPathDto.light) &&
        equalsNullable(this.dark, whiteLabelItemPathDto.dark);
  }
