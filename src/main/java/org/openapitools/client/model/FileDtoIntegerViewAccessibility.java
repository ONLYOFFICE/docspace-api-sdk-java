 ...
 */
@JsonPropertyOrder({
  FileDtoIntegerViewAccessibility.JSON_PROPERTY_IMAGE_VIEW,
  FileDtoIntegerViewAccessibility.JSON_PROPERTY_MEDIA_VIEW,
  FileDtoIntegerViewAccessibility.JSON_PROPERTY_WEB_VIEW,
  FileDtoIntegerViewAccessibility.JSON_PROPERTY_WEB_EDIT,
  FileDtoIntegerViewAccessibility.JSON_PROPERTY_WEB_REVIEW,
  FileDtoIntegerViewAccessibility.JSON_PROPERTY_WEB_CUSTOM_FILTER_EDITING,
  FileDtoIntegerViewAccessibility.JSON_PROPERTY_WEB_RESTRICTED_EDITING,
  FileDtoIntegerViewAccessibility.JSON_PROPERTY_WEB_COMMENT,
  FileDtoIntegerViewAccessibility.JSON_PROPERTY_CAN_CONVERT,
  FileDtoIntegerViewAccessibility.JSON_PROPERTY_MUST_CONVERT
})
@JsonTypeName("FileDtoInteger_viewAccessibility")

public class FileDtoIntegerViewAccessibility {
  ...
  public FileDtoIntegerViewAccessibility() {
  }


  public FileDtoIntegerViewAccessibility imageView(@javax.annotation.Nullable Boolean imageView) {
  ...
  public FileDtoIntegerViewAccessibility mediaView(@javax.annotation.Nullable Boolean mediaView) {
  ...
  public FileDtoIntegerViewAccessibility webView(@javax.annotation.Nullable Boolean webView) {
  ...
  public FileDtoIntegerViewAccessibility webEdit(@javax.annotation.Nullable Boolean webEdit) {
  ...
  public FileDtoIntegerViewAccessibility webReview(@javax.annotation.Nullable Boolean webReview) {
  ...
  public FileDtoIntegerViewAccessibility webCustomFilterEditing(@javax.annotation.Nullable Boolean webCustomFilterEditing) {
  ...
  public FileDtoIntegerViewAccessibility webRestrictedEditing(@javax.annotation.Nullable Boolean webRestrictedEditing) {
  ...
  public FileDtoIntegerViewAccessibility webComment(@javax.annotation.Nullable Boolean webComment) {
  ...
  public FileDtoIntegerViewAccessibility canConvert(@javax.annotation.Nullable Boolean canConvert) {
  ...
  public FileDtoIntegerViewAccessibility mustConvert(@javax.annotation.Nullable Boolean mustConvert) {
  ...
  public boolean equals(Object o) {
    ...
    FileDtoIntegerViewAccessibility fileDtoIntegerViewAccessibility = (FileDtoIntegerViewAccessibility) o;
    return Objects.equals(this.imageView, fileDtoIntegerViewAccessibility.imageView) &&
        Objects.equals(this.mediaView, fileDtoIntegerViewAccessibility.mediaView) &&
        Objects.equals(this.webView, fileDtoIntegerViewAccessibility.webView) &&
        Objects.equals(this.webEdit, fileDtoIntegerViewAccessibility.webEdit) &&
        Objects.equals(this.webReview, fileDtoIntegerViewAccessibility.webReview) &&
        Objects.equals(this.webCustomFilterEditing, fileDtoIntegerViewAccessibility.webCustomFilterEditing) &&
        Objects.equals(this.webRestrictedEditing, fileDtoIntegerViewAccessibility.webRestrictedEditing) &&
        Objects.equals(this.webComment, fileDtoIntegerViewAccessibility.webComment) &&
        Objects.equals(this.canConvert, fileDtoIntegerViewAccessibility.canConvert) &&
        Objects.equals(this.mustConvert, fileDtoIntegerViewAccessibility.mustConvert);
  }
