 ...
 */
@JsonPropertyOrder({
  AiChatModelPricing.JSON_PROPERTY_ID,
  AiChatModelPricing.JSON_PROPERTY_ALIAS,
  AiChatModelPricing.JSON_PROPERTY_OWNED_BY,
  AiChatModelPricing.JSON_PROPERTY_PROVIDER,
  AiChatModelPricing.JSON_PROPERTY_PRICE
})

public class AiChatModelPricing {
  ...
  @javax.annotation.Nonnull  private AiChatPrice price;

  public AiChatModelPricing() {
  }


  public AiChatModelPricing id(@javax.annotation.Nullable String id) {
  ...
  public AiChatModelPricing alias(@javax.annotation.Nullable String alias) {
  ...
  public AiChatModelPricing ownedBy(@javax.annotation.Nullable String ownedBy) {
  ...
  public AiChatModelPricing provider(@javax.annotation.Nullable String provider) {
  ...
  public AiChatModelPricing price(@javax.annotation.Nonnull AiChatPrice price) {
  ...
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setPrice(@javax.annotation.Nonnull AiChatPrice price) {
    this.price = price;
  }
  ...
  public boolean equals(Object o) {
    ...
    AiChatModelPricing aiChatModelPricing = (AiChatModelPricing) o;
    return Objects.equals(this.id, aiChatModelPricing.id) &&
        equalsNullable(this.alias, aiChatModelPricing.alias) &&
        equalsNullable(this.ownedBy, aiChatModelPricing.ownedBy) &&
        equalsNullable(this.provider, aiChatModelPricing.provider) &&
        Objects.equals(this.price, aiChatModelPricing.price);
  }
  ...
  public String toString() {
    ...
    sb.append("class AiChatModelPricing {\n");
