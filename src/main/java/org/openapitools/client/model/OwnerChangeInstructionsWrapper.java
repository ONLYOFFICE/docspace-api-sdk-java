...
import org.openapitools.client.model.OwnerChangeInstructionsDto;
...
@JsonPropertyOrder({
  ...
  OwnerChangeInstructionsWrapper.JSON_PROPERTY_COUNT,
  OwnerChangeInstructionsWrapper.JSON_PROPERTY_LINKS,
  OwnerChangeInstructionsWrapper.JSON_PROPERTY_STATUS,
  OwnerChangeInstructionsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class OwnerChangeInstructionsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private OwnerChangeInstructionsDto response;
  ...
  public OwnerChangeInstructionsDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable OwnerChangeInstructionsDto response) {
    this.response = response;
  }

  public OwnerChangeInstructionsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public OwnerChangeInstructionsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public OwnerChangeInstructionsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public OwnerChangeInstructionsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public OwnerChangeInstructionsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    OwnerChangeInstructionsWrapper ownerChangeInstructionsWrapper = (OwnerChangeInstructionsWrapper) o;
    return Objects.equals(this.response, ownerChangeInstructionsWrapper.response) &&
        Objects.equals(this.count, ownerChangeInstructionsWrapper.count) &&
        Objects.equals(this.links, ownerChangeInstructionsWrapper.links) &&
        Objects.equals(this.status, ownerChangeInstructionsWrapper.status) &&
        Objects.equals(this.statusCode, ownerChangeInstructionsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class OwnerChangeInstructionsWrapper {\n");
