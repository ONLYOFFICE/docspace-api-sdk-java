...
import org.openapitools.client.model.TenantUserInvitationSettingsDto;
...
@JsonPropertyOrder({
  ...
  TenantUserInvitationSettingsWrapper.JSON_PROPERTY_COUNT,
  TenantUserInvitationSettingsWrapper.JSON_PROPERTY_LINKS,
  TenantUserInvitationSettingsWrapper.JSON_PROPERTY_STATUS,
  TenantUserInvitationSettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class TenantUserInvitationSettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private TenantUserInvitationSettingsDto response;
  ...
  public TenantUserInvitationSettingsDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable TenantUserInvitationSettingsDto response) {
    this.response = response;
  }

  public TenantUserInvitationSettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public TenantUserInvitationSettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public TenantUserInvitationSettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public TenantUserInvitationSettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public TenantUserInvitationSettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    TenantUserInvitationSettingsWrapper tenantUserInvitationSettingsWrapper = (TenantUserInvitationSettingsWrapper) o;
    return Objects.equals(this.response, tenantUserInvitationSettingsWrapper.response) &&
        Objects.equals(this.count, tenantUserInvitationSettingsWrapper.count) &&
        Objects.equals(this.links, tenantUserInvitationSettingsWrapper.links) &&
        Objects.equals(this.status, tenantUserInvitationSettingsWrapper.status) &&
        Objects.equals(this.statusCode, tenantUserInvitationSettingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class TenantUserInvitationSettingsWrapper {\n");
