 ...
 */
@JsonPropertyOrder({
  McpServerWrapper.JSON_PROPERTY_RESPONSE,
  McpServerWrapper.JSON_PROPERTY_COUNT,
  McpServerWrapper.JSON_PROPERTY_LINKS,
  McpServerWrapper.JSON_PROPERTY_STATUS,
  McpServerWrapper.JSON_PROPERTY_STATUS_CODE
})

public class McpServerWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private McpServerDto response;
  ...
  public McpServerWrapper response(@javax.annotation.Nullable McpServerDto response) {
  ...
  public McpServerDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable McpServerDto response) {
    this.response = response;
  }

  public McpServerWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public McpServerWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public McpServerWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public McpServerWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public McpServerWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    McpServerWrapper mcpServerWrapper = (McpServerWrapper) o;
    return Objects.equals(this.response, mcpServerWrapper.response) &&
        Objects.equals(this.count, mcpServerWrapper.count) &&
        Objects.equals(this.links, mcpServerWrapper.links) &&
        Objects.equals(this.status, mcpServerWrapper.status) &&
        Objects.equals(this.statusCode, mcpServerWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class McpServerWrapper {\n");
