 ...
 */
@JsonPropertyOrder({
  RoomTemplateStatusDto.JSON_PROPERTY_TEMPLATE_ID,
  RoomTemplateStatusDto.JSON_PROPERTY_PROGRESS,
  RoomTemplateStatusDto.JSON_PROPERTY_ERROR,
  RoomTemplateStatusDto.JSON_PROPERTY_IS_COMPLETED
})
...
public class RoomTemplateStatusDto {
  ...
  public RoomTemplateStatusDto progress(@javax.annotation.Nonnull Double progress) {
  ...
  public RoomTemplateStatusDto error(@javax.annotation.Nullable String error) {
  ...
  public RoomTemplateStatusDto isCompleted(@javax.annotation.Nonnull Boolean isCompleted) {
  ...
  public boolean equals(Object o) {
    ...
    RoomTemplateStatusDto roomTemplateStatusDto = (RoomTemplateStatusDto) o;
    return Objects.equals(this.templateId, roomTemplateStatusDto.templateId) &&
        Objects.equals(this.progress, roomTemplateStatusDto.progress) &&
        equalsNullable(this.error, roomTemplateStatusDto.error) &&
        Objects.equals(this.isCompleted, roomTemplateStatusDto.isCompleted);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(templateId, progress, hashCodeNullable(error), isCompleted);
  }
