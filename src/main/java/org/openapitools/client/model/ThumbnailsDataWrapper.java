...
import org.openapitools.client.model.ThumbnailsDataDto;
 ...
 */
@JsonPropertyOrder({
  ThumbnailsDataWrapper.JSON_PROPERTY_RESPONSE,
  ThumbnailsDataWrapper.JSON_PROPERTY_COUNT,
  ThumbnailsDataWrapper.JSON_PROPERTY_LINKS,
  ThumbnailsDataWrapper.JSON_PROPERTY_STATUS,
  ThumbnailsDataWrapper.JSON_PROPERTY_STATUS_CODE
})

public class ThumbnailsDataWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private ThumbnailsDataDto response;
  ...
  public ThumbnailsDataDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable ThumbnailsDataDto response) {
    this.response = response;
  }

  public ThumbnailsDataWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public ThumbnailsDataWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public ThumbnailsDataWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public ThumbnailsDataWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public ThumbnailsDataWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    ThumbnailsDataWrapper thumbnailsDataWrapper = (ThumbnailsDataWrapper) o;
    return Objects.equals(this.response, thumbnailsDataWrapper.response) &&
        Objects.equals(this.count, thumbnailsDataWrapper.count) &&
        Objects.equals(this.links, thumbnailsDataWrapper.links) &&
        Objects.equals(this.status, thumbnailsDataWrapper.status) &&
        Objects.equals(this.statusCode, thumbnailsDataWrapper.statusCode);
  }
