...
import org.openapitools.client.model.TfaAppCodeDto;
 ...
 */
@JsonPropertyOrder({
  TfaAppCodeArrayWrapper.JSON_PROPERTY_RESPONSE,
  TfaAppCodeArrayWrapper.JSON_PROPERTY_COUNT,
  TfaAppCodeArrayWrapper.JSON_PROPERTY_LINKS,
  TfaAppCodeArrayWrapper.JSON_PROPERTY_STATUS,
  TfaAppCodeArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class TfaAppCodeArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<TfaAppCodeDto> response = new ArrayList<>();
  ...
  public TfaAppCodeArrayWrapper() {
  }


  public TfaAppCodeArrayWrapper response(@javax.annotation.Nullable List<TfaAppCodeDto> response) {
    
    this.response = response;
    return this;
  }

  public TfaAppCodeArrayWrapper addResponseItem(TfaAppCodeDto responseItem) {
  ...
  public List<TfaAppCodeDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<TfaAppCodeDto> response) {
    this.response = response;
  }

  public TfaAppCodeArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public TfaAppCodeArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public TfaAppCodeArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public TfaAppCodeArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public TfaAppCodeArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    TfaAppCodeArrayWrapper tfaAppCodeArrayWrapper = (TfaAppCodeArrayWrapper) o;
    return Objects.equals(this.response, tfaAppCodeArrayWrapper.response) &&
        Objects.equals(this.count, tfaAppCodeArrayWrapper.count) &&
        Objects.equals(this.links, tfaAppCodeArrayWrapper.links) &&
        Objects.equals(this.status, tfaAppCodeArrayWrapper.status) &&
        Objects.equals(this.statusCode, tfaAppCodeArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class TfaAppCodeArrayWrapper {\n");
