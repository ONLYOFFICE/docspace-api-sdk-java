...
import org.openapitools.client.model.ConversationResultDto;
...
@JsonPropertyOrder({
  ...
  ConversationResultArrayWrapper.JSON_PROPERTY_COUNT,
  ConversationResultArrayWrapper.JSON_PROPERTY_LINKS,
  ConversationResultArrayWrapper.JSON_PROPERTY_STATUS,
  ConversationResultArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class ConversationResultArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<ConversationResultDto> response = new ArrayList<>();
  ...
  public ConversationResultArrayWrapper addResponseItem(ConversationResultDto responseItem) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<ConversationResultDto> response) {
    this.response = response;
  }

  public ConversationResultArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public ConversationResultArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public ConversationResultArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public ConversationResultArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public ConversationResultArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    ConversationResultArrayWrapper conversationResultArrayWrapper = (ConversationResultArrayWrapper) o;
    return Objects.equals(this.response, conversationResultArrayWrapper.response) &&
        Objects.equals(this.count, conversationResultArrayWrapper.count) &&
        Objects.equals(this.links, conversationResultArrayWrapper.links) &&
        Objects.equals(this.status, conversationResultArrayWrapper.status) &&
        Objects.equals(this.statusCode, conversationResultArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConversationResultArrayWrapper {\n");
