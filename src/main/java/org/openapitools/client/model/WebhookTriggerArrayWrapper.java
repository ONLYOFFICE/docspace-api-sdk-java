...
import org.openapitools.client.model.WebhookTriggerDto;
...
@JsonPropertyOrder({
  ...
  WebhookTriggerArrayWrapper.JSON_PROPERTY_COUNT,
  WebhookTriggerArrayWrapper.JSON_PROPERTY_LINKS,
  WebhookTriggerArrayWrapper.JSON_PROPERTY_STATUS,
  WebhookTriggerArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class WebhookTriggerArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<WebhookTriggerDto> response = new ArrayList<>();
  ...
  public WebhookTriggerArrayWrapper() {
  }


  public WebhookTriggerArrayWrapper response(@javax.annotation.Nullable List<WebhookTriggerDto> response) {
    
    this.response = response;
    return this;
  }

  public WebhookTriggerArrayWrapper addResponseItem(WebhookTriggerDto responseItem) {
  ...
  public List<WebhookTriggerDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<WebhookTriggerDto> response) {
    this.response = response;
  }

  public WebhookTriggerArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public WebhookTriggerArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public WebhookTriggerArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public WebhookTriggerArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public WebhookTriggerArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    WebhookTriggerArrayWrapper webhookTriggerArrayWrapper = (WebhookTriggerArrayWrapper) o;
    return Objects.equals(this.response, webhookTriggerArrayWrapper.response) &&
        Objects.equals(this.count, webhookTriggerArrayWrapper.count) &&
        Objects.equals(this.links, webhookTriggerArrayWrapper.links) &&
        Objects.equals(this.status, webhookTriggerArrayWrapper.status) &&
        Objects.equals(this.statusCode, webhookTriggerArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class WebhookTriggerArrayWrapper {\n");
