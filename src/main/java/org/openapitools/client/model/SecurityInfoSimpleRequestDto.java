...
@JsonPropertyOrder({
  ...
  SecurityInfoSimpleRequestDto.JSON_PROPERTY_NOTIFY,
  SecurityInfoSimpleRequestDto.JSON_PROPERTY_SHARING_MESSAGE
})
...
public class SecurityInfoSimpleRequestDto {
  ...
  public SecurityInfoSimpleRequestDto addShareItem(FileShareParams shareItem) {
  ...
  public SecurityInfoSimpleRequestDto notify(@javax.annotation.Nullable Boolean notify) {
  ...
  public SecurityInfoSimpleRequestDto sharingMessage(@javax.annotation.Nullable String sharingMessage) {
  ...
  public boolean equals(Object o) {
    ...
    SecurityInfoSimpleRequestDto securityInfoSimpleRequestDto = (SecurityInfoSimpleRequestDto) o;
    return equalsNullable(this.share, securityInfoSimpleRequestDto.share) &&
        Objects.equals(this.notify, securityInfoSimpleRequestDto.notify) &&
        equalsNullable(this.sharingMessage, securityInfoSimpleRequestDto.sharingMessage);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(share), notify, hashCodeNullable(sharingMessage));
  }
