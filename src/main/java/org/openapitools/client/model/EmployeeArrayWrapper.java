...
@JsonPropertyOrder({
  ...
  EmployeeArrayWrapper.JSON_PROPERTY_COUNT,
  EmployeeArrayWrapper.JSON_PROPERTY_LINKS,
  EmployeeArrayWrapper.JSON_PROPERTY_STATUS,
  EmployeeArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class EmployeeArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<EmployeeDto> response = new ArrayList<>();
  ...
  public EmployeeArrayWrapper addResponseItem(EmployeeDto responseItem) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<EmployeeDto> response) {
    this.response = response;
  }

  public EmployeeArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public EmployeeArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public EmployeeArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public EmployeeArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public EmployeeArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeeArrayWrapper employeeArrayWrapper = (EmployeeArrayWrapper) o;
    return Objects.equals(this.response, employeeArrayWrapper.response) &&
        Objects.equals(this.count, employeeArrayWrapper.count) &&
        Objects.equals(this.links, employeeArrayWrapper.links) &&
        Objects.equals(this.status, employeeArrayWrapper.status) &&
        Objects.equals(this.statusCode, employeeArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeArrayWrapper {\n");
