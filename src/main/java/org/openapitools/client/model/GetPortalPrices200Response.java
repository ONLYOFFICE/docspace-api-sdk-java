...
@JsonPropertyOrder({
  ...
  GetPortalPrices200Response.JSON_PROPERTY_COUNT,
  GetPortalPrices200Response.JSON_PROPERTY_LINKS,
  GetPortalPrices200Response.JSON_PROPERTY_STATUS,
  GetPortalPrices200Response.JSON_PROPERTY_STATUS_CODE
})
@JsonTypeName("getPortalPrices_200_response")

public class GetPortalPrices200Response {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private Map<String, Double> response = new HashMap<>();
  ...
  public GetPortalPrices200Response() {
  }


  public GetPortalPrices200Response response(@javax.annotation.Nullable Map<String, Double> response) {
    
    this.response = response;
    return this;
  }

  public GetPortalPrices200Response putResponseItem(String key, Double responseItem) {
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable Map<String, Double> response) {
    this.response = response;
  }

  public GetPortalPrices200Response count(@javax.annotation.Nullable Integer count) {
  ...
  public GetPortalPrices200Response links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public GetPortalPrices200Response addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public GetPortalPrices200Response status(@javax.annotation.Nullable Integer status) {
  ...
  public GetPortalPrices200Response statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    GetPortalPrices200Response getPortalPrices200Response = (GetPortalPrices200Response) o;
    return Objects.equals(this.response, getPortalPrices200Response.response) &&
        Objects.equals(this.count, getPortalPrices200Response.count) &&
        Objects.equals(this.links, getPortalPrices200Response.links) &&
        Objects.equals(this.status, getPortalPrices200Response.status) &&
        Objects.equals(this.statusCode, getPortalPrices200Response.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetPortalPrices200Response {\n");
