...
import org.openapitools.client.model.PaymentCalculation;
 ...
 */
@JsonPropertyOrder({
  PaymentCalculationWrapper.JSON_PROPERTY_RESPONSE,
  PaymentCalculationWrapper.JSON_PROPERTY_COUNT,
  PaymentCalculationWrapper.JSON_PROPERTY_LINKS,
  PaymentCalculationWrapper.JSON_PROPERTY_STATUS,
  PaymentCalculationWrapper.JSON_PROPERTY_STATUS_CODE
})

public class PaymentCalculationWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private PaymentCalculation response;
  ...
  public PaymentCalculation getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable PaymentCalculation response) {
    this.response = response;
  }

  public PaymentCalculationWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public PaymentCalculationWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public PaymentCalculationWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public PaymentCalculationWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public PaymentCalculationWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentCalculationWrapper paymentCalculationWrapper = (PaymentCalculationWrapper) o;
    return Objects.equals(this.response, paymentCalculationWrapper.response) &&
        Objects.equals(this.count, paymentCalculationWrapper.count) &&
        Objects.equals(this.links, paymentCalculationWrapper.links) &&
        Objects.equals(this.status, paymentCalculationWrapper.status) &&
        Objects.equals(this.statusCode, paymentCalculationWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentCalculationWrapper {\n");
