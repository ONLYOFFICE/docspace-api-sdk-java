 ...
 */
@JsonPropertyOrder({
  ExportMessageRequestBodyInteger.JSON_PROPERTY_FOLDER_ID,
  ExportMessageRequestBodyInteger.JSON_PROPERTY_TITLE
})

public class ExportMessageRequestBodyInteger {
  ...
  public ExportMessageRequestBodyInteger() {
  }


  public ExportMessageRequestBodyInteger folderId(@javax.annotation.Nonnull Integer folderId) {
  ...
  public ExportMessageRequestBodyInteger title(@javax.annotation.Nullable String title) {
  ...
  public boolean equals(Object o) {
    ...
    ExportMessageRequestBodyInteger exportMessageRequestBodyInteger = (ExportMessageRequestBodyInteger) o;
    return Objects.equals(this.folderId, exportMessageRequestBodyInteger.folderId) &&
        Objects.equals(this.title, exportMessageRequestBodyInteger.title);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExportMessageRequestBodyInteger {\n");
