 ...
 */
@JsonPropertyOrder({
  FolderStringWrapper.JSON_PROPERTY_RESPONSE,
  FolderStringWrapper.JSON_PROPERTY_COUNT,
  FolderStringWrapper.JSON_PROPERTY_LINKS,
  FolderStringWrapper.JSON_PROPERTY_STATUS,
  FolderStringWrapper.JSON_PROPERTY_STATUS_CODE
})

public class FolderStringWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private FolderDtoString response;
  ...
  public FolderDtoString getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable FolderDtoString response) {
    this.response = response;
  }

  public FolderStringWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public FolderStringWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public FolderStringWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public FolderStringWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public FolderStringWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    FolderStringWrapper folderStringWrapper = (FolderStringWrapper) o;
    return Objects.equals(this.response, folderStringWrapper.response) &&
        Objects.equals(this.count, folderStringWrapper.count) &&
        Objects.equals(this.links, folderStringWrapper.links) &&
        Objects.equals(this.status, folderStringWrapper.status) &&
        Objects.equals(this.statusCode, folderStringWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class FolderStringWrapper {\n");
