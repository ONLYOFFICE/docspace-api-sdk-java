...
public class UpdateProviderBody {
  ...
  public UpdateProviderBody title(@javax.annotation.Nullable String title) {
  ...
  public UpdateProviderBody url(@javax.annotation.Nullable String url) {
  ...
  public UpdateProviderBody key(@javax.annotation.Nullable String key) {
