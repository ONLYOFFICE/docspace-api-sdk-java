...
@JsonPropertyOrder({
  ...
  AuthServiceRequestsArrayWrapper.JSON_PROPERTY_COUNT,
  AuthServiceRequestsArrayWrapper.JSON_PROPERTY_LINKS,
  AuthServiceRequestsArrayWrapper.JSON_PROPERTY_STATUS,
  AuthServiceRequestsArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class AuthServiceRequestsArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<AuthServiceRequestsDto> response = new ArrayList<>();
  ...
  public AuthServiceRequestsArrayWrapper addResponseItem(AuthServiceRequestsDto responseItem) {
  ...
  public List<AuthServiceRequestsDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<AuthServiceRequestsDto> response) {
    this.response = response;
  }

  public AuthServiceRequestsArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public AuthServiceRequestsArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public AuthServiceRequestsArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public AuthServiceRequestsArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public AuthServiceRequestsArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    AuthServiceRequestsArrayWrapper authServiceRequestsArrayWrapper = (AuthServiceRequestsArrayWrapper) o;
    return Objects.equals(this.response, authServiceRequestsArrayWrapper.response) &&
        Objects.equals(this.count, authServiceRequestsArrayWrapper.count) &&
        Objects.equals(this.links, authServiceRequestsArrayWrapper.links) &&
        Objects.equals(this.status, authServiceRequestsArrayWrapper.status) &&
        Objects.equals(this.statusCode, authServiceRequestsArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class AuthServiceRequestsArrayWrapper {\n");
