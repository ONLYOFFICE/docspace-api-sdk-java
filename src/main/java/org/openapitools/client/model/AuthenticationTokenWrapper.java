...
import org.openapitools.client.model.AuthenticationTokenDto;
...
@JsonPropertyOrder({
  ...
  AuthenticationTokenWrapper.JSON_PROPERTY_COUNT,
  AuthenticationTokenWrapper.JSON_PROPERTY_LINKS,
  AuthenticationTokenWrapper.JSON_PROPERTY_STATUS,
  AuthenticationTokenWrapper.JSON_PROPERTY_STATUS_CODE
})

public class AuthenticationTokenWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private AuthenticationTokenDto response;
  ...
  public AuthenticationTokenDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable AuthenticationTokenDto response) {
    this.response = response;
  }

  public AuthenticationTokenWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public AuthenticationTokenWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public AuthenticationTokenWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public AuthenticationTokenWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public AuthenticationTokenWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    AuthenticationTokenWrapper authenticationTokenWrapper = (AuthenticationTokenWrapper) o;
    return Objects.equals(this.response, authenticationTokenWrapper.response) &&
        Objects.equals(this.count, authenticationTokenWrapper.count) &&
        Objects.equals(this.links, authenticationTokenWrapper.links) &&
        Objects.equals(this.status, authenticationTokenWrapper.status) &&
        Objects.equals(this.statusCode, authenticationTokenWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class AuthenticationTokenWrapper {\n");
