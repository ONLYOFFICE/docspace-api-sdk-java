...
import org.openapitools.client.model.McpServerDto;
 ...
 */
@JsonPropertyOrder({
  McpServerArrayWrapper.JSON_PROPERTY_RESPONSE,
  McpServerArrayWrapper.JSON_PROPERTY_COUNT,
  McpServerArrayWrapper.JSON_PROPERTY_LINKS,
  McpServerArrayWrapper.JSON_PROPERTY_STATUS,
  McpServerArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class McpServerArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<McpServerDto> response = new ArrayList<>();
  ...
  public McpServerArrayWrapper() {
  }


  public McpServerArrayWrapper response(@javax.annotation.Nullable List<McpServerDto> response) {
    
    this.response = response;
    return this;
  }

  public McpServerArrayWrapper addResponseItem(McpServerDto responseItem) {
  ...
  public List<McpServerDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<McpServerDto> response) {
    this.response = response;
  }

  public McpServerArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public McpServerArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public McpServerArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public McpServerArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public McpServerArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    McpServerArrayWrapper mcpServerArrayWrapper = (McpServerArrayWrapper) o;
    return Objects.equals(this.response, mcpServerArrayWrapper.response) &&
        Objects.equals(this.count, mcpServerArrayWrapper.count) &&
        Objects.equals(this.links, mcpServerArrayWrapper.links) &&
        Objects.equals(this.status, mcpServerArrayWrapper.status) &&
        Objects.equals(this.statusCode, mcpServerArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class McpServerArrayWrapper {\n");
