 ...
 */
@JsonPropertyOrder({
  AdminMessageBaseSettingsRequestsDto.JSON_PROPERTY_EMAIL,
  AdminMessageBaseSettingsRequestsDto.JSON_PROPERTY_CULTURE
})
...
public class AdminMessageBaseSettingsRequestsDto {
  ...
  public AdminMessageBaseSettingsRequestsDto culture(@javax.annotation.Nullable String culture) {
  ...
  public boolean equals(Object o) {
    ...
    AdminMessageBaseSettingsRequestsDto adminMessageBaseSettingsRequestsDto = (AdminMessageBaseSettingsRequestsDto) o;
    return Objects.equals(this.email, adminMessageBaseSettingsRequestsDto.email) &&
        equalsNullable(this.culture, adminMessageBaseSettingsRequestsDto.culture);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(email, hashCodeNullable(culture));
  }
