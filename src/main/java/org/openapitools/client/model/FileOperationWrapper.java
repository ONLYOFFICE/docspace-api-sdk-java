 ...
 */
@JsonPropertyOrder({
  FileOperationWrapper.JSON_PROPERTY_RESPONSE,
  FileOperationWrapper.JSON_PROPERTY_COUNT,
  FileOperationWrapper.JSON_PROPERTY_LINKS,
  FileOperationWrapper.JSON_PROPERTY_STATUS,
  FileOperationWrapper.JSON_PROPERTY_STATUS_CODE
})

public class FileOperationWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private FileOperationDto response;
  ...
  public FileOperationWrapper response(@javax.annotation.Nullable FileOperationDto response) {
  ...
  public FileOperationDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable FileOperationDto response) {
    this.response = response;
  }

  public FileOperationWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public FileOperationWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public FileOperationWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public FileOperationWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public FileOperationWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    FileOperationWrapper fileOperationWrapper = (FileOperationWrapper) o;
    return Objects.equals(this.response, fileOperationWrapper.response) &&
        Objects.equals(this.count, fileOperationWrapper.count) &&
        Objects.equals(this.links, fileOperationWrapper.links) &&
        Objects.equals(this.status, fileOperationWrapper.status) &&
        Objects.equals(this.statusCode, fileOperationWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class FileOperationWrapper {\n");
