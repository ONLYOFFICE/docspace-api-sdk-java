 ...
 */
@JsonPropertyOrder({
  FileIntegerWrapper.JSON_PROPERTY_RESPONSE,
  FileIntegerWrapper.JSON_PROPERTY_COUNT,
  FileIntegerWrapper.JSON_PROPERTY_LINKS,
  FileIntegerWrapper.JSON_PROPERTY_STATUS,
  FileIntegerWrapper.JSON_PROPERTY_STATUS_CODE
})

public class FileIntegerWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private FileDtoInteger response;
  ...
  public FileDtoInteger getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable FileDtoInteger response) {
    this.response = response;
  }

  public FileIntegerWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public FileIntegerWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public FileIntegerWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public FileIntegerWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public FileIntegerWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    FileIntegerWrapper fileIntegerWrapper = (FileIntegerWrapper) o;
    return Objects.equals(this.response, fileIntegerWrapper.response) &&
        Objects.equals(this.count, fileIntegerWrapper.count) &&
        Objects.equals(this.links, fileIntegerWrapper.links) &&
        Objects.equals(this.status, fileIntegerWrapper.status) &&
        Objects.equals(this.statusCode, fileIntegerWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class FileIntegerWrapper {\n");
