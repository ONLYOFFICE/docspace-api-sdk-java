...
@JsonPropertyOrder({
  ...
  EmployeeWrapper.JSON_PROPERTY_COUNT,
  EmployeeWrapper.JSON_PROPERTY_LINKS,
  EmployeeWrapper.JSON_PROPERTY_STATUS,
  EmployeeWrapper.JSON_PROPERTY_STATUS_CODE
})

public class EmployeeWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private EmployeeDto response;
  ...
  public EmployeeDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable EmployeeDto response) {
    this.response = response;
  }

  public EmployeeWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public EmployeeWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public EmployeeWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public EmployeeWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public EmployeeWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeeWrapper employeeWrapper = (EmployeeWrapper) o;
    return Objects.equals(this.response, employeeWrapper.response) &&
        Objects.equals(this.count, employeeWrapper.count) &&
        Objects.equals(this.links, employeeWrapper.links) &&
        Objects.equals(this.status, employeeWrapper.status) &&
        Objects.equals(this.statusCode, employeeWrapper.statusCode);
  }
