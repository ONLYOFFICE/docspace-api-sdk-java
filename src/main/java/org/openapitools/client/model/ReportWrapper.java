...
@JsonPropertyOrder({
  ...
  ReportWrapper.JSON_PROPERTY_COUNT,
  ReportWrapper.JSON_PROPERTY_LINKS,
  ReportWrapper.JSON_PROPERTY_STATUS,
  ReportWrapper.JSON_PROPERTY_STATUS_CODE
})

public class ReportWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private ReportDto response;
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable ReportDto response) {
    this.response = response;
  }

  public ReportWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public ReportWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public ReportWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public ReportWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public ReportWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    ReportWrapper reportWrapper = (ReportWrapper) o;
    return Objects.equals(this.response, reportWrapper.response) &&
        Objects.equals(this.count, reportWrapper.count) &&
        Objects.equals(this.links, reportWrapper.links) &&
        Objects.equals(this.status, reportWrapper.status) &&
        Objects.equals(this.statusCode, reportWrapper.statusCode);
  }
