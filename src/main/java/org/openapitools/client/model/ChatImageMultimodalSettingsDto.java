 ...
 */
@JsonPropertyOrder({
  ChatImageMultimodalSettingsDto.JSON_PROPERTY_FORMATS
})

public class ChatImageMultimodalSettingsDto {
  public static final String JSON_PROPERTY_FORMATS = "formats";
  @javax.annotation.Nullable  private JsonNullable<List<String>> formats = JsonNullable.<List<String>>undefined();

  public ChatImageMultimodalSettingsDto() {
  }


  public ChatImageMultimodalSettingsDto formats(@javax.annotation.Nullable List<String> formats) {
    this.formats = JsonNullable.<List<String>>of(formats);
    
    return this;
  }

  public ChatImageMultimodalSettingsDto addFormatsItem(String formatsItem) {
  ...
  public boolean equals(Object o) {
    ...
    ChatImageMultimodalSettingsDto chatImageMultimodalSettingsDto = (ChatImageMultimodalSettingsDto) o;
    return equalsNullable(this.formats, chatImageMultimodalSettingsDto.formats);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(formats));
  }
  ...
  public String toString() {
    ...
    sb.append("class ChatImageMultimodalSettingsDto {\n");
