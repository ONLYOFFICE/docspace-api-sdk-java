...
public class ChangeWalletServiceStateRequestDto {
  ...
  @javax.annotation.Nullable  private TenantWalletService service;
  ...
  public TenantWalletService getService() {
    return service;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setService(@javax.annotation.Nullable TenantWalletService service) {
    this.service = service;
  }

  public ChangeWalletServiceStateRequestDto enabled(@javax.annotation.Nullable Boolean enabled) {
  ...
  public boolean equals(Object o) {
    ...
    ChangeWalletServiceStateRequestDto changeWalletServiceStateRequestDto = (ChangeWalletServiceStateRequestDto) o;
    return Objects.equals(this.service, changeWalletServiceStateRequestDto.service) &&
        Objects.equals(this.enabled, changeWalletServiceStateRequestDto.enabled);
  }

  @Override
  public int hashCode() {
    return Objects.hash(service, enabled);
  }
