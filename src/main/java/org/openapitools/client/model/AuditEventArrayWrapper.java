...
import org.openapitools.client.model.AuditEventDto;
 ...
 */
@JsonPropertyOrder({
  AuditEventArrayWrapper.JSON_PROPERTY_RESPONSE,
  AuditEventArrayWrapper.JSON_PROPERTY_COUNT,
  AuditEventArrayWrapper.JSON_PROPERTY_LINKS,
  AuditEventArrayWrapper.JSON_PROPERTY_STATUS,
  AuditEventArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class AuditEventArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<AuditEventDto> response = new ArrayList<>();
  ...
  public AuditEventArrayWrapper addResponseItem(AuditEventDto responseItem) {
  ...
  public List<AuditEventDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<AuditEventDto> response) {
    this.response = response;
  }

  public AuditEventArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public AuditEventArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public AuditEventArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public AuditEventArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public AuditEventArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    AuditEventArrayWrapper auditEventArrayWrapper = (AuditEventArrayWrapper) o;
    return Objects.equals(this.response, auditEventArrayWrapper.response) &&
        Objects.equals(this.count, auditEventArrayWrapper.count) &&
        Objects.equals(this.links, auditEventArrayWrapper.links) &&
        Objects.equals(this.status, auditEventArrayWrapper.status) &&
        Objects.equals(this.statusCode, auditEventArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class AuditEventArrayWrapper {\n");
