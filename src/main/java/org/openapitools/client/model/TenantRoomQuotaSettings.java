 ...
 */
@JsonPropertyOrder({
  TenantRoomQuotaSettings.JSON_PROPERTY_ENABLE_QUOTA,
  TenantRoomQuotaSettings.JSON_PROPERTY_DEFAULT_QUOTA,
  TenantRoomQuotaSettings.JSON_PROPERTY_LAST_RECALCULATE_DATE,
  TenantRoomQuotaSettings.JSON_PROPERTY_LAST_MODIFIED
})
@javax.annotation.Generated(value = "com.example.codegen.MyJavaClientCodegen", date = "2025-11-10T06:17:22.719994700+03:00[Europe/Moscow]", comments = "Generator version: 7.14.0")
public class TenantRoomQuotaSettings {
  ...
  public TenantRoomQuotaSettings() {
  }

  public TenantRoomQuotaSettings enableQuota(@javax.annotation.Nullable Boolean enableQuota) {
  ...
  public TenantRoomQuotaSettings defaultQuota(@javax.annotation.Nullable Long defaultQuota) {
