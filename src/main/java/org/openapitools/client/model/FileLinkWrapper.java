 ...
 */
@JsonPropertyOrder({
  FileLinkWrapper.JSON_PROPERTY_RESPONSE,
  FileLinkWrapper.JSON_PROPERTY_COUNT,
  FileLinkWrapper.JSON_PROPERTY_LINKS,
  FileLinkWrapper.JSON_PROPERTY_STATUS,
  FileLinkWrapper.JSON_PROPERTY_STATUS_CODE
})

public class FileLinkWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private FileLink response;
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable FileLink response) {
    this.response = response;
  }

  public FileLinkWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public FileLinkWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public FileLinkWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public FileLinkWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public FileLinkWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    FileLinkWrapper fileLinkWrapper = (FileLinkWrapper) o;
    return Objects.equals(this.response, fileLinkWrapper.response) &&
        Objects.equals(this.count, fileLinkWrapper.count) &&
        Objects.equals(this.links, fileLinkWrapper.links) &&
        Objects.equals(this.status, fileLinkWrapper.status) &&
        Objects.equals(this.statusCode, fileLinkWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class FileLinkWrapper {\n");
