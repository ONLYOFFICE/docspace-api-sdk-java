...
import org.openapitools.client.model.RoomsNotificationSettingsDto;
...
@JsonPropertyOrder({
  ...
  RoomsNotificationSettingsWrapper.JSON_PROPERTY_COUNT,
  RoomsNotificationSettingsWrapper.JSON_PROPERTY_LINKS,
  RoomsNotificationSettingsWrapper.JSON_PROPERTY_STATUS,
  RoomsNotificationSettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class RoomsNotificationSettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private RoomsNotificationSettingsDto response;
  ...
  public RoomsNotificationSettingsDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable RoomsNotificationSettingsDto response) {
    this.response = response;
  }

  public RoomsNotificationSettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public RoomsNotificationSettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public RoomsNotificationSettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public RoomsNotificationSettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public RoomsNotificationSettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    RoomsNotificationSettingsWrapper roomsNotificationSettingsWrapper = (RoomsNotificationSettingsWrapper) o;
    return Objects.equals(this.response, roomsNotificationSettingsWrapper.response) &&
        Objects.equals(this.count, roomsNotificationSettingsWrapper.count) &&
        Objects.equals(this.links, roomsNotificationSettingsWrapper.links) &&
        Objects.equals(this.status, roomsNotificationSettingsWrapper.status) &&
        Objects.equals(this.statusCode, roomsNotificationSettingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class RoomsNotificationSettingsWrapper {\n");
