...
import org.openapitools.client.model.AiUserSettingsDto;
 ...
 */
@JsonPropertyOrder({
  AiUserSettingsWrapper.JSON_PROPERTY_RESPONSE,
  AiUserSettingsWrapper.JSON_PROPERTY_COUNT,
  AiUserSettingsWrapper.JSON_PROPERTY_LINKS,
  AiUserSettingsWrapper.JSON_PROPERTY_STATUS,
  AiUserSettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class AiUserSettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private AiUserSettingsDto response;
  ...
  public AiUserSettingsWrapper() {
  }


  public AiUserSettingsWrapper response(@javax.annotation.Nullable AiUserSettingsDto response) {
  ...
  public AiUserSettingsDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable AiUserSettingsDto response) {
    this.response = response;
  }

  public AiUserSettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public AiUserSettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public AiUserSettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public AiUserSettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public AiUserSettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    AiUserSettingsWrapper aiUserSettingsWrapper = (AiUserSettingsWrapper) o;
    return Objects.equals(this.response, aiUserSettingsWrapper.response) &&
        Objects.equals(this.count, aiUserSettingsWrapper.count) &&
        Objects.equals(this.links, aiUserSettingsWrapper.links) &&
        Objects.equals(this.status, aiUserSettingsWrapper.status) &&
        Objects.equals(this.statusCode, aiUserSettingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class AiUserSettingsWrapper {\n");
