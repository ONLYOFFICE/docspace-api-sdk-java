 ...
 */
@JsonPropertyOrder({
  EncryptionSettingsWrapper.JSON_PROPERTY_RESPONSE,
  EncryptionSettingsWrapper.JSON_PROPERTY_COUNT,
  EncryptionSettingsWrapper.JSON_PROPERTY_LINKS,
  EncryptionSettingsWrapper.JSON_PROPERTY_STATUS,
  EncryptionSettingsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class EncryptionSettingsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private EncryptionSettings response;
  ...
  public EncryptionSettings getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable EncryptionSettings response) {
    this.response = response;
  }

  public EncryptionSettingsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public EncryptionSettingsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public EncryptionSettingsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public EncryptionSettingsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public EncryptionSettingsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    EncryptionSettingsWrapper encryptionSettingsWrapper = (EncryptionSettingsWrapper) o;
    return Objects.equals(this.response, encryptionSettingsWrapper.response) &&
        Objects.equals(this.count, encryptionSettingsWrapper.count) &&
        Objects.equals(this.links, encryptionSettingsWrapper.links) &&
        Objects.equals(this.status, encryptionSettingsWrapper.status) &&
        Objects.equals(this.statusCode, encryptionSettingsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class EncryptionSettingsWrapper {\n");
