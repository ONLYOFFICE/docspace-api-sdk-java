...
import org.openapitools.client.model.LogoRequestsDto;
...
@JsonPropertyOrder({
  ...
  ItemKeyValuePairStringLogoRequestsDto.JSON_PROPERTY_VALUE
})

public class ItemKeyValuePairStringLogoRequestsDto {
  public static final String JSON_PROPERTY_KEY = "key";
  @javax.annotation.Nullable  private JsonNullable<String> key = JsonNullable.<String>undefined();

  public static final String JSON_PROPERTY_VALUE = "value";
  @javax.annotation.Nullable  private LogoRequestsDto value;
  ...
  public ItemKeyValuePairStringLogoRequestsDto value(@javax.annotation.Nullable LogoRequestsDto value) {
  ...
  public LogoRequestsDto getValue() {
    return value;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setValue(@javax.annotation.Nullable LogoRequestsDto value) {
    this.value = value;
  }
  ...
  public boolean equals(Object o) {
    ...
    ItemKeyValuePairStringLogoRequestsDto itemKeyValuePairStringLogoRequestsDto = (ItemKeyValuePairStringLogoRequestsDto) o;
    return equalsNullable(this.key, itemKeyValuePairStringLogoRequestsDto.key) &&
        Objects.equals(this.value, itemKeyValuePairStringLogoRequestsDto.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class ItemKeyValuePairStringLogoRequestsDto {\n");
