 ...
 */
@JsonPropertyOrder({
  IpRestrictionsWrapper.JSON_PROPERTY_RESPONSE,
  IpRestrictionsWrapper.JSON_PROPERTY_COUNT,
  IpRestrictionsWrapper.JSON_PROPERTY_LINKS,
  IpRestrictionsWrapper.JSON_PROPERTY_STATUS,
  IpRestrictionsWrapper.JSON_PROPERTY_STATUS_CODE
})

public class IpRestrictionsWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private IpRestrictionsDto response;
  ...
  public IpRestrictionsWrapper() {
  }


  public IpRestrictionsWrapper response(@javax.annotation.Nullable IpRestrictionsDto response) {
  ...
  public IpRestrictionsDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable IpRestrictionsDto response) {
    this.response = response;
  }

  public IpRestrictionsWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public IpRestrictionsWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public IpRestrictionsWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public IpRestrictionsWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public IpRestrictionsWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    IpRestrictionsWrapper ipRestrictionsWrapper = (IpRestrictionsWrapper) o;
    return Objects.equals(this.response, ipRestrictionsWrapper.response) &&
        Objects.equals(this.count, ipRestrictionsWrapper.count) &&
        Objects.equals(this.links, ipRestrictionsWrapper.links) &&
        Objects.equals(this.status, ipRestrictionsWrapper.status) &&
        Objects.equals(this.statusCode, ipRestrictionsWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class IpRestrictionsWrapper {\n");
