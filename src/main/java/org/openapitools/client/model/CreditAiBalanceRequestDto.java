 ...
 */
@JsonPropertyOrder({
  CreditAiBalanceRequestDto.JSON_PROPERTY_AMOUNT,
  CreditAiBalanceRequestDto.JSON_PROPERTY_CURRENCY
})
...
public class CreditAiBalanceRequestDto {
  ...
  public CreditAiBalanceRequestDto() {
  }


  public CreditAiBalanceRequestDto amount(@javax.annotation.Nullable Double amount) {
  ...
  public CreditAiBalanceRequestDto currency(@javax.annotation.Nullable String currency) {
  ...
  public boolean equals(Object o) {
    ...
    CreditAiBalanceRequestDto creditAiBalanceRequestDto = (CreditAiBalanceRequestDto) o;
    return Objects.equals(this.amount, creditAiBalanceRequestDto.amount) &&
        equalsNullable(this.currency, creditAiBalanceRequestDto.currency);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreditAiBalanceRequestDto {\n");
