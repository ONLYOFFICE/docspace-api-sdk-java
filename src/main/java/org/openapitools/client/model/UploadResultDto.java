 ...
 */
@JsonPropertyOrder({
  UploadResultDto.JSON_PROPERTY_SUCCESS,
  UploadResultDto.JSON_PROPERTY_DATA,
  UploadResultDto.JSON_PROPERTY_MESSAGE
})
...
public class UploadResultDto {
  ...
  public UploadResultDto data(@javax.annotation.Nullable Object data) {
  ...
  public UploadResultDto message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    UploadResultDto uploadResultDto = (UploadResultDto) o;
    return Objects.equals(this.success, uploadResultDto.success) &&
        equalsNullable(this.data, uploadResultDto.data) &&
        equalsNullable(this.message, uploadResultDto.message);
  }
