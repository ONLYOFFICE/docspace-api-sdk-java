...
@JsonPropertyOrder({
  ...
  EmployeeFullArrayWrapper.JSON_PROPERTY_COUNT,
  EmployeeFullArrayWrapper.JSON_PROPERTY_LINKS,
  EmployeeFullArrayWrapper.JSON_PROPERTY_STATUS,
  EmployeeFullArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class EmployeeFullArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<EmployeeFullDto> response = new ArrayList<>();
  ...
  public EmployeeFullArrayWrapper() {
  }


  public EmployeeFullArrayWrapper response(@javax.annotation.Nullable List<EmployeeFullDto> response) {
    
    this.response = response;
    return this;
  }

  public EmployeeFullArrayWrapper addResponseItem(EmployeeFullDto responseItem) {
  ...
  public List<EmployeeFullDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<EmployeeFullDto> response) {
    this.response = response;
  }

  public EmployeeFullArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public EmployeeFullArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public EmployeeFullArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public EmployeeFullArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public EmployeeFullArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeeFullArrayWrapper employeeFullArrayWrapper = (EmployeeFullArrayWrapper) o;
    return Objects.equals(this.response, employeeFullArrayWrapper.response) &&
        Objects.equals(this.count, employeeFullArrayWrapper.count) &&
        Objects.equals(this.links, employeeFullArrayWrapper.links) &&
        Objects.equals(this.status, employeeFullArrayWrapper.status) &&
        Objects.equals(this.statusCode, employeeFullArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeFullArrayWrapper {\n");
