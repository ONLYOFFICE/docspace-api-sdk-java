...
import org.openapitools.client.model.FormsItemDto;
...
@JsonPropertyOrder({
  ...
  FormsItemArrayWrapper.JSON_PROPERTY_COUNT,
  FormsItemArrayWrapper.JSON_PROPERTY_LINKS,
  FormsItemArrayWrapper.JSON_PROPERTY_STATUS,
  FormsItemArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class FormsItemArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<FormsItemDto> response = new ArrayList<>();
  ...
  public FormsItemArrayWrapper addResponseItem(FormsItemDto responseItem) {
  ...
  public List<FormsItemDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<FormsItemDto> response) {
    this.response = response;
  }

  public FormsItemArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public FormsItemArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public FormsItemArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public FormsItemArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public FormsItemArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    FormsItemArrayWrapper formsItemArrayWrapper = (FormsItemArrayWrapper) o;
    return Objects.equals(this.response, formsItemArrayWrapper.response) &&
        Objects.equals(this.count, formsItemArrayWrapper.count) &&
        Objects.equals(this.links, formsItemArrayWrapper.links) &&
        Objects.equals(this.status, formsItemArrayWrapper.status) &&
        Objects.equals(this.statusCode, formsItemArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class FormsItemArrayWrapper {\n");
