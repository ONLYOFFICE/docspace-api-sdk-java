...
import org.openapitools.client.model.RoomGroupDto;
 ...
 */
@JsonPropertyOrder({
  RoomGroupArrayWrapper.JSON_PROPERTY_RESPONSE,
  RoomGroupArrayWrapper.JSON_PROPERTY_COUNT,
  RoomGroupArrayWrapper.JSON_PROPERTY_LINKS,
  RoomGroupArrayWrapper.JSON_PROPERTY_STATUS,
  RoomGroupArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class RoomGroupArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<RoomGroupDto> response = new ArrayList<>();
  ...
  public RoomGroupArrayWrapper() {
  }


  public RoomGroupArrayWrapper response(@javax.annotation.Nullable List<RoomGroupDto> response) {
    
    this.response = response;
    return this;
  }

  public RoomGroupArrayWrapper addResponseItem(RoomGroupDto responseItem) {
  ...
  public List<RoomGroupDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<RoomGroupDto> response) {
    this.response = response;
  }

  public RoomGroupArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public RoomGroupArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public RoomGroupArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public RoomGroupArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public RoomGroupArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    RoomGroupArrayWrapper roomGroupArrayWrapper = (RoomGroupArrayWrapper) o;
    return Objects.equals(this.response, roomGroupArrayWrapper.response) &&
        Objects.equals(this.count, roomGroupArrayWrapper.count) &&
        Objects.equals(this.links, roomGroupArrayWrapper.links) &&
        Objects.equals(this.status, roomGroupArrayWrapper.status) &&
        Objects.equals(this.statusCode, roomGroupArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class RoomGroupArrayWrapper {\n");
