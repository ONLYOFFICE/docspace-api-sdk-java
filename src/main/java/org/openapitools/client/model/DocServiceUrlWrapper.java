...
import org.openapitools.client.model.DocServiceUrlDto;
 ...
 */
@JsonPropertyOrder({
  DocServiceUrlWrapper.JSON_PROPERTY_RESPONSE,
  DocServiceUrlWrapper.JSON_PROPERTY_COUNT,
  DocServiceUrlWrapper.JSON_PROPERTY_LINKS,
  DocServiceUrlWrapper.JSON_PROPERTY_STATUS,
  DocServiceUrlWrapper.JSON_PROPERTY_STATUS_CODE
})

public class DocServiceUrlWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private DocServiceUrlDto response;
  ...
  public DocServiceUrlDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable DocServiceUrlDto response) {
    this.response = response;
  }

  public DocServiceUrlWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public DocServiceUrlWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public DocServiceUrlWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public DocServiceUrlWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public DocServiceUrlWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    DocServiceUrlWrapper docServiceUrlWrapper = (DocServiceUrlWrapper) o;
    return Objects.equals(this.response, docServiceUrlWrapper.response) &&
        Objects.equals(this.count, docServiceUrlWrapper.count) &&
        Objects.equals(this.links, docServiceUrlWrapper.links) &&
        Objects.equals(this.status, docServiceUrlWrapper.status) &&
        Objects.equals(this.statusCode, docServiceUrlWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class DocServiceUrlWrapper {\n");
