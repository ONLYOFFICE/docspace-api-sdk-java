...
import org.openapitools.client.model.FilesStatisticsResultDto;
...
@JsonPropertyOrder({
  ...
  FilesStatisticsResultWrapper.JSON_PROPERTY_COUNT,
  FilesStatisticsResultWrapper.JSON_PROPERTY_LINKS,
  FilesStatisticsResultWrapper.JSON_PROPERTY_STATUS,
  FilesStatisticsResultWrapper.JSON_PROPERTY_STATUS_CODE
})

public class FilesStatisticsResultWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private FilesStatisticsResultDto response;
  ...
  public FilesStatisticsResultDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable FilesStatisticsResultDto response) {
    this.response = response;
  }

  public FilesStatisticsResultWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public FilesStatisticsResultWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public FilesStatisticsResultWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public FilesStatisticsResultWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public FilesStatisticsResultWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    FilesStatisticsResultWrapper filesStatisticsResultWrapper = (FilesStatisticsResultWrapper) o;
    return Objects.equals(this.response, filesStatisticsResultWrapper.response) &&
        Objects.equals(this.count, filesStatisticsResultWrapper.count) &&
        Objects.equals(this.links, filesStatisticsResultWrapper.links) &&
        Objects.equals(this.status, filesStatisticsResultWrapper.status) &&
        Objects.equals(this.statusCode, filesStatisticsResultWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class FilesStatisticsResultWrapper {\n");
