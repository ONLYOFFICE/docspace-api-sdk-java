...
public class IconRequest {
  ...
  public IconRequest icon(@javax.annotation.Nullable String icon) {
  ...
  public boolean equals(Object o) {
    ...
    IconRequest iconRequest = (IconRequest) o;
    return equalsNullable(this.icon, iconRequest.icon);
  }
