...
import org.openapitools.client.model.RoomFromTemplateStatusDto;
 ...
 */
@JsonPropertyOrder({
  RoomFromTemplateStatusWrapper.JSON_PROPERTY_RESPONSE,
  RoomFromTemplateStatusWrapper.JSON_PROPERTY_COUNT,
  RoomFromTemplateStatusWrapper.JSON_PROPERTY_LINKS,
  RoomFromTemplateStatusWrapper.JSON_PROPERTY_STATUS,
  RoomFromTemplateStatusWrapper.JSON_PROPERTY_STATUS_CODE
})

public class RoomFromTemplateStatusWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private RoomFromTemplateStatusDto response;
  ...
  public RoomFromTemplateStatusDto getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable RoomFromTemplateStatusDto response) {
    this.response = response;
  }

  public RoomFromTemplateStatusWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public RoomFromTemplateStatusWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public RoomFromTemplateStatusWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public RoomFromTemplateStatusWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public RoomFromTemplateStatusWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    RoomFromTemplateStatusWrapper roomFromTemplateStatusWrapper = (RoomFromTemplateStatusWrapper) o;
    return Objects.equals(this.response, roomFromTemplateStatusWrapper.response) &&
        Objects.equals(this.count, roomFromTemplateStatusWrapper.count) &&
        Objects.equals(this.links, roomFromTemplateStatusWrapper.links) &&
        Objects.equals(this.status, roomFromTemplateStatusWrapper.status) &&
        Objects.equals(this.statusCode, roomFromTemplateStatusWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class RoomFromTemplateStatusWrapper {\n");
