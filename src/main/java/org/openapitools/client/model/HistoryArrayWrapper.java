...
@JsonPropertyOrder({
  ...
  HistoryArrayWrapper.JSON_PROPERTY_COUNT,
  HistoryArrayWrapper.JSON_PROPERTY_LINKS,
  HistoryArrayWrapper.JSON_PROPERTY_STATUS,
  HistoryArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class HistoryArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<HistoryDto> response = new ArrayList<>();
  ...
  public HistoryArrayWrapper addResponseItem(HistoryDto responseItem) {
  ...
  public List<HistoryDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<HistoryDto> response) {
    this.response = response;
  }

  public HistoryArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public HistoryArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public HistoryArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public HistoryArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public HistoryArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    HistoryArrayWrapper historyArrayWrapper = (HistoryArrayWrapper) o;
    return Objects.equals(this.response, historyArrayWrapper.response) &&
        Objects.equals(this.count, historyArrayWrapper.count) &&
        Objects.equals(this.links, historyArrayWrapper.links) &&
        Objects.equals(this.status, historyArrayWrapper.status) &&
        Objects.equals(this.statusCode, historyArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class HistoryArrayWrapper {\n");
