...
import org.openapitools.client.model.ApiKeyResponseDto;
...
@JsonPropertyOrder({
  ...
  ApiKeyResponseArrayWrapper.JSON_PROPERTY_COUNT,
  ApiKeyResponseArrayWrapper.JSON_PROPERTY_LINKS,
  ApiKeyResponseArrayWrapper.JSON_PROPERTY_STATUS,
  ApiKeyResponseArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class ApiKeyResponseArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<ApiKeyResponseDto> response = new ArrayList<>();
  ...
  public ApiKeyResponseArrayWrapper() {
  }


  public ApiKeyResponseArrayWrapper response(@javax.annotation.Nullable List<ApiKeyResponseDto> response) {
    
    this.response = response;
    return this;
  }

  public ApiKeyResponseArrayWrapper addResponseItem(ApiKeyResponseDto responseItem) {
  ...
  public List<ApiKeyResponseDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<ApiKeyResponseDto> response) {
    this.response = response;
  }

  public ApiKeyResponseArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public ApiKeyResponseArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public ApiKeyResponseArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public ApiKeyResponseArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public ApiKeyResponseArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    ApiKeyResponseArrayWrapper apiKeyResponseArrayWrapper = (ApiKeyResponseArrayWrapper) o;
    return Objects.equals(this.response, apiKeyResponseArrayWrapper.response) &&
        Objects.equals(this.count, apiKeyResponseArrayWrapper.count) &&
        Objects.equals(this.links, apiKeyResponseArrayWrapper.links) &&
        Objects.equals(this.status, apiKeyResponseArrayWrapper.status) &&
        Objects.equals(this.statusCode, apiKeyResponseArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApiKeyResponseArrayWrapper {\n");
