...
@JsonPropertyOrder({
  ...
  UserInfoWrapper.JSON_PROPERTY_COUNT,
  UserInfoWrapper.JSON_PROPERTY_LINKS,
  UserInfoWrapper.JSON_PROPERTY_STATUS,
  UserInfoWrapper.JSON_PROPERTY_STATUS_CODE
})

public class UserInfoWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private UserInfo response;
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable UserInfo response) {
    this.response = response;
  }

  public UserInfoWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public UserInfoWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public UserInfoWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public UserInfoWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public UserInfoWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    UserInfoWrapper userInfoWrapper = (UserInfoWrapper) o;
    return Objects.equals(this.response, userInfoWrapper.response) &&
        Objects.equals(this.count, userInfoWrapper.count) &&
        Objects.equals(this.links, userInfoWrapper.links) &&
        Objects.equals(this.status, userInfoWrapper.status) &&
        Objects.equals(this.statusCode, userInfoWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserInfoWrapper {\n");
