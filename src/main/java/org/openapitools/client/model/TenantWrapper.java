 ...
 */
@JsonPropertyOrder({
  TenantWrapper.JSON_PROPERTY_RESPONSE,
  TenantWrapper.JSON_PROPERTY_COUNT,
  TenantWrapper.JSON_PROPERTY_LINKS,
  TenantWrapper.JSON_PROPERTY_STATUS,
  TenantWrapper.JSON_PROPERTY_STATUS_CODE
})

public class TenantWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private TenantDto response;
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable TenantDto response) {
    this.response = response;
  }

  public TenantWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public TenantWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public TenantWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public TenantWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public TenantWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    TenantWrapper tenantWrapper = (TenantWrapper) o;
    return Objects.equals(this.response, tenantWrapper.response) &&
        Objects.equals(this.count, tenantWrapper.count) &&
        Objects.equals(this.links, tenantWrapper.links) &&
        Objects.equals(this.status, tenantWrapper.status) &&
        Objects.equals(this.statusCode, tenantWrapper.statusCode);
  }
