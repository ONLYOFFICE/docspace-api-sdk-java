...
import org.openapitools.client.model.FileOperationDto;
...
@JsonPropertyOrder({
  ...
  FileOperationArrayWrapper.JSON_PROPERTY_COUNT,
  FileOperationArrayWrapper.JSON_PROPERTY_LINKS,
  FileOperationArrayWrapper.JSON_PROPERTY_STATUS,
  FileOperationArrayWrapper.JSON_PROPERTY_STATUS_CODE
})

public class FileOperationArrayWrapper {
  public static final String JSON_PROPERTY_RESPONSE = "response";
  @javax.annotation.Nullable  private List<FileOperationDto> response = new ArrayList<>();
  ...
  public FileOperationArrayWrapper addResponseItem(FileOperationDto responseItem) {
  ...
  public List<FileOperationDto> getResponse() {
    return response;
  }
  ...
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponse(@javax.annotation.Nullable List<FileOperationDto> response) {
    this.response = response;
  }

  public FileOperationArrayWrapper count(@javax.annotation.Nullable Integer count) {
  ...
  public FileOperationArrayWrapper links(@javax.annotation.Nullable List<GetPortalPrices200ResponseLinksInner> links) {
    
    this.links = links;
    return this;
  }

  public FileOperationArrayWrapper addLinksItem(GetPortalPrices200ResponseLinksInner linksItem) {
    if (this.links == null) {
  ...
  public FileOperationArrayWrapper status(@javax.annotation.Nullable Integer status) {
  ...
  public FileOperationArrayWrapper statusCode(@javax.annotation.Nullable Integer statusCode) {
  ...
  public boolean equals(Object o) {
    ...
    FileOperationArrayWrapper fileOperationArrayWrapper = (FileOperationArrayWrapper) o;
    return Objects.equals(this.response, fileOperationArrayWrapper.response) &&
        Objects.equals(this.count, fileOperationArrayWrapper.count) &&
        Objects.equals(this.links, fileOperationArrayWrapper.links) &&
        Objects.equals(this.status, fileOperationArrayWrapper.status) &&
        Objects.equals(this.statusCode, fileOperationArrayWrapper.statusCode);
  }
  ...
  public String toString() {
    ...
    sb.append("class FileOperationArrayWrapper {\n");
