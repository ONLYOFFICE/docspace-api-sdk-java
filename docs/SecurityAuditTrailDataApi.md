...
public class Example {
    public static void main(String[] args) {
        ...
        AuditTrailDataApi apiInstance = new AuditTrailDataApi(defaultClient);
        UUID userId = UUID.fromString("aae1e103-bca5-9fa1-ba8c-42058b4abf28"); // UUID | The ID of the user who triggered the audit event.
        ...
        String target = "some text"; // String | The target object affected by the audit event (e.g., document ID, user account).
        ...
        Integer count = 1234; // Integer | The maximum number of audit event records to retrieve.
        Integer startIndex = 1234; // Integer | The index of the first audit event record to retrieve in a paged query.
        try {
