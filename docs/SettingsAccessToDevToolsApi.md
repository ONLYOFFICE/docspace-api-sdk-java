# onlyoffice.docspace.api.sdk.org.openapitools.client.api.AccessToDevToolsApi
...
Get the Developer Tools access settingsReturns the Developer Tools access settings for the portal.
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling AccessToDevToolsApi#getTenantAccessDevToolsSettings");
