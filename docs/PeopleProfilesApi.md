...
> BooleanWrapper checkUserExistsByEmail(email, encemail, culture)

Check if a user exists by emailReturns a boolean indicating whether a user with the specified email exists on the portal.
