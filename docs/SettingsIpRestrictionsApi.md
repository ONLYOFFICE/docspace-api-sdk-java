...
Get the IP portal restrictionsReturns the IP portal restrictions.
...
import org.openapitools.client.api.IPRestrictionsApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        IPRestrictionsApi apiInstance = new IPRestrictionsApi(defaultClient);
        try {
            IPRestrictionArrayWrapper result = apiInstance.getIpRestrictions();
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling IPRestrictionsApi#getIpRestrictions");
...
Get the IP restriction settingsReturns the IP restriction settings.
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling IPRestrictionsApi#readIpRestrictionsSettings");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
Update the IP restrictionsUpdates the IP restrictions with the parameters specified in the request.
...
public class Example {
    public static void main(String[] args) {
        ...
        IPRestrictionsApi apiInstance = new IPRestrictionsApi(defaultClient);
        IpRestrictionsDto ipRestrictionsDto = new IpRestrictionsDto(); // IpRestrictionsDto | 
        try {
            IpRestrictionsWrapper result = apiInstance.saveIpRestrictions(ipRestrictionsDto);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling IPRestrictionsApi#saveIpRestrictions");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
Update the IP restriction settingsUpdates the IP restriction settings with the parameters specified in the request.
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling IPRestrictionsApi#updateIpRestrictionsSettings");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
