...
Create an invitation linkReturns an invitation link for joining the portal.
...
Deletes an invitation link.Ensures that the current user has permission to delete the specified invitation link.  Throws security or not-found exceptions if required conditions are not met.
...
public class Example {
    public static void main(String[] args) {
        ...
        UsersApi apiInstance = new UsersApi(defaultClient);
        InvitationLinkDeleteRequestDto invitationLinkDeleteRequestDto = new InvitationLinkDeleteRequestDto(); // InvitationLinkDeleteRequestDto | The data transfer object containing the details of the invitation link to be deleted.
        try {
...
public class Example {
    public static void main(String[] args) {
        ...
        UsersApi apiInstance = new UsersApi(defaultClient);
        EmployeeType employeeType = EmployeeType.fromValue("All"); // EmployeeType | The type of employee role for the invitation link (DocSpaceAdmin, RoomAdmin or User).
        try {
...
public class Example {
    public static void main(String[] args) {
        ...
        UsersApi apiInstance = new UsersApi(defaultClient);
        UUID userid = UUID.fromString("00000000-0000-0000-0000-000000000000"); // UUID | The user ID to receive the congratulatory message.
        String key = "birthday"; // String | The template identifier or email configuration key.
        try {
...
Update an invitation linkReturns an invitation link for joining the portal.
