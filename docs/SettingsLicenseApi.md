# onlyoffice.docspace.api.sdk.org.openapitools.client.api.LicenseApi
...
Activate a licenseActivates a license for the portal.
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling LicenseApi#acceptLicense");
...
Request a licenseRequests a portal license if necessary.
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling LicenseApi#getIsLicenseRequired");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
Refresh the licenseRefreshes the portal license.
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling LicenseApi#refreshLicense");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
Upload a licenseUploads a portal license specified in the request.
...
|------------- | ------------- | ------------- | -------------|
| **files** | **List&lt;File&gt;**| The list of license files to be uploaded. | |
...
public class Example {
    public static void main(String[] args) {
        ...
        LicenseApi apiInstance = new LicenseApi(defaultClient);
        List<File> files = Arrays.asList(); // List<File> | The list of license files to be uploaded.
        try {
