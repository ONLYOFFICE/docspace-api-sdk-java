# onlyoffice.docspace.api.sdk.org.openapitools.client.api.TelegramApi
...
Check the Telegram connectionChecks if the current user is connected to the Telegram Bot or not.
...
Get the Telegram linkReturns a link that will connect the Telegram Bot to your account.
...
Unlink TelegramUnlinks the Telegram Bot from your account.
