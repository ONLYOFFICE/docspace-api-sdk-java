...
Get notification channelsReturns a list of notification channels.
...
Check notification availabilityChecks if the notification type specified in the request is enabled or not.
...
public class Example {
    public static void main(String[] args) {
        ...
        NotificationsApi apiInstance = new NotificationsApi(defaultClient);
        NotificationType type = NotificationType.fromValue("0"); // NotificationType | The type of notification to query, specified in the route.
        try {
...
Get room notification settingsReturns a list of rooms with the disabled notifications.
...
Enable notificationsEnables the notification type specified in the request.
...
Set room notification statusSets a notification status for a room with the ID specified in the request.
