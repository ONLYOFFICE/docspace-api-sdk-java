...
Change a user emailSets a new email to the user with the ID specified in the request.
...
public class Example {
    public static void main(String[] args) {
        ...
        ChangeEmailRequest changeEmailRequest = new ChangeEmailRequest(); // ChangeEmailRequest | The request parameters for updating a user email.
        try {
