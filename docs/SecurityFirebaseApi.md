# onlyoffice.docspace.api.sdk.org.openapitools.client.api.FirebaseApi
...
Save the Documents Firebase device tokenSaves the Firebase device token specified in the request for the Documents application.
...
Subscribe to Documents push notificationSubscribes to the Documents push notification.
