# onlyoffice.docspace.api.sdk.org.openapitools.client.api.MigrationApi
...
Cancel migrationCancels the migration.
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling MigrationApi#cancelMigration");
...
Clear migrationClears the migration.
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling MigrationApi#clearMigration");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
Finish migrationFinishes the migration process.
...
public class Example {
    public static void main(String[] args) {
        ...
        MigrationApi apiInstance = new MigrationApi(defaultClient);
        FinishDto finishDto = new FinishDto(); // FinishDto | 
        try {
            apiInstance.finishMigration(finishDto);
        } catch (ApiException e) {
            System.err.println("Exception when calling MigrationApi#finishMigration");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
Get migration logsReturns the migration logs.
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling MigrationApi#getMigrationLogs");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
Get migration statusReturns the migration status.
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling MigrationApi#getMigrationStatus");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
Get migrationsReturns a list of available migrations.
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling MigrationApi#listMigrations");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
Start migrationStarts the migration process.
...
public class Example {
    public static void main(String[] args) {
        ...
        MigrationApi apiInstance = new MigrationApi(defaultClient);
        MigrationApiInfo migrationApiInfo = new MigrationApiInfo(); // MigrationApiInfo | 
        try {
            apiInstance.startMigration(migrationApiInfo);
        } catch (ApiException e) {
            System.err.println("Exception when calling MigrationApi#startMigration");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
Upload and initialize migrationUploads and initializes a migration with a migrator name specified in the request.
...
public class Example {
    public static void main(String[] args) {
        ...
        MigrationApi apiInstance = new MigrationApi(defaultClient);
        String migratorName = "some text"; // String | The migrator name extracted from the route parameters.
        try {
            apiInstance.uploadAndInitializeMigration(migratorName);
        } catch (ApiException e) {
            System.err.println("Exception when calling MigrationApi#uploadAndInitializeMigration");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
