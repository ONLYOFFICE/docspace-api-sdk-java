...
Get the banners visibilityReturns the visibility settings of the promotional banners in the portal.
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling BannersVisibilityApi#getTenantBannerSettings");
