# onlyoffice.docspace.api.sdk.org.openapitools.client.api.EncryptionApi
...
import org.openapitools.client.api.EncryptionApi;
...
Get the storage encryption settingsReturns the storage encryption settings.
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling EncryptionApi#getStorageEncryptionSettings");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
Start the storage encryption processStarts the storage encryption process.
...
public class Example {
    public static void main(String[] args) {
        ...
        EncryptionApi apiInstance = new EncryptionApi(defaultClient);
        StorageEncryptionRequestsDto storageEncryptionRequestsDto = new StorageEncryptionRequestsDto(); // StorageEncryptionRequestsDto | 
        try {
            BooleanWrapper result = apiInstance.startStorageEncryption(storageEncryptionRequestsDto);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling EncryptionApi#startStorageEncryption");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
