# docspace-api-sdk.org.openapitools.client.api.GroupsApi
...
Add a new room groupCreates a new room group with the specified name, icon, and list of rooms.
...
public class Example {
    public static void main(String[] args) {
        ...
        RoomGroupRequestDto roomGroupRequestDto = new RoomGroupRequestDto(); // RoomGroupRequestDto | 
        try {
            RoomGroupWrapper result = apiInstance.addRoomGroup(roomGroupRequestDto);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling GroupsApi#addRoomGroup");
...
Change group iconChanges the icon of an existing room group.
...
public class Example {
    public static void main(String[] args) {
        ...
        GroupsApi apiInstance = new GroupsApi(defaultClient);
        Integer id = 1; // Integer | Group id
        IconRequest iconRequest = new IconRequest(); // IconRequest | Icon update data.
        try {
            RoomGroupWrapper result = apiInstance.changeRoomGroupIcon(id, iconRequest);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling GroupsApi#changeRoomGroupIcon");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
Delete groupDeletes the specified room group.
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling GroupsApi#deleteRoomGroup");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
Get room group infoReturns detailed information about a room group.
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.err.println("Exception when calling GroupsApi#getRoomGroupInfo");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
Update room groupUpdates room group properties and adds or removes rooms.
...
public class Example {
    public static void main(String[] args) {
        ...
        GroupsApi apiInstance = new GroupsApi(defaultClient);
        Integer id = 1; // Integer | The group ID.
        UpdateRoomGroupRequest updateRoomGroupRequest = new UpdateRoomGroupRequest(); // UpdateRoomGroupRequest | The request for updating a group.
        try {
            RoomGroupWrapper result = apiInstance.updateRoomGroup(id, updateRoomGroupRequest);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling GroupsApi#updateRoomGroup");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
